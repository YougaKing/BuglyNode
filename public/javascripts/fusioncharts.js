...
(function () {
    if (!window.FusionCharts || !window.FusionCharts.version) {
        var d = window, m = d.document, z = d.navigator, q = {window: d}, E = q.modules = {}, b = q.interpreters = {},
            K = Object.prototype.toString, I = /msie/i.test(z.userAgent) && !d.opera, c = /loaded|complete/, s = !1,
            a = function () {
                var a = q.ready;
                q.ready = !0;
                ...
                var c, f;
                if (b instanceof Array) for (c = 0; c < b.length; c += 1) "object" !== typeof b[c] ? a[c] = b[c] : ("object" !==
                typeof a[c] && (a[c] = b[c] instanceof Array ? [] : {}), v(a[c], b[c])); else for (c in b) "object" === typeof b[c] ? (f = K.call(b[c]), "[object Object]" === f ? ("object" !== typeof a[c] && (a[c] = {}), v(a[c], b[c])) : "[object Array]" === f ? (a[c] instanceof Array || (a[c] = []), v(a[c], b[c])) : a[c] = b[c]) : a[c] = b[c];
                return a
            };
        q.extend = function (a, b, c, f) {
            var l;
            c && a.prototype && (a = a.prototype);
            if (!0 === f) v(a, b); else for (l in b) a[l] = b[l];
            return a
        };
        q.uniqueId = function () {
        ...
        q.parsePolicies = function (a, b, c) {
            var f, l, p;
            for (l in b) if (q.policies[l] instanceof Array) p = c[b[l][0]], a[l] = void 0 === p ? b[l][1] : p; else for (f in"object" !== typeof a[l] && (a[l] = {}), b[l]) p = c[b[l][f][0]], a[l][f] = void 0 === p ? b[l][f][1] : p
        };
        ...
        q.extend(q.core, {
            id: "FusionCharts", version: ["3", "7", "1"], items: {}, options: {}, getObjectReference: function (a) {
        ...
        c.test(m.readyState) || m.loaded ? (q.ready = !0, setTimeout(a, 1)) : function () {
            ...
            if (I) try {
                "https:" === d.location.protocol ? m.write('<script id="__ie_onload_fusioncharts" defer="defer" src="//:">\x3c/script>') : m.write('<script id="__ie_onload_fusioncharts" defer="defer" src="javascript:void(0)">\x3c/script>'), f = m.getElementById("__ie_onload_fusioncharts"), f.onreadystatechange = function () {
...
FusionCharts.register("module", ["private", "modules.mantle.errormanager", function () {
    var d = this, m = d.window, z = {
        ...
        q = {id: q, nature: z[I], source: "FusionCharts" + c, message: v};
        d.raiseEvent(a, q, b);
...
FusionCharts.register("module", ["private", "modules.mantle.eventmanager", function () {
    var d = this, m = d.window, z = d.core, q = m.Object.prototype.toString, E = q.call([]), b = function (a, b, c, g) {
        try {
            a[0].call(b, c, g || {})
        } catch (f) {
            setTimeout(function () {
        ...
        if (a instanceof Array) for (var g = 0, f; g < a.length; g += 1) {
        ...
        unpropagator: function () {
            ...
            if ("string" !== typeof a) d.raiseError(c || d.core, "03091549", "param", "::EventTarget.addListener", Error("Unspecified Event Type")); else if ("function" !== typeof b) d.raiseError(c || d.core, "03091550", "param", "::EventTarget.addListener",
                Error("Invalid Event Listener")); else return a = a.toLowerCase(), I.listeners[a] instanceof Array || (I.listeners[a] = []), I.listeners[a].push([b, c]), b
            ...
            else if (a = a.toLowerCase(), a = I.listeners[a], a instanceof Array) for (g = 0; g < a.length; g += 1) a[g][0] === b && a[g][1] === c && (a.splice(g, 1), --g)
    ...
    }, s = d.legacyEventList = {}, a = {};
    d.disposeEvents = function (a) {
        var b, c;
        for (b in I.listeners) for (c = 0; c < I.listeners[b].length; c += 1) I.listeners[b][c][1] ===
...
FusionCharts.register("module", ["private", "modules.mantle.ajax", function () {
    var d = this, m = d.window, z = parseFloat(m.navigator.appVersion.split("MSIE")[1]),
        q = 5.5 <= z && 7 >= z ? !0 : !1, E = "file:" === m.location.protocol, b = m.ActiveXObject,
        K = (!b || !E) && m.XMLHttpRequest, I = {objects: 0, xhr: 0, requests: 0, success: 0, failure: 0, idle: 0},
        c = function () {
            var d;
    ...
    d.extend(z.prototype, {
        ...
        transact: function (b, a, v, O) {
            var C = this, g = C.xmlhttp, f = C.headers, l = C.onError, p = C.onSuccess;
            b = "POST" === b;
            var F, Q;
            ...
            try {
                ...
                if (b) if ("string" === typeof v) F = v; else {
                    F = [];
...
FusionCharts.register("module", ["private", "modules.mantle.runtime;1.1", function () {
    var d = this, m = d.window, z = /(^|[\/\\])(fusioncharts\.js)([\?#].*)?$/ig, q = /[\\\"<>;&]/,
        E = /^[^\S]*?(sf|f|ht)(tp|tps):\/\//i, b = {}, K = {}, I = {}, c = {}, s = d.purgeDOM = function (a) {
            var b = a.attributes, c, f;
            if (b) for (c = b.length - 1; 0 <= c; --c) f = b[c].name, "function" === typeof a[f] && (a[f] = null);
            if (b = a.childNodes) for (b = b.length, c = 0; c < b; c += 1) s(a.childNodes[c])
        }, a = function (a, b, c) {
            var f, l;
            for (f in a) if (a[f] instanceof Array) b[a[f][0]] = c[f]; else for (l in a[f]) b[a[f][l][0]] =
                c[f][l]
        }, v = /^(FusionCharts|FusionWidgets|FusionMaps)/;
    d.getScriptBaseUri = function (a) {
        var b = m.document.getElementsByTagName("script"), c = b.length, f, l;
        for (l = 0; l < c; l += 1) if (f = b[l].getAttribute("src"), void 0 !== f && null !== f && null !== f.match(a)) return f.replace(a, "$1")
    };
    ...
    d.loadScript = function (a, C, g, f, l) {
        if (!a) return !1;
        var p = C && C.success || C, F = C && C.failure, s, k = {type: "script", success: !1}, B = function () {
    ...
    d.extend(d.core, {
        clone: function (b, c) {
            var g = typeof b, f, l = d.extend({}, this.args, !1, !1);
            a(d.policies, l, this);
        ...
        chartType: function (a, b) {
            var c = this.src, f = !0 === b, l = this.options, p;
...
FusionCharts.register("module", ["private", "modules.interface.renderer", function () {
    var d = this, m = d.window, z = m.document, q = function () {
            d.raiseError(this, "25081845", "run", "::RendererManager", Error("No active renderer"))
        }, E = d.FusionChartsDOMInsertModes = {REPLACE: "replace", APPEND: "append", PREPEND: "prepend"},
        b = {undefined: {render: q, remove: q, update: q, resize: q, config: q, policies: {}}}, K = {},
        I = function (a) {
            return function () {
                var b = this.ref;
            ...
            var c = z.getElementById(a), f = b.id || b.getAttribute("id"), l, p;
            if (null === c) return !1;
            if (a === f) return !0;
            f = b.getElementsByTagName("*");
            l = 0;
            for (p = f.length; l < p; l++) if (f[l] === c) return !1;
            return !0
        }, a = /[^\%\d]*$/ig, v;
    ...
    d.normalizeCSSDimension = function (a, b, c) {
        ...
        if ((f.widthIsRelative = a.match(/^\s*\d*\.?\d*\%\s*$/) && !a.match(/^\s*0\%\s*$/)) && 0 === c.offsetWidth) for (p = c; p = p.offsetParent;) if (0 <
            p.offsetWidth) {
            a = (p.offsetWidth * parseFloat(a.match(/\d*/)[0]) / 100).toString();
            break
        }
        if ((f.heightIsRelative = b.match(/^\s*\d*\.?\d*\%\s*$/) && !b.match(/^\s*0\%\s*$/)) && 20 >= c.offsetHeight) for (p = c; p = p.offsetParent;) if (0 < p.offsetHeight) {
    ...
    d.addEventListener("loaded", function (a) {
        ...
        if (void 0 !== a && null !== a && "function" === typeof a.getExternalInterfaceMethods) {
            ...
            if (b.ref) for (f in g = v.protectedMethods, a = v.getRenderer(b.options.renderer).protectedMethods, b) if (a && !g[f] && !a[f] && void 0 === b.ref[f]) try {
                b.ref[f] = c(b, f)
            } catch (p) {
            }
        }
    ...
    d.extend(d.core.prototype, {
        render: function (a,
            ...
            var f = this, l = f.width, p = f.height, s = f.__state;
            "object" === typeof b && (g = c, c = b.h, b = b.w);
            b = null === b || void 0 === b ? l : b.toString().replace(a, "");
            c = null === c || void 0 === c ? p : c.toString().replace(a, "");
            !0 !== g ? d.raiseEvent("beforeresize", {currentWidth: l, currentHeight: p, newWidth: b, newHeight: c},
                f, void 0, function () {
                    f.width = b;
                    f.height = c;
                    d.renderer.resize(f, {width: b, height: c});
...
FusionCharts.register("module", ["private", "modules.interface.transcoder", function () {
    var d = this, m = d.window, z = d.transcoders = {}, q = {}, E = {}, b = /url$/i, K = d._interactiveCharts = {
        selectscatter: [!0, !1],
        dragcolumn2d: [!0, !0],
        dragarea: [!0, !0],
        dragline: [!0, !0],
    ...
    d.addDataHandler = function (a, b) {
        if ("string" !==
            typeof a || void 0 !== z[a.toLowerCase()]) d.raiseError(d.core, "03091606", "param", "::DataManager.addDataHandler", Error("Invalid Data Handler Name")); else {
    ...
    d.extend(d.core.prototype,
        {
            setChartDataUrl: function (a, c, g, s, C) {
                ...
                b.test(c) ? this.setChartDataUrl(a, c, p, s, v) : (k.dataSource = a, B = c, k.dataFormat = c, A = z[B], "undefined" === typeof A ? d.raiseError(d.core, "03091611", "param", "FusionCharts#setChartData", Error("Data Format not recognized")) : (c = (c = d.renderer && d.renderer.getRenderer(k.renderer || d.renderer.currentRendererName())) &&
                    c.dataFormat, p = c === B ? A.passthrough ? A.passthrough(a, p) : {data: a} : A.encode(a, this, p || k.dataConfiguration) || {}, p["native"] = c === B, p.format = p["native"] ? c : "xml", p.dataFormat = B, p.dataSource = a, p.silent = !!v, "function" === typeof s && (p.successcallback = s), d.raiseEvent("beforeDataUpdate", p, this, void 0, C, g)))
            }, getChartData: function (a, b) {
                var c = this.options, g = this.id, s;
    ...
    d.addEventListener("beforeInitialize", function (a) {
        a = a.sender;
        var c = a.options, g = c.dataSource, s = d.renderer && d.renderer.getRenderer(c.renderer);
        delete q[a.id];
        E[a.id] = {};
        if (void 0 !== g && null !== g) {
...
(function () {
    ...
    function z(d, a) {
        ...
        switch (typeof p) {
            ...
            case "object":
                ...
                if (c && "object" === typeof c) for (g = c.length, v = 0; v < g; v += 1) "string" === typeof c[v] && (q = c[v], (C = z(q, p)) && l.push(m(q) + (b ? ": " : ":") + C)); else for (q in p) Object.prototype.hasOwnProperty.call(p, q) && (C = z(q, p)) && l.push(m(q) + (b ? ": " : ":") + C);
                C = 0 === l.length ? "{}" : b ? "{\n" + b + l.join(",\n" +
                    b) + "\n" + f + "}" : "{" + l.join(",") + "}";
                b = f;
                return C
    ...
    "function" !== typeof JSON.stringify && (JSON.stringify = function (d, a, v) {
        var m;
        K = b = "";
        if ("number" === typeof v) for (m = 0; m < v; m += 1) K += " "; else "string" === typeof v && (K = v);
    ...
    "function" !== typeof JSON.parse && (JSON.parse = function (b, a) {
        function c(b, g) {
            var f, l, d = b[g];
            if (d && "object" === typeof d) for (f in d) Object.prototype.hasOwnProperty.call(d, f) && (l = c(d, f), void 0 !== l ? d[f] = l : delete d[f]);
            return a.call(b, g, d)
        }
...
FusionCharts.register("module", ["private", "modules.data.json", function () {
    var d = this, m = d.window, z = m.document, q = d.xssEncode, E, b;
    ...
    E = function () {
        var b = {
            ...
            s = {chart: !0, map: !0, graph: !0}, a = {dataset: "data", categories: "category"},
            v = {target: "target", value: "value"}, E = {
            ...
            append: function (a, c, g, d) {
                ...
                for (m = 0; m < g.length; m += 1) switch (B = g[m], k = B.nodeName.toLowerCase(), B.nodeType) {
                    case 1:
                        ...
                        if (r = q[k]) if ("object" === typeof r && "object" === typeof r[p]) for (W in W = void 0, r[p]) {
                            if (F[W]) {
                                k = r[p][W];
                                break
                            }
    ...
    b = function () {
        ...
        d = function (c, s, a, v) {
            ...
            (s = s.toLowerCase());
            if (void 0 === a && c[s]) for (l in c[s]) p = l.toLowerCase(), "compactdatamode" === p && (v.applyDSV = 1 == c[s][l]);
            if (c instanceof Array) for (l = 0; l < c.length; l += 1) g = "string" === typeof c[l] ? g + q(c[l]) : g + d(c[l], s, a, v); else {
...
FusionCharts.register("module", ["private", "modules.data.csv", function () {
    var d = this, m = d.window, z = d.core, q = m.parseInt, E = m.parseFloat, b = function (b) {
        return b
    }, K;
    K = function (b) {
        this.data = [];
    ...
    d.addDataHandler("CSV", {
        encode: function (b, c) {
            ...
            var s = z.transcodeData(d, "xml", "json") || {}, a = c.jsVars, v, m, C, g, f, l, p,
                F = s.chart || s.map || s.graph || {};
            p = Boolean(F.exporterrorcolumns || 0);
            var q = s.categories && s.categories[0] && s.categories[0].category || [],
                k = s.map && !s.chart || a && a.instanceAPI && "geo" === a.instanceAPI.defaultSeriesType, B = !1,
                A = !1, W = !1, r = !1;
            m = !1;
            var oa = b, ga = {}, $, V, ta, za, Aa, Z, U, na, H, T, fa;
            f = 0;
            v = new K({
            ...
            if (k) for (T in ga.geo = !0, q = a.hcObj && a.hcObj.entities && a.hcObj.entities.items || [], v.setRow(0, ["Id", " Short Name", "Long Name", "Value", "Formatted Value"]), a = 0, q) A = q[T], fa = A.eJSON, m = A.value, v.setRow(++a, [T, fa.shortLabel, fa.label, void 0 === m ? "" : m, A.formattedValue]); else if (void 0 !== ($ = s.dials && s.dials.dial || s.pointers && s.pointers.pointer || s.value)) if (ga.gauge = !0, "string" === typeof $) v.set(0, 0, oa($)), ga.singlevalue = !0, "string" ===
            typeof s.target && (v.set(0, 1, oa(s.target)), ga.bullet = !0); else for (v.setRow(0, ["Id", "Value"]), ga.multivalue = !0, a = 0, l = 1, f = $.length; a < f; a += 1, l += 1) v.setRow(l, [l, oa($[a].value)]); else if ($ = s.dataset || !(s.data instanceof Array) && []) {
                ga.multiseries = !0;
                C = 1;
                ...
                for (a = 0; a < Z; a += 1) for (na = $, na[a].dataset ? (na = na[a].dataset,
            ...
            0 < v.rowCount && void 0 === v.get(0, 0) && v.set(0, 0, F.xaxisname ||
                "Label");
            return {data: v.toString(), error: void 0, predictedFormat: ga}
        }, transportable: !1
    });
...
FusionCharts.register("module", ["private", "modules.renderer.js", function () {
    var d = this, m = d.window, z = m.document, q = d.core.options, E = /msie/i.test(m.navigator.userAgent) && !m.opera,
        b = Boolean(m.SVGAngle || z.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1")),
        K = function () {
        }, I = d.hcLib = {cmdQueue: []},
        c = I.moduleCmdQueue = {base: [], charts: [], powercharts: [], widgets: [], maps: []},
        s = I.moduleDependencies = {}, a = I.moduleMeta = {
        ...
        }, v = {}, O = I.getMetaSentence = function () {
            var a = {};
            return function (b) {
                b = b && b.replace(/(^\s*)|(\s*$)/g, "") || "";
            ...
            var p = b.length, s = 0, m;
            m = function () {
                if (s >= p) c && c(); else {
                    var F = b[s], C = F && F.match(/[^\/]*$/i)[0], ta = a[F];
                    s += 1;
                    if (F) {
                        if (g(C)) {
                            m();
            ...
            var c = a.options.containerBackgroundColor, f = a.options.containerBackgroundOpacity, g = a.jsVars.transparent;
    ...
    d.extend(K, {
        dataFormat: "json", ready: !1, policies: {
            ...
            I.cmdQueue.push({cmd: "render", obj: this, args: arguments})
        }, update: function () {
            I.cmdQueue.push({cmd: "update", obj: this, args: arguments})
        }, resize: function () {
            I.cmdQueue.push({cmd: "resize", obj: this, args: arguments})
        }, dispose: function () {
            var a = I.cmdQueue, b, c;
            b = 0;
            for (c = a.length; b < c; b += 1) a[b].obj === this && (a.splice(b, 1), --c, --b)
        }, load: function () {
            I.cmdQueue.push({cmd: "load", obj: this, args: arguments})
        }, config: function (a, b) {
            var c, f = this.jsVars, g = f.msgStore, f = f.cfgStore, d = this.options, l;
            l = {
            ...
            }, beforeDataUpdate: p, beforeDispose: function (a) {
...
FusionCharts.register("module", ["private", "modules.renderer.js-lib", function () {
    var d = this, m = d.window, z = m.document, q = m.navigator,
        E = Boolean(m.SVGAngle || z.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1")),
        b = /msie/i.test(q.userAgent) && !m.opera, K = m.parseFloat, I = /\s+/g, c = /^#?/, s = /^rgba/i, a = /[#\s]/ig,
        v = /\{br\}/ig, O = /(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i, C = Math.abs, g = Math.pow, f = Math.round,
        l = g(2, -24), p = Object.prototype.toString, F = "ontouchstart" in z, q = F && !(q.maxTouchPoints ||
        q.msMaxTouchPoints),
        Q = "http://www.fusioncharts.com?BS=FCHSEvalMark&utm_source=FCS_trial&pver=" + m.escape(d.core.version),
        k = !/fusioncharts\.com$/i.test(m.location.hostname), B = Math, A = B.max, W = B.min, r = {pageX: 0, pageY: 0},
        oa = d.hcLib || (d.hcLib = {}), ga = function (a) {
            var b = a.data, c = b.chart, h = c.paper, f = a.state, n = T(H(a.originalEvent)),
                g = n.target || n.originalTarget || n.srcElement || n.relatedTarget || n.fromElement,
                d = c.elements.resizeBox, l = b.layerX = n.pageX - b.chartPosLeft, L = b.layerY = n.pageY - b.chartPosTop,
                k = l - b.ox, G = L - b.oy,
                p = b.bBox, s = b.ox, r = b.oy, ca = b.zoomX, aa = b.zoomY, p = b.canvasY, m = b.canvasX, v = b.canvasW,
                B = b.canvasH, F = b.canvasX2, ta = b.canvasY2, q = b.strokeWidth, k = b.attr;
            switch (f) {
                case "start":
                    a = V(this);
                    ...
                    d.attr({x: 0, y: 0, width: 0, height: 0}).show();
                    break;
                case "end":
                    p = d.getBBox();
                    c =
            ...
            var b = a.data;
            a = a.originalEvent;
            var c = a.target || a.originalTarget || a.srcElement || a.relatedTarget || a.fromElement, h = a.type,
                f = a.layerX, n = a.layerY;
            ...
            var a =
                "innerWidth", b = "innerHeight", c = z.documentElement || z.body, h = c;
            "innerWidth" in m ? h = m : (a = "clientWidth", b = "clientHeight");
            return function () {
                return {width: h[a], height: h[b], scrollTop: c.scrollTop, scrollLeft: c.scrollLeft}
            }
        }(), V = function (a, b) {
        ...
        za = function (a, b) {
            ...
            b = T(H(b));
            var c = b.pageX, h = b.pageY, f = V(a);
            return {chartX: c - f.left, chartY: h - f.top, pageX: c, pageY: h}
        }, n = function (a) {
            ...
            for (var c = b.length, h = -1; c--;) if (a === b[c]) {
                h = c;
                break
            }
            return h
            ...
            if (b instanceof Array) for (n = 0; n < b.length; n += 1) {
                try {
                    g = a[n], d = b[n]
                } catch (L) {
                    continue
                ...
                if (null !== d && "object" === typeof d) if (l = p.call(d), "[object Object]" === l) {
                    if (null === g || "object" !== typeof g) g = a[n] = {};
                    l = sa(d, f);
                    -1 !== l ? g = a[n] = h[l] : Ea(g, d, c, h, f)
                } else "[object Array]" === l ? (null !== g && g instanceof Array || (g = a[n] = []), l = sa(d, f), -1 !== l ? g = a[n] = h[l] : Ea(g, d, c, h, f)) : a[n] = d; else a[n] = d
            }
            return a
        }, la = function (a, b, c) {
            if ("object" !==
            ...
            var c;
            if (b instanceof Array) for (c = b.length - 1; 0 <= c; --c) "object" !== typeof b[c] ? !0 === b[c] && a && a.splice && a.splice(c, 1) : p.call(b[c]) === p.call(a[c]) && ya(a[c], b[c]); else for (c in b) "object" !== typeof b[c] ? !0 === b[c] && a && a.splice && a.splice(c, 1) : p.call(b[c]) === p.call(a[c]) && ya(a[c], b[c]);
            return a
        }, Ia = function () {
            var a = /^@window_/g;
            return function (b,
                ...
                for (L = 0; L < l; L += 1) {
                    d = h[L];
                    n = f;
                    if (d.match(a)) g = m[d.replace(a, "")], f = f[g]; else {
            ...
            if (b) if (b.match(s)) h = b.split(","), f = h[0].slice(h[0].indexOf("(") + 1), n = h[1], g = h[2]; else {
            ...
            var a = {};
            return function (b) {
                var c = (b = b || this) && b.FCcolor || b, h = c.color, f = c.ratio, n = c.angle, g = c.alpha, d = c.r,
                    l = c.cx, L = c.cy, k = c.fx, G = c.fy, p = c.gradientUnits, s = c.x1, A = c.y1, r = c.x2, H = c.y2,
                    ca = 1, aa, m, v, B;
                ...
                f = f && (f + "").split(",") || [];
                g = (g || 0 === g) && (g + "").split(",") || [];
                if (h = h.split(",")) if (aa = "", 1 === h.length) v = h[0].replace(/^#?([a-f0-9]{3,6})/ig, "$1"), aa = g.length ? "rgba(" + Na(v).join(",") + "," + .01 * K(g[0]) + ")" : v.replace(/^#?([a-f0-9]{3,6})/ig, "#$1"); else {
                    b = 0;
                    ...
                    if (void 0 !== d || void 0 !== k || void 0 !== l ||
                        c.radialGradient) aa = "xr(" + [k, G, d, l, L, p].join() + ")" + aa; else {
                        aa = "-" + aa;
            ...
            b = b.replace(a, "");
            var h = parseInt(b, 16), f = Math.floor(h / 65536), n = Math.floor((h - 65536 * f) / 256);
        ...
        Ta = function (b, c) {
            ...
            c.prototype = {
                ...
                addAxisGridLine: function (c, h, f, n, g, d, l, L) {
                    var N = "" === f ? !1 : !0, k = 0 < n || 0 < d.match(b)[1] ? !0 : !1, G;
                    if (N || k) k || (d = "rgba(0,0,0,0)", n = .1), G = {
                        ...
                        text: f, style: c.labels.style, textAlign: h.textAlign,
                        align: h.align, verticalAlign: h.verticalAlign, rotation: 0, x: 0, y: 0
                    }), c.plotLines.push(G);
                    return G
                },
                addAxisAltGrid: function (a, b) {
                    if (!this.is3D) {
                        var c = L(a._lastValue, a.min), u = Z(a._altGrid, !1);
                        u && a.plotBands.push({isGrid: !0, color: a.alternateGridColor, to: b, from: c, zIndex: 1});
                        a._lastValue = b;
                        a._altGrid = !u
                    }
                },
                ...
                addVline: function (a, b, c, u) {
                    u = u._FCconf;
                    var h = u.isBar, f = u.divlineStyle, n = aa(b.label),
                        g = Boolean(L(b.showlabelborder, u.showVLineLabelBorder, 1)),
                        d = Boolean(L(b.showlabelbackground, 1)), D = Z(b.labelhalign, h ? "left" : "center"),
                        l = Z(b.labelvalign, h ? "middle" : "bottom").toLowerCase(), N = L(b.labelposition, 0),
                        k = L(b.lineposition,
                            .5), G = L(b.showvlines, u.showVLines, 1), p = L(b.alpha, u.vLineAlpha, 80),
                        ...
                        H = L(b.thickness, u.vLineThickness, 1), ca = .5 * H, m = Boolean(Number(Z(b.dashed, 0))),
                        v = L(b.dashlen, 5), B = L(b.dashgap, 2), F = u.smartLabel, T = parseInt(f.fontSize, 10) + 2,
                        ta = 0, C = L(b.rotatelabel, u.rotateVLineLabels) ? 270 : 0, k = 0 > k || 1 < k ? .5 : k,
                        N = 0 > N || 1 < N ? 0 : N;
                    F.setStyle(f);
                    F = F.getOriSize(n);
                    s = qa(s, G ? p : "0");
            ...
            return function (c, h, f, n, g, d, N, L) {
                ...
                n = Math.abs(c - h);
                if (!1 === d && !1 === g && L) if (0 < c && 0 > h) for (f = !1, g = 10 < k ? k / 10 : k, L = a(h, c, N, g, !1), d = L - (N + 1) * g; !1 === f;) {
                    if (d += (N + 1) * g, b(d, N, g)) if (L = d - n, G =
                            d / (N + 1), s = Math.min(Math.abs(h), c), p = s == Math.abs(h) ? -1 : 1, 0 === N) f = !0; else for (r = 1; r <= Math.floor((N + 1) / 2); r++) A = G * r, !(A - s > L) && A > s && (H = d - A, H / G == Math.floor(H / G) && A / G == Math.floor(A / G) && (n = d, c = -1 == p ? H : A, h = -1 == p ? -A : -H, f = !0))
                } else f = a(h, c, N, k, !0), L = f - n, n = f, 0 < c ? c += L : h -= L; else L && (f = function (a, c, u) {
                    for (var h = 0, f = 1, n; ;) {
                        n = a + h * f;
                        n = 0 === n ? 1 : n;
                        if (b(c, n, u)) break;
                ...
                return {
                    Max: c, Min: h, Range: n, interval: k, divGap: (c -
                        h + aa) / (N + 1)
                }
            }
        }(), Qb = function () {
            var a = function (a, b, c) {
                var u = c.jsVars && c.jsVars.smartLabel, h = a.offsetWidth, f = a.offsetHeight, n = this.chart;
                a = this.title;
                var g = c._chartMessageImageStyle, d = !1, l;
            ...
            a.prototype = {
                ...
                credits: {href: Q, text: "FusionCharts XT Trial", enabled: k},
                legend: {enabled: !1},
            ...
            return function (a, b, h, f, n, g, d) {
                var l, k = h.trendStyle, p, s, A, r, H, ca, m, v, B, F, T, ta, C, q = g ? "xAxis" : "dataLabels";
                if (g ? h.showVLines : h.showTrendlines) for (l = 0, s = a.length; l < s; l += 1) if ((C = a[l]) && C.line) for (p = 0, A = C.line.length; p < A; p += 1) r = C.line[p], F = h.numberFormatter.getCleanValue(Z(r.startvalue,
            ...
            var f, n = h[a];
            n || (n = function () {
            }, n.prototype = c instanceof kb ? c : new kb, n.prototype.constructor = n, n = h[a] = new n);
            c && (n.base = c);
            n.name = a;
            ...
            return this instanceof h ? (a = function () {
            }, a.prototype = n, a.prototype.constructor =
                a, new a) : n
        }, G = function () {
            var a = [{
                regex: /((^|[^\\])((\\)\\)*\$cleanvalue)/ig,
            ...
            return function () {
                var c = arguments[0], h = arguments[1], f, n, g, d, l;
                Y(h) || (h = b);
                if (c) for (l = h.length, d = 0; d < l; d +=
                    1) if (g = a[h[d]]) f = ta(za((n = arguments[g.argIndex]) && n[g.argKey], "") + ""), c = c.replace(g.regex, "$2$4" + (g.parsingMethod ? g.parsingMethod(f) : f)), c = c.replace(g.escapeRegex, "$2$4$5");
                return c
            }
        }();
    ...
    d.extend(oa, {
        ...
        regex: {
            stripWhitespace: I,
            dropHash: c, startsRGBA: s, cleanColorCode: a, breakPlaceholder: v, hexcode: /^#?[0-9a-f]{6}/i
        },
        ...
        plotEventHandler: function (a, c, h) {
            c = c || {};
            var f = c.type, n = fa(a.container, c), n = la(n, this.data("eventArgs")), g = a.logic.fireGroupEvent,
                l = this.data("groupId"), k = function (a, h) {
            ...
            "click" !== f && "mouseup" !== f && "touchend" !== f || !/click/i.test(h) || a.linkClickFN.call({link: n.link}, a)
        },
        ...
        bindSelectionEvent: function (a, b) {
            b = b || {};
            var c = a.options.chart, h = a.container, f = c.zoomType, n = la({}, b.attr || {}),
                g = n["stroke-width"] = L(n.strokeWidth, n["stroke-width"], 1), d = V(h),
        ...
        createContextMenu: function (a) {
            var c =
                    a.chart, h = c.smartLabel, f = c.logic.hcJSON && c.logic.hcJSON.chart.useRoundEdges, g = oa.Raphael,
                d = function (a) {
                    var b = a.menufillcolor && n(a.menufillcolor), c = a.menulabelcolor && n(a.menulabelcolor),
                        h = a.menufillhovercolor && n(a.menufillhovercolor);
                    a = a.menulabelhovercolor && n(a.menulabelhovercolor);
                    return {attrs: {backgroundColor: b, color: c}, hover: {backgroundColor: h, color: a}}
                }(c.definition.chart), l = function (a, b, c) {
                    b = b || {};
                ...
                }(a.basicStyle, a.hover, d.hover), k = function (a, b, c) {
                    b = la({}, b || {});
                    b = la(b, a);
                    return {
                ...
                }(a.basicStyle, a.attrs, d.attrs), L = {
                    textAlign: "left",
                    align: "left",
                    paddingLeft: "5px",
                    paddingRight: "5px",
                ...
                p = a.position, r = a.verticalPadding || 3, s = a.horizontalPadding || 6, H = {}, aa, m, ca, v, B, F, T,
                ta, C, q, Y, fa, sa;
            if (c) aa = V(c.container); else return !1;
            v = function () {
                var a = H.items, c = a.length, n = 0, u = 0, g = 0, d, t;
                ...
                u = a.length;
                for (c = 0; c < u; c += 1) if (d = a[c], H.menuItems[c]) H.menuItems[c].label.innerHTML = d.text; else {
                    H.menuItems[c] = {};
            ...
            ta = function (a) {
                var b = a.x;
                a = a.y;
                var h = {x: b, y: a}, n = H.width, f = H.height, u = c.chartHeight, t = c.chartWidth;
            ...
            Y = function () {
                var a = H.menuItems[this._itemIdx], b;
                T();
            ...
            H.hideItem = function (a) {
                a = this.menuItems[a];
                var b = this.height, c = this.itemH;
                a && !a._isHidden && (a.box.style.display = "none", this.height = b - c, a._isHidden =
                    !0, a = ta(p), this.left = a.x, this.top = a.y)
            };
            H.redraw = function () {
        ...
        getLinkAction: function (a, b) {
            ...
            return function (h) {
                ...
                var n = a.chart || a.map || {}, f = L(n.unescapelinks, 1), n = L(n.clickurloverridesplotlinks, 0),
                    g = Aa(this.link, "");
                h = h && h.options && h.options.chart && h.options.chart.link || "";
                var l = this.options && this.options.chart && this.options.chart.link || "",
                    k = n ? Z(h, l, g) : Z(g, l, h), G = k, p, H, r, s, A, aa, ca, v, B, F;
                void 0 !== k && (f && (k = m.decodeURIComponent ? m.decodeURIComponent(k) : m.unescape(k)), k = k.replace(/^\s+/, "").replace(/\s+$/,
                    ...
                    switch (A) {
                        case "j":
                            k = k.replace(/^j\s*\-/i, "j-");
                            p = k.indexOf("-", 2);
                            -1 === p ? Ia(k.slice(2)) : Ia(k.substr(2, p - 2).replace(/\s/g, ""), k.slice(p + 1));
                            break;
                        case "javascript":
                        ...
                        case "f":
                            k = k.replace(/^f\s*\-/i, "f-");
                            p = k.indexOf("-", 2);
                            -1 !== p ? (H = k.substr(2, p - 2)) && m.frames[H] ? m.frames[H].location =
                        ...
                        case "newmap":
                            ...
                            switch (aa) {
                                ...
                                case "json":
                                    var h =
                                        ca = k.substring(p + 1, k.length), n = {chart: {}}, g, h = h.toLowerCase();
                                    if (a.linkeddata) for (g = 0; g < a.linkeddata.length; g += 1) a.linkeddata[g].id.toLowerCase() === h && (n = a.linkeddata[g].linkedchart || a.linkeddata[g].linkedmap);
                                    v = n;
                                    aa = "json"
                            }
                            d.raiseEvent("linkedChartInvoked", {alias: B, linkType: aa.toUpperCase(), data: v}, b);
                            break;
                        default:
                            m.location.href = k
                    }
                    d.raiseEvent("linkClicked", {linkProvided: G, linkInvoked: k, linkAction: A && A.toLowerCase()}, b)
                }, 0))
            }
        },
        graphics: {
            parseAlpha: pa, convertColor: qa, getDarkColor: Ja, getLightColor: Ta,
            mapSymbolName: function (a, b) {
                ...
                k ? d = {
                    ...
                    FCcolor: {
                        color: a,
                        alpha: b, ratio: c, angle: d ? -h : h
                    }
                });
                return [d, {FCcolor: {color: f[0], alpha: g[0]}}]
            }, getAngle: function (a, b, c) {
                a = 180 * Math.atan(b / a) / Math.PI;
                2 == c ? a = 180 - a : 3 == c ? a += 180 : 4 == c && (a = 360 - a);
                return a
            }, parseColor: ib, getValidColor: function (a) {
                return O.test(ib(a)) && a
            }, HSBtoRGB: function (a) {
                var b = a[0], c = 0, h = 0, n = 0, g = [], g = a[1] / 100;
                a = a[2] / 100;
                var d = b / 60 - Math.floor(b / 60), k = a * (1 - g), l = a * (1 - d * g), g = a * (1 - (1 - d) * g);
                ...
                var b = a[0], c = a[1];
                a = a[2];
                var h = Math.max(Math.max(b, c), a), n = Math.min(Math.min(b, c), a), g = 0, d = 0;
...
window.FusionCharts && window.FusionCharts.register("module", ["private", "vendor.redraphael", function () {
    var d = this.hcLib, m = window.Raphael, z;
    (function () {
        (function (d, m) {
            var b = /[\.\/]/, z = function () {
            }, I = function (a, b) {
                return a - b
            }, c, s, a = {n: {}}, v = function (a, b) {
                a = String(a);
                var g = s, f = Array.prototype.slice.call(arguments, 2), d = v.listeners(a), p = 0, m, q = [], k = {},
                    B = [], A = c;
                c = a;
                for (var W = s = 0, r = d.length; W < r; W++) "zIndex" in d[W] && (q.push(d[W].zIndex), 0 > d[W].zIndex && (k[d[W].zIndex] = d[W]));
                for (q.sort(I); 0 > q[p];) if (m = k[q[p++]],
                        B.push(m.apply(b, f)), s) return s = g, B;
                for (W = 0; W < r; W++) if (m = d[W], "zIndex" in m) if (m.zIndex == q[p]) {
                    B.push(m.apply(b, f));
                    if (s) break;
                    do if (p++, (m = k[q[p]]) && B.push(m.apply(b, f)), s) break; while (m)
                } else k[m.zIndex] = m; else if (B.push(m.apply(b, f)), s) break;
                s = g;
                c = A;
            ...
            v.listeners = function (c) {
                c = c.split(b);
                var d = a, g, f, l, p, s, m, k, v = [d], A = [];
                l = 0;
                for (p = c.length; l < p; l++) {
                    k = [];
                    s = 0;
                    for (m = v.length; s < m; s++) for (d = v[s].n, g = [d[c[l]], d["*"]], f = 2; f--;) if (d = g[f]) k.push(d), A = A.concat(d.f || []);
                    v = k
                }
                return A
            };
            v.on = function (c, d) {
                ...
                for (var g = c.split(b), f = a, l = 0, p = g.length; l < p; l++) f = f.n, f = f.hasOwnProperty(g[l]) && f[g[l]] || (f[g[l]] = {n: {}});
                f.f = f.f || [];
                l = 0;
                for (p = f.f.length; l < p; l++) if (f.f[l] == d) return z;
                f.f.push(d);
                return function (a) {
                    +a == +a && (d.zIndex = +a)
                }
            ...
            v.off = v.unbind = function (c, d) {
                if (c) {
                    var g = c.split(b), f, l, p, s, m, k, B = [a];
                    s = 0;
                    for (m = g.length; s < m; s++) for (k = 0; k < B.length; k += p.length - 2) {
                        p = [k, 1];
                        f = B[k].n;
                        if ("*" != g[s]) f[g[s]] && p.push(f[g[s]]); else for (l in f) f.hasOwnProperty(l) && p.push(f[l]);
                        B.splice.apply(B, p)
                    }
                    s = 0;
                    for (m = B.length; s < m; s++) for (f = B[s]; f.n;) {
                        if (d) {
                            if (f.f) {
                                k = 0;
                                for (g = f.f.length; k < g; k++) if (f.f[k] == d) {
                                    f.f.splice(k, 1);
                                    break
                                }
                                !f.f.length && delete f.f
                            }
                            for (l in f.n) if (f.n.hasOwnProperty(l) &&
                                f.n[l].f) {
                                p = f.n[l].f;
                                k = 0;
                                for (g = p.length; k < g; k++) if (p[k] == d) {
                                    p.splice(k, 1);
                                    break
                                }
                                !p.length && delete f.n[l].f
                            }
                        } else for (l in delete f.f, f.n) f.n.hasOwnProperty(l) && f.n[l].f && delete f.n[l].f;
                        f = f.n
                    }
                } else v._events = a = {n: {}}
            };
            ...
            "undefined" != typeof module && module.exports ? module.exports = v : m || "undefined" == typeof define ? d.eve = v : define("eve",
                [], function () {
                    return v
                })
        })(this, !0);
        (function (d, m, b) {
            ...
            function I(a, b) {
                for (var c = [], e = 0, t = a.length; t - 2 * !b > e; e += 2) {
                    var h = [{x: +a[e - 2], y: +a[e - 1]}, {x: +a[e], y: +a[e + 1]}, {
                        x: +a[e + 2],
                        y: +a[e + 3]
                    }, {x: +a[e + 4], y: +a[e + 5]}];
                    b ? e ? t - 4 == e ? h[3] = {x: +a[0], y: +a[1]} : t - 2 == e && (h[2] = {
                        x: +a[0],
                        y: +a[1]
                    }, h[3] = {x: +a[2], y: +a[3]}) : h[0] = {
                        x: +a[t - 2],
                        y: +a[t - 1]
                    } : t - 4 == e ? h[3] = h[2] : e || (h[0] = {x: +a[e], y: +a[e + 1]});
            ...
            function c(a, b, c, e, t, h, w, J, n) {
                null == n && (n = 1);
                n = (1 < n ? 1 : 0 > n ? 0 : n) / 2;
                for (var M = [-.1252, .1252, -.3678, .3678, -.5873, .5873, -.7699, .7699, -.9041, .9041, -.9816, .9816], f = [.2491, .2491, .2335, .2335, .2032, .2032, .1601, .1601, .1069, .1069, .0472, .0472], d = 0, g = 0; 12 > g; g++) var S = n * M[g] + n, k = S * (S * (-3 * a + 9 * c - 9 * t + 3 * w) + 6 * a - 12 * c + 6 * t) - 3 * a + 3 * c, S = S * (S * (-3 * b + 9 * e - 9 * h + 3 * J) + 6 * b - 12 * e + 6 * h) - 3 * b + 3 * e, d = d + f[g] * ma(k * k + S * S);
                return n * d
            }
            ...
            function a(a, e, t) {
                a = b._path2curve(a);
                e = b._path2curve(e);
                for (var h, w, J, n, M, f, d, g, S, k, R = t ? 0 : [], u = 0, l = a.length; u < l; u++) if (S = a[u], "M" == S[0]) h = M = S[1], w = f = S[2]; else {
                    "C" == S[0] ? (S = [h, w].concat(S.slice(1)), h = S[6], w = S[7]) : (S = [h, w, h, w, M, f, M, f], h = M, w = f);
                    for (var L = 0, da = e.length; L < da; L++) if (k = e[L], "M" == k[0]) J = d = k[1], n = g = k[2]; else {
                        "C" == k[0] ? (k = [J, n].concat(k.slice(1)), J = k[6], n = k[7]) :
                            (k = [J, n, J, n, d, g, d, g], J = d, n = g);
                        var p;
                        var G = S, X = k;
                        p = t;
                        var H = b.bezierBBox(G), s = b.bezierBBox(X);
                        if (b.isBBoxIntersect(H, s)) {
                            ...
                            for (ka = 0; ka < H; ka++) for (G = 0; G < s; G++) {
                                var rb = D[ka], Fa = D[ka + 1], X = r[G], ic = r[G + 1], N = .001 > Ea(Fa.x -
                                    rb.x) ? "y" : "x", aa = .001 > Ea(ic.x - X.x) ? "y" : "x", ca;
                                ca = rb.x;
                                var v = rb.y, Yb = Fa.x, B = Fa.y, T = X.x, ta = X.y, ba = ic.x, F = ic.y;
                                if (sa(ca, Yb) < Y(T, ba) || Y(ca, Yb) > sa(T, ba) || sa(v, B) < Y(ta, F) || Y(v, B) > sa(ta, F)) ca = void 0; else {
                                    var jc = (ca * B - v * Yb) * (T - ba) - (ca - Yb) * (T * F - ta * ba),
                                        q = (ca * B - v * Yb) * (ta - F) - (v - B) * (T * F - ta * ba),
                                        C = (ca - Yb) * (ta - F) - (v - B) * (T - ba);
                                    if (C) {
                                        var jc = jc / C, q = q / C, C = +jc.toFixed(2), ha = +q.toFixed(2);
            ...
            function C(a, b, c, e, t, h) {
                ...
                var J = 3 * b, n = 3 * (e - b) - J, M = 1 - J - n, f = 3 * c, d = 3 * (t - c) - f, g = 1 - f - d;
                return function (a, b) {
                    var c = w(a, b);
                    return ((g * c + d) * c + f) * c
                }(a, 1 / (200 * h))
            ...
            function f(a, c, t, w, M, f) {
                t = L(t);
                var d, g, S, k, R, u, l = a.ms, da = {}, p = {}, X = {};
                if (w) for (u = 0, s = Oa.length; u < s; u++) {
                    var H = Oa[u];
                ...
                u = 0;
                for (var s = a.percents.length; u < s; u++) if (a.percents[u] == t || a.percents[u] > w * a.top) {
                    t = a.percents[u];
                    R = a.percents[u - 1] || 0;
                    l = l / a.top * (t - R);
                    k = a.percents[u + 1];
                ...
                if (d) {
                    if (g) g.initstatus = w, g.start = new Date - g.ms * w; else {
                        for (var D in d) if (d.hasOwnProperty(D) && (G.hasOwnProperty(D) || c.ca[D])) switch (da[D] = c.attr(D), null == da[D] && (da[D] = h[D]), p[D] = d[D], G[D]) {
                            case Q:
                                X[D] = (p[D] - da[D]) / l;
                                break;
                            case "colour":
                                da[D] =
                                    b.getRGB(da[D]);
                                u = b.getRGB(p[D]);
                                X[D] = {r: (u.r - da[D].r) / l, g: (u.g - da[D].g) / l, b: (u.b - da[D].b) / l};
                                break;
                            case "path":
                                u = Ab(da[D], p[D]);
                                H = u[1];
                            ...
                            case "transform":
                                u = c._;
                                if (s = e(u[D], p[D])) for (da[D] = s.from, p[D] = s.to, X[D] = [], X[D].real = !0, u = 0, s = da[D].length; u < s; u++) for (X[D][u] = [da[D][u][0]], ka = 1, r = da[D][u].length; ka < r; ka++) X[D][u][ka] = (p[D][u][ka] - da[D][u][ka]) / l; else s =
                                    c.matrix || new v, u = {
                                    _: {transform: u.transform}, getBBox: function () {
                                        return c.getBBox(1)
                                    }
                            ...
                            case "csv":
                                s = n(d[D]).split(Ta);
                                H = n(da[D]).split(Ta);
                                if ("clip-rect" == D) for (da[D] = H, X[D] = [], u = H.length; u--;) X[D][u] = (s[u] - da[D][u]) / l;
                                p[D] = s;
                                break;
                            default:
                        ...
                        if (!D) if ((D = n(u).match(Wa)) && 5 == D.length) {
                            var A = D;
                            D = function (a) {
            ...
            b.eve = m;
            z = b;
            var p, F = "apply", Q = "number", k = "array", B = Array.prototype.slice, A = Array.prototype.splice,
                W = function () {
                    return function () {
                    }.hasOwnProperty("prototype")
                }(), r = {doc: document, win: d}, oa = Object.prototype.hasOwnProperty.call(r.win, "Raphael"),
                ga = r.win.Raphael, $ = r.doc, V = r.win, ta = b.supportsTouch = "createTouch" in $, za =
            ...
            var Z = function () {
                ...
                na = {circle: 1, rect: 1, path: 1, ellipse: 1, text: 1, image: 1, group: 1},
                ...
                T = b._touchMap = {mousedown: "touchstart", mousemove: "touchmove", mouseup: "touchend"},
                fa = b._dragEventMap = {dragstart: "mousedown", dragmove: "mousemove", dragend: "mouseup"},
                n = V.String, L = V.parseFloat, ca = V.parseInt, aa = V.Math, sa = aa.max, Y = aa.min, Ea = aa.abs,
                la = aa.pow, ya = aa.cos, Ia = aa.sin, ma = aa.sqrt, Ma = aa.round, pa = aa.PI, qa = pa / 180,
                La = 180 / pa, Ya = n.prototype.toLowerCase, ib = n.prototype.toUpperCase,
                Ja = V.Object.prototype.toString, Ta = /[, ]+/, Na = /\{(\d+)\}/g;
            b._ISURL = /^url\(['"]?([^\)]+?)['"]?\)$/i;
            ...
            var yb = {NaN: 1, Infinity: 1, "-Infinity": 1}, kb = {hs: 1, rg: 1}, h = b._availableAttrs = {
                "arrow-end": "none",
                "arrow-start": "none",
                blur: 0,
                ...
                a = Ab(a);
                t = 0;
                for (w = a.length; t < w; t++) for (n = a[t], h = 1, J = n.length; h < J; h += 2) c = b.x(n[h],
            ...
            var Ha = b._lastArgIfGroup = function (a, c) {
                ...
                var c = a[0], e, t;
                if (b.is(c, "object") && !b.is(c, "array") && "group" !== c.type) for (e = c, c.path && (c = c.path) && !b.is(c, "string") && b.is(c[0], k), c = 1, t = arguments.length; c <
                t; c += 2) e[arguments[c]] || (e[arguments[c]] = arguments[c + 1]); else for (e = {}, c = 1, t = arguments.length; c < t; c += 2) e[arguments[c]] = a[(c - 1) / 2] || arguments[c + 1];
                return e
                ...
                if (b instanceof Array) for (h = 0; h < b.length; h += 1) {
                    ...
                    if ("object" !== typeof J) c && void 0 === J || (a[h] = J); else {
                        if (null === w || "object" !== typeof w) w = a[h] = J instanceof Array ? [] : {};
                        n = checkCyclicRef(J, t);
                        -1 !== n ? w = a[h] = e[n] : xa(w, J, c, e, t)
                    }
                } else for (h in b) {
                    try {
                        w =
                    ...
                    if (null !== J && "object" === typeof J) if (n = Ja.call(J), "[object Object]" === n) {
                        if (null === w || "object" !== typeof w) w = a[h] = {};
                        n = checkCyclicRef(J, t);
                        -1 !== n ? w = a[h] = e[n] : xa(w, J, c, e, t)
                    } else "[object Array]" === n ? (null !== w && w instanceof Array || (w = a[h] = []), n = checkCyclicRef(J, t), -1 !== n ? w = a[h] = e[n] : xa(w, J, c, e, t)) : a[h] = J; else a[h] = J
                }
                return a
            };
            b.extend = function (a, b, c) {
                if ("object" !== typeof a && "object" !== typeof b) return null;
                if ("object" !== typeof b || null === b) return a;
                "object" !== typeof a && (a = b instanceof
                Array ? [] : {});
                xa(a, b, c);
                return a
            };
            ...
            var fb = function (a) {
                ...
                var h = {r: a *= 255, g: c *= 255, b: e *= 255, hex: b.rgb(a, c, e), toString: nb};
            ...
            b.color = function (a) {
                ...
                b.is(a, "object") && "h" in a && "s" in a && "b" in a ? (c = b.hsb2rgb(a), a.r =
                    c.r, a.g = c.g, a.b = c.b, a.hex = c.hex) : b.is(a, "object") && "h" in a && "s" in a && "l" in a ? (c = b.hsl2rgb(a), a.r = c.r, a.g = c.g, a.b = c.b, a.hex = c.hex) : (b.is(a, "string") && (a = b.getRGB(a)), b.is(a, "object") && "r" in a && "g" in a && "b" in a ? (c = b.rgb2hsl(a), a.h = c.h, a.s = c.s, a.l = c.l, c = b.rgb2hsb(a), a.v = c.b) : (a = {hex: "none"}, a.r = a.g = a.b = a.h = a.s = a.v = a.l = -1));
                a.toString = nb;
                return a
            };
            ...
            b.rgb2hsb = function (a, b, c) {
                ...
                return {h: a, s: 0 == t ? 0 : t / e, b: e, toString: Pa}
            };
            b.rgb2hsl = function (a, b, c) {
                ...
                e = (e + t) / 2;
                return {h: a, s: 0 == h ? 0 : .5 > e ? h / (2 * e) : h / (2 - 2 * e), l: e, toString: Oc}
            };
            ...
            var ea = b._cacher = function (a, b, c) {
                function e() {
                    var t = B.call(arguments, 0), h = t.join("␀"), w = e.cache = e.cache || {}, J = e.count =
                        e.count || [];
                    if (w.hasOwnProperty(h)) {
                        a:for (var t = J, J = h, n = 0, M = t.length; n < M; n++) if (t[n] === J) {
            ...
            b.getRGB = ea(function (a) {
                ...
                if (!a || (a = n(a)).indexOf("-") + 1) return {r: -1, g: -1, b: -1, hex: "none", error: 1, toString: K};
                ...
                return {
                    r: -1,
                    g: -1, b: -1, hex: "none", error: 1, toString: K
                }
            }, b);
            b.tintshade = ea(function (a, c) {
                ...
                0 > c && (c *= -1, t = 0);
                1 < c && (c = 1);
                t = 0 === c ? e : {r: t - (t - e.r) * c, g: t - (t - e.g) * c, b: t - (t - e.b) * c, toString: K};
            ...
            b.parsePathString = function (a) {
                ...
                var e = {a: 7, c: 6, h: 1, l: 2, m: 2, r: 4, q: 4, s: 4, t: 2, v: 1, z: 0}, t = [];
                ...
                n(a).replace(Qb, function (a, b, c) {
                    ...
                    if ("r" == a) t.push([b].concat(h)); else for (; h.length >= e[a] && (t.push([b].concat(h.splice(0, e[a]))), e[a]);) ;
                });
            ...
            b.findDotsAtSegment = function (a, b, c, e, t, h, w, J, n) {
                var M = 1 - n, f = la(M, 3), d = la(M, 2), g = n * n, u = g * n,
                    S = f * a + 3 * d * n * c + 3 * M * n * n * t + u * w,
                    f = f * b + 3 * d * n * e + 3 * M * n * n * h + u * J,
                    d = a + 2 * n * (c - a) + g * (t - 2 * c + a), u = b + 2 * n * (e - b) + g * (h - 2 * e + b),
                    k = c + 2 * n * (t - c) + g *
                        (w - 2 * t + c), g = e + 2 * n * (h - e) + g * (J - 2 * h + e);
                a = M * a + n * c;
                b = M * b + n * e;
                t = M * t + n * w;
                h = M * h + n * J;
                ...
                (d > k || u < g) && (J += 180);
                return {x: S, y: f, m: {x: d, y: u}, n: {x: k, y: g}, start: {x: a, y: b}, end: {x: t, y: h}, alpha: J}
            };
            ...
            var Zb = b.pathBBox = function (a) {
                    ...
                    t = sa[F](0, t);
                    h = sa[F](0, h);
                    h = {x: a, y: w, x2: t, y2: h, width: t - a, height: h - w};
                    b.bbox = eb(h);
                    return h
                }, P = function (a) {
                    a = eb(a);
                    ...
                    for (var M = a.length; n < M; n++) {
                        ...
                        } else for (e[n] = [], "m" == d[0] && (w = d[1] + t, J = d[2] + h), f = 0, g = d.length; f < g; f++) e[n][f] = d[f];
                        d = e[n].length;
                        switch (e[n][0]) {
                            case "z":
                                t = w;
                ...
                Jb = b._pathToAbsolute = function (a) {
                    ...
                    for (var M = 3 == a.length && "M" == a[0][0] && "R" == a[1][0].toUpperCase() && "Z" == a[2][0].toUpperCase(), f, d = n, g = a.length; d < g; d++) {
                        ...
                        } else if ("R" == f[0]) u = [t, h].concat(f.slice(1)), e.pop(), e = e.concat(I(u, M)), n = ["R"].concat(f.slice(-2)); else for (u = 0, S = f.length; u < S; u++) n[u] = f[u];
                        switch (n[0]) {
                            case "Z":
                                t =
                                    w;
                    ...
                    var M = 120 * pa / 180, d = qa * (+t || 0), g = [], u, S = ea(function (a, b, c) {
                        var e = a * ya(c) - b * Ia(c);
                        a = a * Ia(c) + b * ya(c);
                        return {x: e, y: a}
                    });
                    if (f) l = f[0], u = f[1], h = f[2], k = f[3]; else {
                        u =
                            S(a, b, -d);
                        a = u.x;
                        b = u.y;
                        ...
                        h = k * c * l / e + (a + n) / 2;
                        var k = k * -e * u / c + (b + J) / 2, l = aa.asin(((b - k) / e).toFixed(9));
                    ...
                    var J = t - 2 *
                        c + a - (w - 2 * t + c), f = 2 * (c - a) - 2 * (t - c), M = a - c,
                        d = (-f + ma(f * f - 4 * J * M)) / 2 / J, J = (-f - ma(f * f - 4 * J * M)) / 2 / J, g = [b, n],
                        u = [a, w];
                    "1e12" < Ea(d) && (d = .5);
                    "1e12" < Ea(J) && (J = .5);
                    ...
                    0 < J && 1 > J && (d = Tb(a, b, c, e, t, h, w, n, J), u.push(d.x),
                        g.push(d.y));
                    return {min: {x: Y[F](0, u), y: Y[F](0, g)}, max: {x: sa[F](0, u), y: sa[F](0, g)}}
                }), Ab = b._path2curve = ea(function (a, b) {
                    var c = !b && xb(a);
                    if (!b && c.curve) return P(c.curve);
                    var e = Jb(a), t = b && Jb(b), h = {x: 0, y: 0, bx: 0, by: 0, X: 0, Y: 0, qx: null, qy: null},
                        w = {x: 0, y: 0, bx: 0, by: 0, X: 0, Y: 0, qx: null, qy: null}, n = function (a, b) {
                            var c, e;
                        ...
                        }, M = 0, d = sa(e.length, t && t.length || 0);
                    for (; M < d; M++) {
                        e[M] = n(e[M], h);
                        J(e, M);
                        t && (t[M] = n(t[M], w));
                        ...
                        f(e, t, h, w, M);
                        f(t, e, w, h, M);
                        var g = e[M], u = t && t[M], S = g.length, k = t && u.length;
                        h.x = g[S - 2];
                        h.y = g[S - 1];
                        h.bx =
                            L(g[S - 4]) || h.x;
            ...
            b._parseDots = ea(function (a) {
                ...
                e = 1;
                for (t = c.length - 1; e < t; e++) if (!c[e].offset) {
                    a = L(c[e - 1].offset || 0);
                    w = 0;
                    for (h = e + 1; h < t; h++) if (c[h].offset) {
                        w =
                            c[h].offset;
                        break
                    }
            ...
            var J = b._extractTransform = function (a, c) {
                ...
                c = n(c).replace(/\.{3}|\u2026/g,
                    a._.transform || "");
                var e = b.parseTransformString(c), t = 0, h = 0, w = 0, J = 1, f = 1, M = a._, w = new v;
                M.transform = e || [];
                if (e) for (var h = 0, d = e.length; h < d; h++) {
                    var g = e[h], u = g.length, S = n(g[0]).toLowerCase(), k = g[0] != S, R = k ? w.invert() : 0, l;
            ...
            b._getContainer = function (a, c, e, t) {
                ...
                } : {container: h, width: c, height: e} : {container: 1, x: a, y: c, width: e, height: t}
            };
            b.pathToRelative = Rb;
            b._engine = {};
            b.path2curve = Ab;
            ...
            (function (a) {
                ...
                a.add = function (a, b, c, e, t, h) {
                    var w = [[], [], []], J = [[this.a, this.c, this.e], [this.b, this.d, this.f], [0, 0, 1]];
                    b = [[a, c, t], [b, e, h], [0, 0, 1]];
            ...
            for (var R = function () {
                ...
                if (r.doc.addEventListener) return function (a, b, c, e) {
                    ...
                    h = function (t) {
                        var h = r.doc.documentElement.scrollTop ||
                            r.doc.body.scrollTop, w = r.doc.documentElement.scrollLeft || r.doc.body.scrollLeft, J;
                        if (ta && T.hasOwnProperty(za ? b : fa[b])) for (var n = 0, f = t.targetTouches && t.targetTouches.length; n < f; n++) if (J = t.targetTouches[n].target, J == a || "tspan" == J.nodeName && J.parentNode == a) {
                            J = t;
                            t = t.targetTouches[n];
                            t.originalEvent = J;
                            t.preventDefault = S;
                ...
                for (var c = a.clientX, e = a.clientY, t = r.doc.documentElement.scrollTop || r.doc.body.scrollTop, h = r.doc.documentElement.scrollLeft ||
                    ...
                    w = jc[J];
                    if (ta && "touchmove" === a.type) for (var n = a.touches.length, f; n--;) {
                    ...
                    if (!w.el.removed) {
                        var n = b._engine.getNode(w.el), M = n.nextSibling, d = n.parentNode, g = n.style.display;
                ...
                b[a] = Fa[a] = function (c, e) {
                    b.is(c, "function") && (this.events = this.events || [], this.events.push({
                        name: a, f: c, unbind: Yb(this.shape ||
                            this.node || r.doc, a, c, e || this)
                    }));
                    return this
                };
                b["un" + a] = Fa["un" + a] = function (b) {
                    for (var c = this.events || [], e = c.length; e--;) if (c[e].name == a && c[e].f == b) {
                        c[e].unbind();
                        c.splice(e, 1);
            ...
            Fa.mouseup = function (a, c, e) {
                ...
                Jc.push(e = {el: this, fn: a, scope: c});
            ...
            Fa.drag = function (a, c, e, t, h, w) {
                function n(J) {
                    ...
                    jc.push({el: this, move_scope: t, start_scope: h, end_scope: w});
            ...
            Fa.follow = function (a, c, e) {
                ...
                a.followers.push({
                    el: this, stalk: e = {before: "insertBefore", after: "insertAfter"}[e],
                    cb: c
                });
                e && this[e](a);
                return this
            ...
            U.group = function () {
                var a = arguments, c = Ha(a, !0), a = b._engine.group(this, a[0], c);
                return this.__set__ && this.__set__.push(a), this._elementsById[a.id] =
                    a
            };
            U.circle = function () {
                var a = arguments, c = Ha(a, !0), a = Ba(a, "cx", 0, "cy", 0, "r", 0, "fill", "none", "stroke", "#000"),
                    c = b._engine.circle(this, a, c);
                return this.__set__ && this.__set__.push(c), this._elementsById[c.id] = c
            };
            U.rect = function () {
                var a = arguments, c = Ha(a, !0),
                    a = Ba(a, "x", 0, "y", 0, "width", 0, "height", 0, "r", 0, "fill", "none", "stroke", "#000"),
                    c = b._engine.rect(this, a, c);
                return this.__set__ && this.__set__.push(c), this._elementsById[c.id] = c
            };
            U.ellipse = function () {
                var a = arguments, c = Ha(a, !0), a = Ba(a, "x", 0, "y", 0, "rx", 0, "ry",
                    0, "fill", "none", "stroke", "#000"), c = b._engine.ellipse(this, a, c);
                return this.__set__ && this.__set__.push(c), this._elementsById[c.id] = c
            };
            U.path = function () {
                var a = arguments, c = Ha(a, !0), a = Ba(a, "path", "", "fill", "none", "stroke", "#000"),
            ...
            U.getElementByPoint = function (a, b) {
                var c, e, t = this.canvas, h = r.doc.elementFromPoint(a, b);
                if (r.win.opera && "svg" == h.tagName) {
                    e = t.getBoundingClientRect();
                    c = t.ownerDocument;
                    var w = c.body, J = c.documentElement;
            ...
            Fa.isPointInside = function (a, c) {
                var e = this.realPath = this.realPath || ua[this.type](this), t;
            ...
            Fa.glow = function (a) {
                ...
                a = a || {};
                var b = (a.width || 10) + (+this.attr("stroke-width") || 1), c = a.fill || !1, e = a.opacity || .5,
                    t = a.offsetx || 0, h = a.offsety || 0;
                a = a.color || "#000";
                ...
                pd = d.requestAnimationFrame || d.webkitRequestAnimationFrame || d.mozRequestAnimationFrame || d.oRequestAnimationFrame || d.msRequestAnimationFrame || function (a) {
                    ...
                    for (var a = +new Date, c = 0; c < Oa.length; c++) {
                        ...
                        if (!e.el.removed && !e.paused) {
                            var t = a - e.start, h = e.ms, w = e.easing, n = e.from, J = e.diff, M = e.to, d = e.el, g = {},
                                u, S = {}, k;
                            ...
                            if (!(0 > t)) if (t < h) {
                                ...
                                for (l in n) if (n.hasOwnProperty(l)) {
                                    switch (G[l]) {
                                        ...
                                        case "transform":
                                            if (J[l].real) for (u =
                                                                    [], t = 0, w = n[l].length; t < w; t++) for (u[t] = [n[l][t][0]], M = 1, S = n[l][t].length; M < S; M++) u[t][M] = n[l][t][M] + R * h * J[l][t][M]; else u = function (a) {
                                                return +n[l][a] + R * h * J[l][a]
                                            }, u = [["m", u(0), u(1), u(2), u(3), u(4), u(5)]];
                                            break;
                                        case "csv":
                                            if ("clip-rect" == l) for (u = [], t = 4; t--;) u[t] = +n[l][t] + R * h * J[l][t];
                                            break;
                                        default:
            ...
            Fa.animateWith = function (a, c, e, t, h, w) {
                ...
                e = 0;
                for (t = Oa.length; e < t; e++) if (Oa[e].anim == c && Oa[e].el == a) {
            ...
            b.animation = function (a, c, e, t) {
                ...
                return w ? (e && (h.easing = e), t && (h.callback = t), new g({100: h}, c)) : new g(a, c)
            };
            ...
            Fa.status = function (a, b) {
                ...
                for (t = Oa.length; e < t; e++) if (h = Oa[e], h.el.id == this.id && (!a || h.anim == a)) {
            ...
            Fa.resume = function (a) {
                for (var b = 0; b < Oa.length; b++) if (Oa[b].el.id ==
            ...
            Fa.toFront = function () {
                ...
                var a = b._engine.getNode(this),
                    c = this.parent, e = this.followers, t;
            ...
            Fa.toBack = function () {
                if (this.removed) return this;
                var a = b._engine.getNode(this), c = this.parent, e = this.followers, t;
            ...
            Fa.insertAfter = function (a) {
                ...
                var c = b._engine.getNode(this), e = b._engine.getLastNode(a),
                    t = a.parent.canvas, h = this.followers, w;
            ...
            Fa.insertBefore = function (a) {
                if (this.removed) return this;
                var c = b._engine.getNode(this), e = b._engine.getNode(a), t = this.followers, h;
            ...
            var Lc = function (a) {
                ...
                this.length = 0;
                this.type = "set";
                if (a) for (var b = 0, c = a.length; b < c; b++) !a[b] || a[b].constructor != Fa.constructor && a[b].constructor != Lc || (this[this.items.length] = this.items[this.items.length] = a[b], this.length++)
            }, mb = Lc.prototype;
            mb.push = function () {
            ...
            mb.attr = function (a,
                                c) {
                if (a && b.is(a, k) && b.is(a[0], "object")) for (var e = 0, t = a.length; e < t; e++) this.items[e].attr(a[e]); else for (e = 0, t = this.items.length; e < t; e++) this.items[e].attr(a, c);
                return this
            };
            mb.clear = function () {
            ...
            mb.animate = function (a, c, e, t) {
                ...
                var h = this.items.length, w = h, n = this, J;
                if (!h) return this;
                t && (J = function () {
                    !--h && t.call(n)
                });
            ...
            mb.getBBox = function () {
                for (var a = [], b = [], c = [], e = [], t = this.items.length; t--;) if (!this.items[t].removed) {
            ...
            b.registerFont = function (a) {
                ...
                if (!a.svg) {
                    ...
                    for (var t in a.glyphs) if (a.glyphs.hasOwnProperty(t) && (c = a.glyphs[t], b.glyphs[t] = {
                            w: c.w,
                            k: {},
                            d: c.d && "M" + c.d.replace(/[mlcxtrv]/g, function (a) {
                                return {l: "L", c: "C", x: "z", t: "m", r: "l", v: "c"}[a] || "M"
                            }) + "z"
                        }, c.k)) for (var h in c.k) c.hasOwnProperty(h) && (b.glyphs[t].k[h] = c.k[h])
                }
                return a
            };
            U.getFont = function (a, c, e, t) {
                ...
                if (b.fonts) {
                    ...
                    var n;
                    if (h) for (w = 0, a = h.length; w < a && (n = h[w], n.face["font-weight"] != c || n.face["font-style"] != e && n.face["font-style"] || n.face["font-stretch"] != t); w++) ;
                    return n
                }
            };
            U.print = function (a, c, e, t, h, w, J) {
                ...
                if (t) {
                    ...
                    for (var u = 0, l = M.length; u < l; u++) {
                        if ("\n" == M[u]) d = da = f = 0, k += S; else var R = d && t.glyphs[M[u - 1]] || {},
                            da = t.glyphs[M[u]], f = f + (d ? (R.w || t.w) + (R.k && R.k[M[u]] || 0) + t.w * J : 0),
                            d = 1;
            ...
            U.add = function (a) {
                if (b.is(a, "array")) for (var c = this.set(), e = 0, t = a.length, h; e < t; e++) h = a[e] || {}, na.hasOwnProperty(h.type) && c.push(this[h.type]().attr(h));
                return c
            };
            b.format = function (a,
                                 c) {
            ...
            Fa.crisp = function () {
                var a = this.attrs, c, e = this.attr(["x", "y", "width", "height", "stroke-width"]),
            ...
            b.define = function (a, c, e, t, h, w) {
                var n;
                if (b.is(a, k)) for (w = 0, n = a.length; w < n; w++) b.define(a[w]); else if (b.is(a, "object")) b.define(a.name, a[a.name], a.ca, a.fn, a.e, a.data); else if (a && !b.fn[a]) return b.fn[a] = function () {
                    var w = arguments, n = c.apply(this, w), J;
                    if (t && b.is(t, "object")) for (J in t) n[J] = t[J];
                    if (h && b.is(h, "object")) for (J in h) n[J] && n[J](h[J]);
                    if (e) {
                        if (b.is(e, "function")) n.ca[a] = e; else for (J in e) n.ca[J] = e[J];
            ...
            (function () {
                if (b.svg) {
                    var a = String, c = parseFloat, e = parseInt, t = Math, h = t.max, w = t.abs, n = t.pow,
                        J = t.sqrt, M = /[, ]+/,
                    ...
                    var S = function (a, b) {
                        ...
                        R = {pad: "pad", redlect: "reflect", repeat: "repeat"}, da = function (e, M) {
                            if (!e.paper || !e.paper.defs) return 0;
                            var f = "linear", d = e.paper, g = (d.id + "-" + M).replace(/[\(\)\s%:,\xb0#]/g, "_"), u = .5,
                                da = .5, L, p, D, G, X, s = e.node, H = s.style, ka = b._g.doc.getElementById(g);
                            if (!ka) {
                                M = a(M).replace(b._radial_gradient, function (a, b) {
                                    ...
                                    G = b[5];
                                    X = b[6];
                                    var e = b[0], t = b[1], h = b[2], w = b[3], M = b[4], d = e && t, g;
                                    h && (L = /\%/.test(h) ? h : c(h));
                                ...
                                M = M.split(/\s*\-\s*/);
                                if ("linear" == f) {
                                    var ka = M.shift(), r = ka.match(/\((.*)\)/), A,
                                        r = r && r[1] && r[1].split(/\s*\,\s*/), ka = -c(ka);
                            ...
                            S(e, ka);
                            k(s, {fill: "url('" + b._url + "#" + g + "')", opacity: 1, "fill-opacity": 1});
                            H.fill = "";
                            H.opacity = 1;
                            ...
                            if ("path" == c.type) {
                                ...
                                if ("none" != S) {
                                    var d = "raphael-marker-" + S, D = "raphael-marker-" + n + S + da + L + "-obj" + c.id;
                                ...
                                } else t ? (t = c._.arrows.startdx * f || 0, f = b.getTotalLength(M.path) - t) : (t = 0, f = b.getTotalLength(M.path) - (c._.arrows.enddx * f || 0)), c._.arrows[n + "Path"] && k(J, {d: b.getSubpath(M.path, t, f)}), delete c._.arrows[n + "Path"], delete c._.arrows[n + "Marker"], delete c._.arrows[n + "dx"], delete c._.arrows[n + "Type"], delete c._.arrows[n + "String"];
                            ...
                            var h = D[a(e).toLowerCase()], w, n;
                            if (e = h || void 0 !== e && [].concat(e)) {
                                w = c.attrs["stroke-width"] || 1;
                                t = {round: w, square: w, butt: 0}[c.attrs["stroke-linecap"] || t["stroke-linecap"]] || 0;
                                n = e.length;
                                w = h ? w : 1;
                                for (h = []; n--;) h[n] = e[n] * w + (n % 2 ? 1 : -1) * t || e[n], 0 > h[n] && (h[n] =
                                    0);
                                b.is(e, "array") && k(c.node, {"stroke-dasharray": h.join(",")})
                            }
                        }, X = function (a, b) {
                            for (var c in b) d("raphael.attr." + c + "." + a.id, a, b[c], c), a.ca[c] && a.attr(c, b[c])
                        }, s = b._setFillAndStroke = function (c, t) {
                            if (c.paper.canvas) {
                                var n = c.node, J = c.attrs, d = c.paper, g = n.style, u = g.visibility;
                                g.visibility = "hidden";
                                for (var l in t) if (t.hasOwnProperty(l) && b._availableAttrs.hasOwnProperty(l)) {
                                    var R = t[l];
                                    J[l] = R;
                                    switch (l) {
                                        case "blur":
                                        ...
                                        case "clip-rect":
                                            ...
                                            if (s || 4 == D.length) {
                                                ...
                                                var X = k("clipPath"), ka = k(s ? "path" : "rect");
                                                X.id = b.createUUID();
                                                k(ka, s ? {
                                                ...
                                                k(n, {"clip-path": "url('" + b._url + "#" + X.id + "')"});
                                                c.clip = ka
                                            }
                                            !R && (R = n.getAttribute("clip-path")) && ((R = b._g.doc.getElementById(R.replace(/(^url\(#|\)$)/g,
                                                ""))) && R.parentNode.removeChild(R), k(n, {"clip-path": ""}), delete c.clip);
                                            break;
                                        case "path":
                                            "path" == c.type && (k(n, {d: R ? J.path = b._pathToAbsolute(R) : b._availableAttrs.path}), c._.dirty = 1, c._.arrows && ("startString" in c._.arrows && p(c, c._.arrows.startString), "endString" in c._.arrows && p(c, c._.arrows.endString, 1)));
                                            break;
                                        case "width":
                                            if (n.setAttribute(l, R), c._.dirty = 1, J.fx) l = "x", R = J.x; else break;
                                        case "x":
                                        ...
                                        case "cx":
                                            ...
                                            break;
                                        case "height":
                                            if (n.setAttribute(l, R), c._.dirty = 1, J.fy) l = "y", R = J.y; else break;
                                        case "y":
                                        ...
                                        case "cy":
                                            ...
                                            break;
                                        case "r":
                                            "rect" == c.type ? k(n, {rx: R, ry: R}) : n.setAttribute(l, R);
                                            c._.dirty = 1;
                                            break;
                                        case "src":
                                        ...
                                        case "fill":
                                            ...
                                            if (r) {
                                                var X = k("pattern"), A = k("image");
                                                X.id = b.createUUID();
                                                k(X, {x: 0, y: 0, patternUnits: "userSpaceOnUse", height: 1, width: 1});
                                                k(A, {x: 0, y: 0, "xlink:href": r[1]});
                                                X.appendChild(A);
                                                (function (a) {
                                                    b._preload(r[1],
                                                        function () {
                                                            var b = this.offsetWidth, c = this.offsetHeight;
                                                            k(a, {width: b, height: c});
                                                            k(A, {width: b, height: c});
                                                            d.safari()
                                                        })
                                                })(X);
                                            ...
                                            D = b.getRGB(R);
                                            if (!D.error) delete t.gradient, delete J.gradient, !b.is(J.opacity, "undefined") && b.is(t.opacity, "undefined") && k(n, {opacity: J.opacity}), !b.is(J["fill-opacity"], "undefined") && b.is(t["fill-opacity"], "undefined") && k(n, {"fill-opacity": J["fill-opacity"]}), c.gradient &&
                                            S(c); else if (("circle" == c.type || "ellipse" == c.type || "r" != a(R).charAt()) && da(c, R)) {
                                                if ("opacity" in J || "fill-opacity" in J) if (D = b._g.doc.getElementById(n.getAttribute("fill").replace(/^url\(#|\)$/g, ""))) D = D.getElementsByTagName("stop"), k(D[D.length - 1], {"stop-opacity": ("opacity" in J ? J.opacity : 1) * ("fill-opacity" in J ? J["fill-opacity"] : 1)});
                                                J.gradient = R;
                                                J.fill = "none";
                                                g.fill = "";
                                                break
                                            }
                                            D.hasOwnProperty("opacity") ? (k(n, {"fill-opacity": g.fillOpacity = 1 < D.opacity ? D.opacity / 100 : D.opacity}), c._.fillOpacityDirty = !0) :
                                        ...
                                        case "stroke":
                                            ...
                                            g[l] = D.hex;
                                            "stroke" == l && (D.hasOwnProperty("opacity") ? (k(n, {"stroke-opacity": g.strokeOpacity = 1 < D.opacity ? D.opacity / 100 : D.opacity}), c._.strokeOpacityDirty = !0) : c._.strokeOpacityDirty && b.is(J["stroke-opacity"], "undefined") && b.is(t["stroke-opacity"], "undefined") && (n.removeAttribute("stroke-opacity"),
                                        ...
                                        case "visibility":
                                            ...
                                            break;
                                        case "opacity":
                                            J.gradient && !J.hasOwnProperty("stroke-opacity") && k(n, {"stroke-opacity": 1 < R ? R / 100 : R});
                                        case "fill-opacity":
                                            if (J.gradient) {
                                                if (D =
                                                        b._g.doc.getElementById(n.getAttribute("fill").replace(/^url\(#|\)$/g, ""))) D = D.getElementsByTagName("stop"), k(D[D.length - 1], {"stop-opacity": R});
                                                break
                                            }
                                        default:
                            ...
                            if ("text" == e.type && (h.hasOwnProperty("text") || h.hasOwnProperty("font") || h.hasOwnProperty("font-size") || h.hasOwnProperty("x") || h.hasOwnProperty("y") ||
                                ...
                                if (h.hasOwnProperty("text") && (h.text !== w.text || e._textdirty)) {
                                    ...
                                    e._textdirty = !1
                                } else for (M = n.getElementsByTagName("tspan"), S = u = 0, l = M.length; S < l; S++) if (J = M[S], g = J.attributes[0], !g || "visibility" !== g.name && "visibility" !== g.nodeName || "hidden" !== g.value && "hidden" !== g.nodeValue) S ? k(J, {
                                    dy: f,
                                    x: w.x
                                }) : (g = M[1] && M[1].attributes[0], !g || "visibility" !== g.name && "visibility" !== g.nodeName || "hidden" !== g.value && "hidden" !== g.nodeValue || (u = t.floor(.5 *
                                    M.length)), k(M[0], {dy: f * (M.length - u) * d, x: w.x}));
                                k(n, {x: w.x, y: w.y});
                                e._.dirty = 1;
                                n = e._getBBox();
                                ...
                                f && b.is(f, "finite") && M[0] && k(M[0], {dy: f})
                            }
                        }, ka = function (a, c, e) {
                            e = e || c;
                    ...
                    r.transform = function (a) {
                        ...
                        this.clip && !c.clipispath && k(this.clip, {transform: this.matrix.invert()});
                        this.pattern && L(this);
                        this.node && k(this.node, {transform: this.matrix});
                    ...
                    r._getBBox = function () {
                        var a = this.node, b = {}, c = this.attrs, e, t;
                    ...
                    r.blur = function (a) {
                        if (0 !== +a) {
                            var c = k("filter"), e = k("feGaussianBlur");
                            this.attrs.blur = a;
                            c.id = b.createUUID();
                            k(e, {stdDeviation: +a || 1.5});
                            c.appendChild(e);
                            this.paper.defs.appendChild(c);
                            this._blur = c;
                            k(this.node, {filter: "url('" + b._url + "#" + c.id + "')"})
                    ...
                    b._engine.create = function () {
                        var a = b._getContainer.apply(0, arguments), c = a && a.container, e = a.x, t = a.y,
                            h = a.width, a = a.height;
                        if (!c) throw Error("SVG container not found.");
                        var w = k("svg"), n, e = e || 0, t = t || 0, h =
                            h || 512, a = a || 342;
                        k(w, {height: a, version: 1.1, width: h, xmlns: "http://www.w3.org/2000/svg"});
                    ...
                    b._engine.setViewBox = function (a, b, c, e, t) {
                        ...
                        var w = h(c / this.width, e / this.height), n = this.top, J = t ? "meet" : "xMinYMin", M;
                        null == a ? (this._vbSize && (w = 1), delete this._vbSize, M = "0 0 " + this.width + " " + this.height) : (this._vbSize = w, M = a + " " + b +
                            " " + c + " " + e);
                        for (k(this.canvas, {
                            viewBox: M,
                            preserveAspectRatio: J
                        }); w && n;) J = "stroke-width" in n.attrs ? n.attrs["stroke-width"] : 1, n.attr({"stroke-width": J}), n._.dirty = 1, n._.dirtyT = 1, n = n.prev;
                    ...
                    b.prototype._desc =
                        function (a) {
                            var c = this.desc;
                            if (c) for (; c.firstChild;) c.removeChild(c.firstChild); else this.desc = c = k("desc"), this.canvas.appendChild(c);
            ...
            (function () {
                if (b.vml) {
                    var a = String, c = parseFloat, e = Math, t = e.round, h = e.max, w = e.min, n = e.sqrt, J = e.abs,
                        M = /[, ]+/, f = b.eve, d = {M: "m", L: "l", C: "c", Z: "x", m: "t", l: "r", c: "v", z: "x"},
                        g = /([clmz]),?([^clmz]*)/gi, u = / progid:\S+Blur\([^\)]+\)/g, k = /-?[^,\s-]+/g,
                        R = {path: 1, rect: 1, image: 1}, S = {circle: 1, ellipse: 1}, l = function (c) {
                            ...
                            var t = b.matrix();
                            t.rotate(-a, .5, .5);
                            return {dx: t.x(c, e), dy: t.y(c, e)}
                        }, L = function (a, b, c, e, t, h) {
                            var w = a._, n = a.matrix, M = w.fillpos;
                            a = a.node;
                            var f = a.style, d = 1, g =
                                "", u = 21600 / b, k = 21600 / c;
                            f.visibility = "hidden";
                            if (b && c) {
                                ...
                                if (M || w.fillsize) if (e = (e = a.getElementsByTagName("fill")) && e[0]) a.removeChild(e), M && (t = da(h, n.x(M[0], M[1]), n.y(M[0], M[1])), e.position = t.dx * d + " " + t.dy * d), w.fillsize && (e.size = w.fillsize[0] * J(b) + " " + w.fillsize[1] * J(c)), a.appendChild(e);
                    ...
                    var D = function (b, c, e) {
                        ...
                        if (e.paper.canvas) {
                            e.attrs = e.attrs || {};
                            var J = e.node, f = e.attrs, d = J.style,
                            ...
                            if ("text" == e.type) {
                                ...
                                k = 0;
                                for (d = J.length; k < d; k++) if (J[k] in n) {
                                    e._.dirty = 1;
                                    break
                                }
                                ...
                                e.textpath.style["v-text-kern"] =
                                    !0
                            }
                        }
                    }, G = function (e, t, h) {
                        e.attrs = e.attrs || {};
                        var w = Math.pow, J = "linear", f = ".5 .5";
                        e.attrs.gradient = t;
                    ...
                    e.transform = function (c) {
                        ...
                        var e = this.paper._viewBoxShift,
                            t = e ? "s" + [e.scale, e.scale] + "-1-1t" + [e.dx, e.dy] : "", h;
                        e && (h = c = a(c).replace(/\.{3}|\u2026/g, this._.transform || ""));
                        b._extractTransform(this, t + c);
                        var e = this.matrix.clone(), w = this.skew;
                        c = this.node;
                        var t = ~a(this.attrs.fill).indexOf("-"), n = !a(this.attrs.fill).indexOf("url(");
                        e.translate(-.5, -.5);
                    ...
                    e.blur = function (a) {
                        var c = this.node.runtimeStyle, e = c.filter, e = e.replace(u, "");
                    ...
                    b._engine.group = function (a, c, e) {
                        var t = b._g.doc.createElement("div"), h = new s(t, a, e);
                    ...
                    b._engine.group.transform =
                        function (e) {
                            ...
                            var t = this.node.style, h = this.clip, w = this.paper._viewBoxShift,
                    ...
                    b._engine.image = function (a, c, e) {
                        ...
                        a = a.path(c, e);
                        e = a.attrs;
                        var t = a.node, h = t.getElementsByTagName("fill")[0];
                        e.src = c.src;
                        a.X = e.x = c.x;
                        a.Y = e.y = c.y;
                        a.W = e.width = c.w;
                    ...
                    b._engine.text = function (c, e, h) {
                        var w = H("shape"), n = H("path"), J = H("textpath");
                        x = e.x || 0;
                        y = e.y || 0;
                        text = e.text;
                    ...
                    b._engine.setViewBox = function (a, b, c, e, t) {
                        ...
                        var w = this.width, n = this.height, J = 1 / h(c / w, e / n), M,
                            d;
                        t && (M = n / e, d = w / c, c * M < w && (a -= (w - c * M) / 2 / M), e * d < n && (b -= (n - e * d) / 2 / d));
                        this._viewBox = [a, b, c, e, !!t];
                        this._viewBoxShift = {dx: -a, dy: -b, scale: J};
                    ...
                    b._engine.initWin = function (c) {
                        ...
                        try {
                            !e.namespaces.rvml && e.namespaces.add("rvml", "urn:schemas-microsoft-com:vml"), H = b._createNode = function (b, c) {
                                var t = e.createElement("<rvml:" + b + ' class="rvml">'), h;
                    ...
                    b._engine.create = function () {
                        var a = b._getContainer.apply(0, arguments), c = a.container, e = a.height, t = a.width,
                            h = a.x, a = a.y;
                        if (!c) throw Error("VML container not found.");
                        var w = new b._Paper, n = w.canvas = b._g.doc.createElement("div"), J = n.style, h = h || 0,
                            a = a || 0, t = t || 512, e = e || 342;
                        w.width = t;
                        w.height = e;
                        t == +t && (t += "px");
                        e == +e && (e += "px");
...
FusionCharts.register("module", ["private", "fusioncharts.redraphael.css", function () {
    var d = this.hcLib.Raphael, m = d.eve, z = d._g, q = d.fn, E = d.el, b = /[, ]+/, K = /\B([A-Z]{1})/g, I, c;
    I = function (b) {
        this.rules = {};
        this.ns = b || ""
    };
    ...
    c.setCssText = function (b) {
        var a = this.node;
        if (!a) if (b) a = this.getSheet(); else return;
    ...
    d.vml && m.on("raphael.attr.class", function (b) {
        var a = this.paper, c = "." + b, a = a._stylesheet && a._stylesheet.rules, d = this.parent, m = this.attrs,
            g = {}, f;
        ...
        if (c && a) {
            ...
            for (; d && d.attr;) {
                if (b = d.attr("class")) for (f in c = "." + b + " " + c, b = a[c], b) "color" === f && "text" === this.type && (f = "fill"), m[f] || g[f] ||
                (g[f] = b[f]);
                d = d.parent
            }
            this.css(g)
...
FusionCharts.register("module", ["private", "modules.renderer.js-raphaelexport", function () {
    var d = this.hcLib, m = d.Raphael, z = d.pluckNumber, q = d.pluck, E = m._availableAttrs, b = /^matrix\(|\)$/g,
        K = /\,/g, I = /\n|<br\s*?\/?>/ig, c = /[^\d\.]/ig, s = /[\%\(\)\s,\xb0#]/g, a = /group/ig, v = /&/g, O = /"/g,
        C = /'/g, g = /</g, f = />/g, l = 0;
    (function (d) {
        var m = Math, Q = parseFloat, k = m.max, B = m.abs, A = m.pow, W = String, r = /[, ]+/,
            oa = [{reg: /xmlns\=\"http\:\/\/www.w3.org\/2000\/svg\"/ig, repStr: ""}, {
                reg: /^.*<svg /,
                ...
                blur: function () {
                    ...
                    var f = a.attrs.gradient, g = "linear", l, r, H, v = .5, q = .5, n = r = "", L = "", ca, aa, C, Y;
                    l = f.replace(s, "_");
                    if (!c[l]) {
                    ...
                    var d = W(c.attrs["clip-rect"]), g = d.split(r), d = d.replace(s, "_") + "__" + l++;
                ...
                "text-anchor": function (a, b) {
                    ...
                    var d = b.attrs, k = d.text, l = q(d["font-size"], d.font, "10"), p = q(d["line-height"]), r, H, A;
                ...
                var d = "", g = {attrSTR: "", styleSTR: "", textSTR: "", attrs: c.attr()}, k = c.isShadow, l = "", p = "",
                    r, A, m = g.attrs;
                if ("none" === c.node.style.display || k) c.next && (d += $(c.next, f)); else {
                    for (r in m) if ("gradient" !== r && (void 0 !== E[r] || ga[r]) && void 0 !== m[r]) if (ga[r]) ga[r](c, g, f); else g.attrSTR += " " +
                        r + '="' + m[r] + '"';
...
FusionCharts.register("module", ["private", "modules.renderer.js-raphaelshadow", function () {
    ...
    E.svg ? (d && (E.el.dropshadow = function (b, d, a, v) {
        var q = this.node, C = this._.shadowFilter, g = this.paper.cacheShadows || (this.paper.cacheShadows = {}),
            f = "drop-shadow" + [b, d, a, v].join(" "), l;
        if ("none" === b) {
            if (C) {
                --C.use;
            ...
            filter: C,
            hash: f,
            offset: C.appendChild(K("feOffset", {result: "offOut", "in": "SourceGraphic", dx: z(b), dy: z(d)})),
            ...
            blur: C.appendChild(K("feGaussianBlur", {result: "blurOut", "in": "matrixOut", stdDeviation: m(z(a))})),
            blend: C.appendChild(K("feComposite",
                {"in": "SourceGraphic", in2: "blurOut", operator: "over"}))
        }, q.setAttribute("filter", 'url("' + E._url + "#" + C.id + '")'));
        return this
    }), I = function (c, d) {
        var a = this.__shadowscale, m = {}, q, C;
        ...
        a = this._.shadows ||
            (this._.shadows = []);
        var g, f, l, p, F;
        if (!this.__shadowblocked) if ("none" === b) for (; f = a.pop();) f.remove(); else for (m = E.color(m), m.error && (m = E.color("rgba(0,0,0,1)")), z instanceof Array ? (g = z[0], z = z[1]) : g = z, g = 1 / E.pick(g, 1), z = 1 / E.pick(z, 1), b = E.pick(b, 1) * g, d = E.pick(d, 1) * g, g = .05 * E.pick(m.opacity, 1), l = q(this.attr("stroke-width") || 1, 10) + 6, p = this.matrix.clone(), p.translate(b, d), F = 1; 3 >= F; F++) f = (a[F - 1] || this.clone().follow(this, I, !C && "before")).attr({
            stroke: m.hex, "stroke-opacity": g * F, "stroke-width": (l - 2 * F) * z, transform: p.toTransformString(),
...
FusionCharts.register("module", ["private", "modules.renderer.js-raphaelshapes", function () {
    var d = this.window, m = "createTouch" in d.document, z = /msie/i.test(d.navigator.userAgent) && !d.opera,
        q = d.Math, E = q.cos, b = q.sin, K = q.abs, I = q.pow, c = q.atan2, s = q.tan, a = q.acos, v = q.min,
        O = q.round, C = q.PI, g = q.sqrt, f = 2 * C, l = d.parseInt, p = d.parseFloat, F = String,
        Q = Array.prototype.slice, k = I(2, -24), B = "rgba(192,192,192," + (z ? .002 : 1E-6) + ")",
        A = this.hcLib.Raphael, W = A.eve, r = A._createNode, oa = A._setFillAndStroke, ga = A.el.constructor, $ = {
            speed: "optimizeSpeed",
            crisp: "crispEdges", precision: "geometricPrecision"
        }, V = {enabled: !1, "false": !1, 0: !1, disabled: !0, "true": !0, 1: !0},
        ta = {Q: "L", Z: "X", q: "l", z: "x", ",": " "}, za = /,?([achlmqrstvxz]),?/gi, Aa = /\s*\,\s*/g, Z,
        U = function () {
    ...
    A.define && A.define([{
        ...
        name: "cubepath", cubepath: function () {
            ...
            cubepath: function (a, b, c, d, f, g) {
                var k = this._.cubetop, l = this._.cubeside;
                a = a || 0;
                b = b || 0;
                c = c || 0;
                d = d || 0;
                ...
                var d = this._.cubetop, f = this._.cubeside, g = this.attr("cubepath") || [0, 0, 0, 0, 0, 0], k = g[2],
                    l = g[4], g = g[5], p;
                a = A.color(a);
        ...
        name: "scroller", scroller: function (a, b, c, d, f, g, k) {
            var l = this.group("scroller", k), r = l.attrs, m = l._.scroller = {};
            ...
            m.track = this.rect(l).mousedown(function (a) {
                ...
                H = A.animation({"scroll-position": a}, 2E3 * K(b - a), "easeIn");
                l.animate(H);
            ...
            "drop-shadow": function (a, b, c, d, f, g) {
                ...
                var b = this, c = b.paper, d = b._.scroller, f = b.attrs, g = f["scroll-display-buttons"],
                    k = f["scroll-repaint"], l, p;
                void 0 === g && (g = "none");
                ...
                a !== g && (f["scroll-display-buttons"] = a, "none" === a && d.start ? (d.arrowstart.remove(), delete d.arrowstart, d.arrowend.remove(), delete d.arrowend, d.start.unmouseup(d._mouseupStart), d.start.remove(), delete d.start, d.end.unmouseup(d._mouseupEnd), d.end.remove(), delete d.end) : (d.arrowstart = c.polypath(b), d.arrowend = c.polypath(b), d.start = c.rect(b).mousedown(function () {
                    var a;
                    0 !== (a = f["scroll-position"]) && (b.animate({"scroll-position": a - .1}, 100).animate(l = A.animation({"scroll-position": 0},
                    ...
                    var a;
                    1 !== (a = f["scroll-position"]) && (b.animate({"scroll-position": a + .1}, 100).animate(p = A.animation({"scroll-position": 1}, 4500 * (1 - a), "easeIn")), W("raphael.scroll.start." + b.id, b, a))
                ...
                var c = this.attrs, d = "horizontal" === c["scroll-orientation"], f = c["scroll-repaint"],
                    g = c["scroll-position"], k = this._.scroller, l = k.anchor;
                a = 1 < a ? 1 : 0 > a ? 0 : p(a);
                isNaN(a) && (a = g);
                ...
                var f = this.attrs, g = this._.scroller, k = f["scroll-ratio"], l = f["scroll-position"], p = 0,
                    r = c * k, f = "none" === f["scroll-display-buttons"];
                c && --c;
                a && (a += .5);
                d && --d;
                b && (b += .5);
                ...
                g.anchor.attr({height: d, width: r - 1, y: b, x: g.trackOffset + g.trackLength * l}).crisp()
            }, "scroll-repaint-vertical": function (a, b, c, d) {
                var f = this.attrs, g = this._.scroller, k = f["scroll-ratio"], l = f["scroll-position"],
                    p = 0, r = d * k, f = "none" === f["scroll-display-buttons"];
                c && --c;
                a && (a += .5);
                d && --d;
                b && (b += .5);
                ...
                g.anchorOffset = g.trackOffset + .5 * (r - 1);
                g.anchor.attr({
                    height: r - 1, width: c, y: g.trackOffset + g.trackLength *
                    l, x: a
                }).crisp()
            }, fill: function (a) {
                var b = this.attrs, c = this._.scroller, d = b["scroll-repaint"],
                    f = "flat" === b["scroll-display-style"], g = "horizontal" === b["scroll-orientation"],
                    k = {stroke: "none"}, l;
                ...
                c.track.attr(k);
                k.fill = f && A.tintshade(a, -.6).rgba ||
                    [270 * g, A.tintshade(a, .3).rgba + ":40", A.tintshade(a, -.7).rgba].join("-");
        ...
        name: "button", button: function (a, b, c, d, f, g) {
            ...
            g._.button = {
                bound: this.rect(g),
                tracker: this.rect(g).attr({fill: B, stroke: B, cursor: "pointer"}).data("compositeButton", g)
            };
            !A.is(f,
                "object") && (f = {});
            ...
            "button-active": function (a) {
                ...
                var b =
                    this.attrs, c = this._.button, d = c.symbol, f = this.attrs["button-repaint"];
                a = F(a || "");
                ...
                return {"button-symbol-padding": p(a)}
            }, "button-padding": function (a,
                                           b) {
                return {"button-padding": [null == a && (a = 5) || p(a), null == b && a || p(b)]}
            }, "button-repaint": function (a, b, c, d, f) {
                var g = this._.button, k = g.bound, l = g.label, p = g.symbol, r = this.attrs, m = r["button-padding"],
                    H = m[0], s = m[1], B, q;
                void 0 === a && (a = 0);
                void 0 === b && (b = 0);
                ...
                var f = this._.button, g = f.bound, k = f.symbol, l = f.label,
                    p = {normal: f.gradient, active: f.gradientActive, hover: f.gradientHover}[a];
        ...
        name: "trianglepath", trianglepath: function () {
            var a = arguments, b = A._lastArgIfGroup(a);
            ...
            trianglepath: function (a, b, c, d, f, k, l, p, r) {
                if (l || p || r) {
                    ...
                    this.attr({path: ["M", m[0].x, m[0].y, "Q", a, b, m[1].x, m[1].y, "L", m[2].x, m[2].y, "Q", c, d, m[3].x, m[3].y, "L", m[4].x, m[4].y, "Q", f, k, m[5].x, m[5].y, "L", m[0].x, m[0].y]})
                } else this.attr({path: ["M", a, b, "L", c, d, f, k, "Z"]})
            }
        }
    }]);
    A.ca["text-bound"] = function (a, b, c, d, f, g) {
        ...
        if ("text" ===
            ...
            k.attr({stroke: b, "stroke-width": c, fill: a, "shape-rendering": 1 === c && "crisp" || "", r: f});
    ...
    A.fn.symbol.ca = {
        symbol: function (a) {
            var b =
                A.is(a, "object") && 1 === arguments.length && !A.is(a, "function") ? a : arguments, c;
            b === a && (a = b[0]);
    ...
    A.addSymbol = function (a, b) {
        var c = A.is(b, "function") && (c = {}, c[a] = b, c) || a, d = A.fn.symbol.cache, f = [], g;
    ...
    A.svg ? (Z = "$1", na = function (a) {
        ...
        g._transform =
            g.transform;
        g.transform = H;
        A._setFillAndStroke(g, {fill: "none", stroke: "#000"});
        (d || b).canvas.appendChild(a);
        b = r("skew");
        b.on = !0;
        a.appendChild(b);
...
FusionCharts.register("module", ["private", "modules.renderer.js-htmlrenderer", function () {
    var d = this.hcLib, m = d.Raphael, z = d.dem, q = this.window, E = q.document,
        b = /msie/i.test(q.navigator.userAgent) && !q.opera, K = "VML" === m.type, I = d.hasTouch,
        c = {cursor: "cursor"}, s = {
            x: "left",
            y: "top",
            ...
            width: "width",
            height: "height"
        }, a = {fill: "backgroundColor", stroke: "borderColor", color: "color"}, v = {
            left: 0,
            top: 0,
            padding: 0,
            border: "none",
    ...
    g.prototype = {
        attr: function (d) {
            var g = this.element, p = {}, m, v, k, B, A, q, r;
            if ("object" !== typeof d) {
                if (!(p = this[d])) {
                    if ("string" === typeof d) g && g.getAttribute && (B = g.getAttribute(d));
                    else if (void 0 !== d && null !== d && "object" === typeof d) for (k in d) g.setAttribute(k, d[k]);
                    p = B
                }
                return p
            }
            for (m in d) {
                ...
                if (c[m]) {
                    ...
                    g.style[c[m]] = k;
                    v = !0
                } else if (s[m]) g.style[s[m]] = k + "px", v = !0; else if (a[m]) g.style[a[m]] = k && k.replace(/^#?([a-f0-9]+)/ig, "#$1") || "none", v = !0; else if (/^visibility$/i.test(m)) v = "hidden" === k, g.style.display = v ? "none" : "", this.hidden = v, v = !0; else if (/^opacity$/i.test(m)) g.style.opacity = k, b && (v = 100 * Number(k), g.style.filter = "progid:DXImageTransform.Microsoft.Alpha(Opacity=" +
                    v + ")"), v = !0; else if (/^innerhtml$/i.test(m)) {
...
FusionCharts.register("module", ["private", "modules.renderer.js-raphaeltooltip", function () {
    var d = this, m = d.window, z = m.document, q = z.body || z.getElementsByTagName("body")[0], E = d.hcLib,
        b = E.Raphael, K = b.eve, I = E.createElement, c = E.addEvent, s = E.removeEvent, a = E.getPosition,
        v = E.hasTouch, O = E.getTouchEvent, C = m.Math, g = C.ceil, f = C.floor, l = {}, p = m.screen.availHeight,
        F = m.screen.availWidth, Q = {"": 1, moz: 1, webkit: 1, o: 1, ms: 1},
        k = {borderRadius: "borderRadius", boxShadow: "boxShadow"}, B = /\-([a-z])/ig, A = function (a, b) {
            return b.toUpperCase()
        },
        W = function (a) {
            var c = r.forbiddenStyle, d, g, f;
            for (d in a) g = B.test(d) ? d.replace(B, A) : d, void 0 !== a[d] && !c[g] && (this[g] = a[d]), b.vml && /color/ig.test(g) && (this[g] = b.getRGB(this[g]).toString());
            for (d in k) if (this[d]) for (f in Q) this[f + d] = this[d]
        }, r = E.toolTip = {
    ...
    r.setup = function () {
        var a = r.container, c = r.textElement, g = r.style, f = r.defaultContainerStyle, k = r.forbiddenStyle, l;
    ...
    r.onelement = function (b) {
        if (!b.__tipProcessed) {
            var d = this.paper, g = "group" === this.type ? d && d._elementFromEvent(b) : this, f = d.__tipStyle;
    ...
    r.redraw = function () {
        if (!r.prevented && !r.blocked && r.currentTarget && r.currentTarget.__tipNeeded) {
            var a = r.currentTarget, b = a.paper, c = r.textElement, d = r.containerStyle, f = r.style, k = a.__tipText,
                a = r.pointeroffset, l = b.__tipCp, m = z.documentElement || z.body, A = m.scrollLeft,
                m = m.scrollTop, H = r.x, s = r.y, v, n = b.width, B = b.height, b = b.__tipConstrain;
            if (100 > n || 100 > B) b = !1;
...
FusionCharts.register("module", ["private", "modules.renderer.js-smartlabel", function () {
    var d = this.hcLib, m = d.isIE, z = d.hasSVG, q = Math.max, E = this.window,
        b = / HtmlUnit/.test(E.navigator.userAgent), K = E.document, I = / AppleWebKit\//.test(E.navigator.userAgent),
        c = !!K.createElement("canvas").getContext,
        s = !(!c || !K.createElement("canvas").getContext("2d").measureText), E = function () {
            function a(a, b, c) {
                if (!a || !a.length) return 0;
                var d = c.getWidthFunction(), g = 0, f = 0, f = d(a), k = f / a.length;
                c = b;
                g = Math.ceil(b / k);
                if (f < b) return a.length -
                    1;
                g > a.length && (c = b - f, g = a.length);
                for (; 0 < c;) if (c = b - d(a.substr(0, g)), f = Math.floor(c / k)) g += f; else return g;
                for (; 0 > c;) if (c = b - d(a.substr(0, g)), f = Math.floor(c / k)) g += f; else break;
                return g
            }
            ...
            var C = d.supportedStyle, g = {
                    ...
                    height: "1px",
                    overflow: "hidden"
                }, l = I ? 0 : 4.5, p = 0, F = /\b_SmartLabel\b/, Q = /\b_SmartLabelBR\b/,
                k = /(<[^<\>]+?\>)|(&(?:[a-z]+|#[0-9]+);|.)/ig,
                B = RegExp("\\<span[^\\>]+?_SmartLabel[^\\>]{0,}\\>(.*?)\\<\\/span\\>", "ig"), A = /<[^>][^<]*[^>]+>/i,
                W = !1, r = 0, oa = 0, ga, $, V;
            K.getElementsByClassName ? (ga = "getElementsByClassName", $ = "_SmartLabel", V = !0) : (ga = "getElementsByTagName",
                $ = "span", V = !1);
            v.prototype = {
                get: function (a) {
                    var b = this.containers, c = this.length, d = this.maxContainers, g, f = "", k = "",
                        k = this.getCanvasFont(a);
                    for (g in C) void 0 !== a[g] && (f += C[g] + ":" + a[g] + ";");
                    if (!f) return !1;
                    if (b[f]) f = b[f], this.first !== f && (f.prev && (f.prev.next = f.next), f.next && (f.next.prev = f.prev), f.next = this.first, f.next.prev = f, this.last === f && (this.last = f.prev), f.prev = null, this.first = f); else {
            ...
            E.prototype = {
                dispose: function () {
                    ...
                    var g = {
                        ...
                        oriText: b,
                        isTruncated: !1
                    }, l = !1, m, s, v = 0, n, L, C, z = -1, E = l = -1;
                    s = this.container;
                    var I = this.context, O = 0;
                    C = 0;
                    var la, ya, Ia;
                    Ia = [];
                    var ma = 0, Ma = this.showNoEllipses ? "" : "...";
                    L = this.lineHeight;
                    var pa, O =
                        [], z = m = -1;
                    pa = function (a) {
                    ...
                    if (s) {
                        ...
                        if (l) {
                            ...
                            ma = s[ga]($);
                            I = 0;
                            for (ya = ma.length; I < ya; I += 1) if (b = ma[I], V || F.test(b.className)) pa = b.innerHTML, "" !== pa && (" " === pa ? z = O.length : "-" === pa && (m = O.length), O.push({
                                spaceIdx: z,
                                dashIdx: m,
                                elem: b
                            }), Ia.push(pa));
                            ...
                            this.cache[la] ? r = this.cache[la].width :
                                (r = ya(la), this.cache[la] = {width: r});
                            if (L > r) n = b.substr(0, a(b, L, this)).split(""), ma = n.length; else {
                                if (r > c) return g.text = "", g.width = g.oriTextWidth = g.height = g.oriTextHeight = 0, g;
                            ...
                            C = this.lineHeight;
                            if (f) {
                                for (; ma < m; ma += 1) if (la = n[ma] = Ia[ma], this.cache[la] ? r = this.cache[la].width : (r = ya(la), this.cache[la] = {width: r}), O += r, O > L && (s || (s = n.slice(0, -1).join("")), O > c)) return g.text = pa(s) + Ma, g.tooltext = g.oriText, g.width = ya(g.text), g.height = this.lineHeight,
                                    g;
                                g.text = n.join("");
                                g.width = O;
                                g.height = this.lineHeight
                            } else {
                                for (; ma < m; ma += 1) if (la = n[ma] = Ia[ma], " " !== la || I || (la = "&nbsp;"), this.cache[la] ? r = this.cache[la].width : (r = ya(la), this.cache[la] = {width: r}), O += r, O > L && (s || (s = n.slice(0, -1).join("")), O > c)) {
                    ...
                    if (!this.init) return !1;
                    var d = {text: a, width: null, height: null, oriTextWidth: null, oriTextHeight: null, isTruncated: !1},
                        g = this.container;
                    ...
                    if (!this.init) return !1;
                    var b = {text: a, width: null, height: null}, c = this.container, d = this.getWidthFunction(), g = 0;
                    if (W) {
                        a = a.split(/(<br\s*\/*\>)/g);
                        c = a.length;
...
FusionCharts.register("module", ["private", "modules.renderer.js-numberformatter", function () {
    var d = this, m = d.hcLib, z = m.pluckNumber, q = m.extend2, E = m.getValidValue, b = m.pluck, K = m.getFirstValue,
        I = Math.abs, c = Math.pow, s = Math.round, a = function (a) {
            return a && a.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&")
        }, v = {}, O = function (a) {
            var b = [], c;
    ...
    m.NumberFormatter = function () {
        function d(a, b, g) {
            ...
            f = c(10, b);
            a = s(a * f) / f + "";
            if (1 == g) for (-1 == a.indexOf(".") && (a += ".0"), g = a.split("."), b -= g[1].length, g = 1; g <= b; g++) a += "0";
            return a
        }

        function f(a, b, c, d, g) {
            var f = Number(a), l = "", m = !1, p = "", s = "", v = p = 0;
            if (isNaN(f)) return "";
            if (1E15 < f) return f.toExponential(g ? 1 : 14);
            p = 0;
            v = a.length;
            -1 != a.indexOf(".") && (l = a.substring(a.indexOf(".") + 1, a.length), v = a.indexOf("."));
            0 > f && (m = !0, p = 1);
            p =
                a.substring(p, v);
            a = p.length;
            g = d.length - 1;
            f = d[g];
            if (a < f) s = p; else for (; a >= f;) s = (a - f ? c : "") + p.substr(a - f, f) + s, a -= f, f = 0 >= --g ? d[0] : d[g], a < f && (s = p.substring(a, 0) + s);
            "" != l && (s = s + b + l);
            !0 === m && (s = "-" + s);
            return s
        }
        ...
        var l, m = {
            ...
            xNumberPrefix: "",
            xNumberSuffix: ""
        }, v = {mscombidy2d: {formatnumberscale: "1"}}, C = function (c, d, g) {
            var f, l, s, C, Q, I, O, za, Aa, Z = d.name, U = q({}, m), na, H, T, fa, n, L,
                ca, aa, sa, Y, Ea;
            (s = v[Z]) && (U = q(U, s));
            this.csConf = U;
            this.chartAPI = d;
            ...
            if (E(c.thousandseparatorposition)) for (na = c.thousandseparatorposition.split(","), T = na.length, n = m.thousandseparatorposition[0]; T--;) fa = parseInt(na[T], 10), 0 >= fa && (fa = n), n = na[T] = fa;
            d || (d = {});
        ...
        C.prototype = {
            cleaneValueCacheStore: {}, percentStrCacheStore: {}, dispose: function () {
                ...
                var d = this.baseConf, g = this.csConf, f = this.chartAPI,
                    l = z(a.scalerecursively, d.scalerecursively), s = z(a.maxscalerecursion, d.maxscalerecursion),
                    v = E(a.scaleseparator, d.scaleseparator), q, C, F, Q, O, U;
                c = z(c, this.Y.length);
                E(a.numberscaleunit) && (q = a.numberscaleunit.split(","));
                E(a.numberscalevalue) && (C = a.numberscalevalue.split(","));
                s || (s =
                    -1);
                if (E(a.thousandseparatorposition)) for (F = a.thousandseparatorposition.split(","), Q = F.length, U = m.thousandseparatorposition[0]; Q--;) (O = z(I(F[Q]))) ? U = O : O = U, F[Q] = O;
                d = {
                    cacheStore: [],
                ...
                var d = "object" === typeof a && a || new Date(a), g = this.timeConf, f = b(c, g.outputDateFormat),
                    l = d.getFullYear(), m = d.getMonth(), p = d.getDate(), s = d.getDay(), v = d.getMinutes(),
                    q = d.getSeconds(), d = d.getHours(), v = 9 < v ? "" + v : "0" + v, q = 9 < q ? "" + q : "0" + q,
                    d = 9 < d ? "" + d : "0" + d;
            ...
            if (null !== a) {
                ...
                if (1 == c.formatnumberscale) {
                    ...
                    if (c.scalerecursively) {
                        ...
                        if (s.length === a.length) for (v = 0; v < s.length; v++) if (q = z(s[v]) || 1E3, Math.abs(Number(m)) >= q) F = a[v] || "", m = Number(m) / q; else break;
                        p.value = m;
                        p.scale = F
                    }
                    s = p;
                ...
                if (c.scalerecursively && 0 !== c.formatnumberscale && "0" !== c.formatnumberscale) {
                    ...
                    if (1 == c.formatnumber) for (m = "", q = 0; q < a; q++) p = 0 === q ? l[q] : Math.abs(l[q]), v = p + "", q ==
                    a - 1 && (v = d(p, b(c.decimalprecision, C), c.forcedecimals)), m = m + f(v, c.decimalseparator, c.thousandseparator, c.thousandseparatorposition) + s[q] + (q < a - 1 ? c.scaleseparator : ""); else for (m = "", q = 0; q < a; q++) m = m + (0 === q ? l[q] : Math.abs(l[q]) + "") + s[q] + (q < a - 1 ? c.scaleseparator : "");
    ...
    d.extend(d.core, {
        formatNumber: function (a, b) {
            b = b && C(b) || {};
            var c = O(b), d;
            v[c] ? d = v[c] : v[c] = d = new m.NumberFormatter(b, {useScaleRecursively: !0});
    ...
    d.extend(d.core, {
        formatNumber: function (a, b, c, p) {
            c = c && C(c) || {};
            var s = this.jsVars.instanceAPI || {}, z = s.numberFormatter, k;
            "" === O(c) ? z ? k = z : (z = this.getChartData(d.dataFormats.JSON, !0), z = z.data || {}, z = z.chart || {}, c = O(z), v[c] ? k = v[c] : v[c] = k = new m.NumberFormatter(z, s)) : (z = this.getChartData(d.dataFormats.JSON, !0), z = z.data || {}, z = z.chart ||
                {}, z = q(q({}, z), c), c = O(z), v[c] ? k = v[c] : v[c] = k = new m.NumberFormatter(z, s));
...
FusionCharts.register("module", ["private", "modules.renderer.js-dom", function () {
    var d = this.hcLib, m = this.window, z = m.document, q = d.extend2, E = "ontouchstart" in m;
    (function (b) {
        var d = function () {
            var b = {}, d;
            b.pointerdrag = {
        ...
        I = q({}, d);
        b.dem = new function () {
            var b = {}, d = {}, a = z.addEventListener ? function (a, b, c) {
                ...
                if (s) for (b = s.start, k = b.length; k--;) (g = b[k]) && d.push(C(a, g, c, "start"));
                return d
            }, C = function (b, c, d, g) {
                g = g || "closure";
                a(b, c, d[g]);
            ...
            return {
                listen: function (a, l, m, v, q) {
                    ...
                    var B = l.length, A = [], K = function (a, b, c) {
                        A.push(function () {
                            k.unlisten(a, b, c)
                        })
                    }, r, oa, ga, $, V;
                    if (a.ownerDocument && a.ownerDocument === z) for (; B--;) oa = l[B], $ = Boolean(I[oa]), V = "function" === typeof m ? m : m[B], ga = {
                        handler: V,
                        elem: a,
                        type: oa,
                        isGesture: $,
                        ...
                        E(a, oa, ga)) : ((r = b[oa]) || (r = b[oa] = []), r.push(ga), C(a, oa, ga)), K(a, oa, V); else for (; B--;) oa = l[B], V = "function" === typeof m ? m : m[B], ga = {
                        handler: V,
                        elem: a,
                        type: oa,
                        isGesture: $,
                    ...
                    var q, C = !1, k, z;
                    if (Boolean(I[g])) for (k = (q = d[g]) && q.length || 0; k--;) {
                        if (z = q[k], z.handler === m && z.elem ===
                            a) {
                            var C = a, A = void 0, E = void 0, r = void 0, A = void 0;
                            if (A = I[g]) for (A = A.start, r = A.length; r--;) (E = A[r]) && v(C, E, z.start);
                            q.splice(k, 1);
                            C = !0
                        }
                    } else for (k = (q = b[g]) && q.length || 0; k--;) z = q[k], z.handler === m && z.elem === a && (v(a, g, z.closure), q.splice(k, 1), C = !0);
                    return C
                    ...
                    if (a.ownerDocument && a.ownerDocument === z) z.createEvent ? (s = z.createEvent("HTMLEvents"), s.initEvent(d, !0, !0), g && (g.originalEvent ? g.originalEvent = s : q(s, g)), "function" === typeof a[d] && a[d].call(a), a.dispatchEvent(s)) : (s = z.createEventObject(),
                        s.eventType = d, g && (g.originalEvent ? g.originalEvent = s : q(s, g)), "function" === typeof a[d] && a[d].call(a), a.fireEvent("on" + d, s)), m && !s.returnValue && m(s); else for (m = (d = b[d]) && d.length || 0; m--;) s = d[m], s.elem === a && s.closure(g)
                }
            }
        }
    })(d || m);
    (function (b) {
        ...
        function E(b, c, d, g, f, l, m, q) {
            var z = c / 40, k = s[l || "linear"](g - d, z), B = 0, A = function () {
                var c;
        ...
        var c = {width: {suffix: "px"}, height: {suffix: "px"}, opacity: !0, top: {suffix: "px"}, left: {suffix: "px"}},
            s = {
                linear: function (a, b) {
        ...
        b.danimate = q({
            animate: function (a, b, m, g, f) {
                ...
                if (40 > m) {
                    ...
                    f && f()
                } else for (z in b) c[z] && (s += 1, g[z] = b[z], l[z] = d(a, z), k = "object" === typeof c[z] && c[z].suffix, E(a, m, l[z], g[z], z, "linear", p, k))
            }
        }, {})
    })(d || m)
}]);
FusionCharts.register("module", ["private", "modules.renderer.js-colormanager", function () {
    var d = this.hcLib, m = d.pluckNumber, z = d.graphics.getDarkColor, q = d.graphics.getLightColor,
        ...
        K = d.defaultPaletteOptions = {
            ...
            var s = b.chart, a = d.extend2({}, K), v = c.defaultPaletteOptions || {}, E;
            a || (a = {});
            for (E in v) a[E] = v[E];
    ...
    E.prototype = {
        getColor: function (b) {
            ...
            c = c.replace(/\s/g, "");
            c = c.toLowerCase();
            if ("" === c || null === c || void 0 === c) d = [b]; else for (m = c.split(","), E = b.split(","), C = Math.max(m.length, E.length, 1), g = m[0], f = E[0], F = /[\{\}]/ig, K = 0; K < C; K++) l = (m[K] || g).replace(F, ""), p = E[K] || f, "color" == l ? d.push(p) : "light" == l.substr(0, 5) ? (a = l.indexOf("-"), a = -1 == a ? 1 : l.substr(a + 1, l.length - a), a = 100 - a, d.push(q(p, a))) : "dark" == l.substr(0, 4) ? (a = l.indexOf("-"), a = -1 == a ? 1 : l.substr(a + 1, l.length - a), a = 100 - a, d.push(z(p, a))) : d.push(l);
            return d
...
FusionCharts.register("module", ["private", "modules.renderer.js-annotations", function () {
    var d = this, m = d.core, z = d.hcLib, q = d.window, E = /msie/i.test(q.navigator.userAgent) && !q.opera,
        b = z.addEvent, K = z.removeEvent, I = z.hasTouch, c = q.Number, s = I ? 6 : 5,
        a = "rgba(192,192,192," + (E ? .002 : 1E-6) + ")", E = q.Math, v = E.min, O = E.max, C = E.sin, g = E.cos,
        f = E.PI, l = f / 180, p = d.extend, F = z.pluck, Q = z.pluckNumber, k = z.graphics.convertColor,
        B = z.getValidValue, A = z.parseUnsafeString, W = z.setImageDisplayMode, r = z.graphics.parseColor,
        oa = z.setLineHeight,
        ga = z.getMouseCoordinate, $ = {style: {}}, V = z.toRaphaelColor, ta = function (a, b) {
            ...
            if (d = a.match(/^[\+\-]?(\$[a-z0-9\.]+)|[\+\-](\$[a-z0-9\.]+)/g)) for (b = 0; b < d.length; b += 1) {
                l = d[b];
                var r = g, q = f, v = l.split("."),
                    C = void 0, A = void 0, z = 0;
            ...
            if (d = a.match(/^[\+\-]?\$\d+(\.\d+)?|[\+\-]\$\d+(\.\d+)?/g)) for (b = 0; b < d.length; b += 1) p = p + Number(d[b].replace("$", "")) || 0;
            return {value: m + p, hasDynamicMacros: s}
        }, Aa = function (a, b, c) {
            if (!b.removed) {
                b = b.data("annotation");
                var g = b.getRenderer(), f = ga(g.container, c), l = f.annotationOptions = b.options, k = f.groupOptions =
                    b.group.options;
                f._shape = b;
    ...
    U = function (a, b, c, d, g) {
        ...
        if (a = a.items) for (d = 0, c = a.length; d < c; d += 1) b.push(new na(a[d], this))
    };
    p(U.prototype, {
        scaleImageX: 1,
        scaleImageY: 1,
    ...
    U.prototype.scale = function () {
        var a = this.options, b = this.shared, c = this.bounds, d = this.snaps, g = this.getRenderer(),
            f = b.rootxscale, l = b.rootyscale, k = c.xs = Q(a.xscale, b.xscale, 100) / 100,
            m = c.ys = Q(a.yscale, b.yscale, 100) / 100, p, s, r;
        g && (this.scaleText *= m,
    ...
    U.prototype.draw = function () {
        var a = this.getRenderer(), b = this.options, c = this.bounds, d = this.items, g = a && a.layers.dataset,
            f = this.wrapper;
        if (a) {
            f || (this.wrapper =
                f = a.paper.group("annotations"), g && (this.isBelow ? f.insertBefore(g) : f.insertAfter(a.layers.datalabels || g)));
            this.wrapper.attr({x: 0, y: 0, visibility: Q(b.visible, 1) ? "" : "hidden"}).translate(c.x, c.y);
            b = 0;
    ...
    d.extend(na.prototype, {
        getAbsoluteBounds: function () {
            var a = this.bounds, b = a.x1, c = a.y1, d = a.x2, g = a.y2, f = v(b, d), l = v(c, g), b = O(b, d) - f,
                c = O(c, g) - l;
            return {x: f, width: b, y: l, height: c, r: a.r, unscaled: {width: b / a.xs, height: c / a.ys}}
        }, queue: function () {
            this.group.annotations.shapesToDraw.push(this)
        },
        scale: function (a) {
            var b = this, c = b.group, d = c.bounds, g = b.bounds, f = b.options, l = c.snaps, k = F(f.x, f.xpos),
                m = F(f.y, f.ypos), p = F(f.tox, f.toxpos), s = F(f.toy, f.toypos), r = g.xs = d.xs, d = g.ys = d.ys,
                q = Q(f.xshift, c.xshift, 0), v = Q(f.yshift, c.yshift, 0), C;
            C = function (d, g, f, n) {
            ...
            var b = this.options, c = this.group, d = c.options, g = this.attrs, f = this.style, l = c.scaleValue,
                m = Q(d.fillalpha, d.alpha, 100), s = this.fillAlpha = F(b.fillalpha, b.alpha, m),
                ...
                m = this.borderAlpha = Q(b.borderalpha, b.alpha, d.borderalpha, m), z = this.dashed = !!Q(b.dashed, 0),
            ...
            var a = this.getRenderer(), c = this.type, d = this.attrs, g = this.style, f = a && a.paper,
                l = na.types[c] && na.types[c].call && na.types[c].call(this, a), k = na.imageShapeTypes[l],
                m = na.textShapeTypes[l], p = k || m || na.trackerShapeTypes[l], s = this.link || this.toolText,
                r = this.wrapper, c = this.tracker, q = a && a.layers.tracker || this.group.wrapper, v = !1, C = c || r,
                A = na.eventNames, z = na.ownEvents, E, F;
            if (a) {
                if (l) {
                    if (r) if (r.elemType !==
                        l) {
                        ...
                        r = r.remove()
                    } else if (this.hasEvents) for (E in A) (F = this[E]) && F.eventAttached && (K(C.node, A[E], F), F.eventAttached = !1);
                    ...
                    !this.shadow || this.shadowAdded || k || m ? r.shadow(this.shadowAdded = !1) : r.shadow(this.shadowAdded =
                        !0, O(this.borderAlpha, this.fillOptions.alpha) / 100);
                    ...
                    if (this.hasEvents) for (E in A) (F = this[E]) && !F.eventAttached &&
            ...
            var a = this.wrapper, b = this.tracker, c = b || a, d = na.eventNames, g = na.ownEvents, f, l;
            if (a) {
                if (this.ownEventsAttached) {
                    for (l in g) c["un" + l].apply(a, g[l]);
                    this.ownEventsAttached = !1
                }
                if (this.hasEvents) for (f in d) (l = this[f]) && l.eventAttached && (K(c.node, d[f], l), l.eventAttached = !1);
    ...
    d.extend(na, {
        ...
        types: {
            rectangle: function () {
                ...
                var a = this.args,
                    b = this.attrs, c = this.options, d = this.bounds, g = this.group, f = g.snaps;
                ...
                var b = this.args, c = this.attrs, d = this.options, k = this.bounds, m = a.chartWidth,
                    p = a.chartHeight, s = this.group.scaleValueComplement, r = this.group.snaps, q = k.angles,
                    v = this.group;
                a = k.r;
                ...
                var b = this.options, c = this.args, d = this.attrs, g = this.bounds, f = a.chartWidth;
                a = a.chartHeight;
                var k = this.group, m = k.scaleValue, p = g.angles;
                ...
                var b =
                        this.args, c = this.style, d = this.attrs, g = this.group, f = this.bounds, l = this.options,
                    k = this.getAbsoluteBounds(), m = F(l.align, g.options.textalign, "center").toLowerCase(),
                    s = F(l.valign, g.options.textvalign, "middle").toLowerCase(), q = A(F(l.text, l.label)),
                    v = a.logic.smartLabel, C = Q(l.wrap, g.options.wraptext, 1), z, E,
                    B = F(l.rotatetext, g.options.rotatetext, "0").toLowerCase(), B = na.textRotationOptions[B],
                    I = "0" !== B ? "y" : "x", K = a.options.orphanStyles;
                a = p({}, K.defaultStyle.style || {});
                K = g.id && K[g.id.toLowerCase()] || $;
                a = p(a, K.style);
                var K = parseFloat(a.fontSize), W = F(l.font, g.options.font, a.fontFamily),
                ...
                l.bordercolor && (!d["text-bound"] && (d["text-bound"] =
                    []), d["text-bound"][1] = r(l.bordercolor), d["text-bound"][2] = Q(l.borderthickness, 1), d["text-bound"][3] = Q(l.padding, 1));
                ...
                var b = this, c = b.style, d = a.chartWidth, g = a.chartHeight;
                a = b.options;
                var f = b.attrs, l = b.args, k = B(a.url), m = b.group.scaleImageX * F(Number(a.xscale), 100) / 100,
                    s = b.group.scaleImageY * F(Number(a.yscale), 100) / 100, r = b.getAbsoluteBounds(),
                    v = {width: 1, height: 1}, C;
    ...
    d.extend(Z.prototype, {
        reset: function (a, b, c) {
            ...
            b && (this._options = b);
            if (a && a.groups && d) for (c = 0; c < a.groups.length; c += 1) d.push(new U(a.groups[c], b, g, this._idstore, this))
        }, getRenderer: function () {
    ...
    d.addEventListener("internal.animationComplete", function (a) {
        var b = (a = a.sender.annotations) && a.shapesToDraw, c = b && b.length, d, g;
        if (c) {
    ...
    m.addEventListener("rendered", function (a, b) {
        if ("javascript" === b.renderer) {
            var c = a.sender, d = c.jsVars || {}, g = d.instanceAPI;
...
FusionCharts.register("module", ["private", "modules.renderer.js-base", function () {
    var d = this, m = d.hcLib, z = m.Raphael, q = d.window, E = q.document, b = m.BLANKSTRING, K = m.createTrendLine,
        I = "https:" === q.location.protocol ? "https://export.api3.fusioncharts.com/" : "http://export.api3.fusioncharts.com/",
        c = m.pluck, s = m.getValidValue, a = m.pluckNumber, v = m.getFirstValue, O = m.getDefinedColor,
        C = m.parseUnsafeString, g = m.FC_CONFIG_STRING, f = m.extend2, l = m.getDashStyle, p = m.parseTooltext,
        F = m.toPrecision, Q = m.regex.dropHash, k = m.HASHSTRING,
        B = m.getSentenceCase, A = m.addEvent, W = function (a) {
            return void 0 !== a && null !== a
        }, r = q.Math, oa = m.TOUCH_THRESHOLD_PIXELS, ga = m.CLICK_THRESHOLD_PIXELS, $ = r.min, V = r.max, ta = r.abs,
        za = r.ceil, Aa = r.floor, Z = r.log, U = r.pow, na = r.sqrt, H = r.round, T = m.graphics.getColumnColor,
        fa = m.getFirstColor, n = m.setLineHeight, L = m.pluckFontSize, ca = m.getFirstAlpha,
        aa = m.graphics.getDarkColor, sa = m.graphics.getLightColor, Y = m.graphics.convertColor,
        Ea = m.COLOR_TRANSPARENT, la = m.POSITION_CENTER, ya = m.POSITION_TOP, Ia = m.POSITION_BOTTOM,
        ma = m.POSITION_RIGHT,
        Ma = m.POSITION_LEFT, pa = m.parsexAxisStyles, qa = m.chartAPI, La = m.graphics.mapSymbolName,
        Ya = qa.singleseries, ib = qa.multiseries, Ja = m.COMMASTRING, Ta = m.STRINGUNDEFINED, Na = m.ZEROSTRING,
        sb = m.ONESTRING, Wa = m.HUNDREDSTRING, Ga = m.PXSTRING, Sb = m.COMMASPACE,
        Qb = q.navigator.userAgent.match(/(iPad|iPhone|iPod)/g), Fb = !/fusioncharts\.com$/i.test(q.location.hostname),
        jb = {left: "start", right: "end", center: "middle"}, yb = m.BLANKSTRINGPLACEHOLDER, kb = m.BGRATIOSTRING,
        h = m.COLOR_WHITE, G = m.TESTSTR, u = m.graphics.getAngle, D = m.axisLabelAdder,
        N = m.falseFN, ba = m.NumberFormatter, ha = m.getLinkAction, ra = m.getAxisLimits, ua = m.createDialog,
        ja = function (a, b) {
            return 0 < a ? Z(a) / Z(b || 10) : null
        }, Ha = m.hasTouch = void 0 !== E.documentElement.ontouchstart, Ba = m.fireEvent = function (a, b, c, d) {
            m.dem.fire(a, b, c, d)
        }, xa = {1: "bold", 0: "normal"}, Ka = {1: "italic", 0: "normal"}, eb = {1: "underline", 0: "none"}, ia = {
            font: function (a, b) {
            ...
            var a = {}, b, c = function () {
                var h, e, g, f, u = 0, n, l, k = parseInt(d.core.options.resizeTrackingInterval, 10) || 300, m;
            ...
            return function (h, e) {
                var g = h.jsVars, f = e || h.ref && h.ref.parentNode || {};
        ...
        Pa = {
            getExternalInterfaceMethods: function () {
                ...
                var d = this.jsVars, e = d.hcObj, h = d.fcObj, g = h.options;
                ...
                return "FusionCharts/3.4.0 (XT)"
                                     ...
                                     g) {
            c = c.chart;
            var e = a(c.showborder, 1) ? a(c.borderthickness, 1) : 0, f = a(c.charttopmargin, g.charttopmargin, 15) + e,
                u = a(c.chartrightmargin, g.chartrightmargin, 15) + e,
                n = a(c.chartbottommargin, g.chartbottommargin, 15) + e,
                e = a(c.chartleftmargin, g.chartleftmargin, 15) + e, l = f + n, k = e + u;
            h *= .7;
            d *= .7;
            ...
            d = {
                ...
                credits: {href: m.CREDIT_HREF, text: m.CREDIT_STRING, enabled: Fb},
                global: {},
                labels: {items: []},
                lang: {},
                legend: {
            ...
            for (e = e || {
                ...
                if (!c) break
            } else h.push({index: d, y: a[d].y}); else isNaN(a[d].y) || null === a[d].y || (g = !0, h.push({
                index: d,
                y: a[d].y
            }));
            if (2 < h.length) {
                ...
                for (u = 0; 10 > u; ++u) for (n = 0; n < h.length; ++n) l = 0 === n ? (3 * (h[n + 1].y - h[n].y) - f["D" + h[n + 1].index]) / 2 : n === h.length -
        ...
        Mb = m.placeVerticalAxis = function (c, d, h, f, e, u, n, l, k, m) {
            var D = h[g], p = D.smartLabel, r, X, q, v, N = 0, C = D.marginRightExtraSpace, ba = D.marginLeftExtraSpace,
                A = {}, z = {}, ha = {}, E = c.plotLines, F = c.plotBands, D = d.verticalAxisValuesPadding,
                ua = isNaN(d.fixedValuesPadding) ? 0 : d.fixedValuesPadding, H = D - ua,
                ra = d.verticalAxisValuesPadding, ja = d.verticalAxisNamePadding, B = d.verticalAxisNameWidth,
                Ba = d.rotateVerticalAxisName && String(d.rotateVerticalAxisName).toLowerCase(), I = "none" !== Ba,
                K = c.offset ? c.offset : 0, Ha = 0, L = 0, Da = 0, xa = 0, Ka = 0, Q =
                    0, nb = 0, eb, ia, Pa, ea, D = 2, nb = n ? C + 5 : ba + 4, fb = V(a(h.chart.plotBorderWidth, 1), 0),
                wa = c.showLine ? c.lineThickness : fb, bb = function (a, b) {
                    var c, e;
                    a && a.label && void 0 !== s(a.label.text) && (Pa = a.label, Pa.style && Pa.style !== ia && (ia = Pa.style, p.setStyle(ia)), r = p.getOriSize(a.label.text), e = (c = r.width) ? c + 2 : 0, a.isGrid ? (A[b] = {
                        ...
                        height: r.height,
                        label: Pa
                    }, Ka = V(Ka, e)) : (ha[b] = {width: c, height: r.height, label: Pa},
                        Q = V(Q, e))))
                }, W = function (a, d) {
                    var h, g = d ? N : N + a;
                    h = c.title.style;
            ...
            (function () {
                if (L + Ha > u) {
                    ...
                    if (H + ja >= ea) ja >= ea ? ja -= ea : (H -= ea - ja, ja = 0); else {
                        ea -= H + ja;
                        ja = H = 0;
                        if (20 < Q) if (Ka > xa) {
                            if (Q - Ka >= ea) {
            ...
            var e = this.snapLiterals || (this.snapLiterals = {}), u = d.chart, n = C(u.caption);
            d = C(u.subcaption);
            var l = u = a(u.captionpadding,
                10), k = c[g], m = this.smartLabel || k.smartLabel, D = !1, p = 0, r, s, G = 0, q = 0, v = 0, N = 0,
                ba = c.title, A = c.subtitle, z = V(a(c.chart.plotBorderWidth, 1), 0), ha = 0, E = 0;
            if (3 < f) {
                u < z && (u = z + 2);
            ...
            var u = 0, n = h.plotLines, l = [], k, m = h.plotLines.length;
            c = c[g].smartLabel;
            for (var p = parseFloat(L(d.basefontsize, 10)), D; u < m; u += 1) d = n[u], d.isGrid && d.label && d.label.text && (l.push(d), 0 === d.value && (k = l.length - 1));
            if (m = l.length) if (h.labels.style ? c.setStyle(h.labels.style) : l[0].label && l[0].label.style && c.setStyle(h.labels.style), u = c.getOriSize("W").height, f || (u += .4 *
                    p), a /= m - 1, a < u) {
                f = V(1, za(u / a));
            ...
            var l = h[g], k = f && f.chart || {}, m, D, p, r, G, q, v, N, C, ba, A, z, ha = 0, E = 0, F = 10, ua = 1, H = 0,
                ra = 0, ja = 0, Ha = 0, B = !1, Ba = !1, I = !1, Da = a(k.labelstep, 0), K = a(k.xaxisminlabelwidth, 0),
                L = a(k.maxlabelheight, u), Ka = d.labelDisplay, Q = d.rotateLabels,
                xa = d.horizontalLabelPadding, ea = l.marginBottomExtraSpace, nb = h.chart.marginLeft,
                Pa = h.chart.marginRight, ia = l.smartLabel, eb = l.plotBorderThickness, fb = d.catCount,
                wa = d.slantLabels, P = e / (c.max - c.min), bb = 0, W = 0, U = 0, O = 0, ga = f && f.chart || {},
                T = 1E3 * a(ga.updateinterval, ga.refreshinterval), oa = ga.datastreamurl,
                Oc = Boolean(this.realtimeEnabled && T && void 0 !== oa), xb, Ra, Ab, ub, Y, Tb, Mb, Jb, aa, Rb, Z, Zb, fa,
                ca, Ca, $a, ta, qa, pa, sa, ya, Ea, La, Ja, lb, Ga = null, Na = null, Sa, Wa, sb, dc, Ya, ib, kb, jb, Wb,
                va, Vb, ec, Qa = [], Hb = [], pb, Cb = 0, Db = 0, Xb, gc, tb, fc,
                kc, yb, db, lc = d.horizontalAxisNamePadding, Bb = 0, Xa = d.staggerLines, Ib = bb, Fb = !1, Qb = !1,
                Sb = 0, mc, Eb, Lb, Ub, td, Sc, ud, $c, ad, Ec, Tc, bd, pc, Mc, Uc, Gc, cd, Nc, Vc, Ac;
            Vb = c.plotLines;
            F = va = 0;
            ...
            if (typeof h._FCconf.isXYPlot !== Ta || l.isBar) {
                ...
                for (db = Vb.length; va < db; va += 1) (D = Vb[va]) && D.label && typeof D.label.text !== Ta && (D.isGrid ? (ub = {plotObj: D}, D.isCat && (Jb = va % Xa, xb[Jb] || (xb[Jb] = []), aa ? (Rb = ub, xb[Jb].push(Rb)) : (Rb = aa = ub, xb[Jb].push(aa))), Qa.push(ub)) : D.isTrend && Hb.push({plotObj: D}));
                ec = c.plotBands;
                va = 0;
                for (db = ec.length; va < db; va += 1) (D = ec[va]) &&
                D.isTrend && D.label && typeof D.label.text !== Ta && Hb.push({plotObj: D});
                if (Qa.length) if (!I && !ha) if (l.distributedColumns) for (va = 0, db = Qa.length; va < db; va += 1) $a = Qa[va], ta = va % Xa, D = $a.plotObj, D.label && D.isCat && (0 <= va - Xa ? (Zb = Qa[va - Xa], La = Zb.plotObj.value * P + Zb.plotObj._weight * P / 2) : (Zb = null, La = c.min * P - nb), va + Xa < db ? (Z = Qa[va + Xa], Ja = Z.plotObj.value * P - Z.plotObj._weight * P / 2) : (Z = null, Ja = c.max * P + Pa), G = D.label, G.style && G.style !== q && (q = G.style, ia.setStyle(q)), fa = D.value * P, ad = fa - D._weight * P / 2, $c = fa + D._weight * P / 2, 1 < Xa ? (sa =
                    ad - La, ya = $c + Ja, lb = $c - ad + $(sa, ya)) : lb = $c - ad, G = D.label, G.style && G.style !== q && ia.setStyle(G.style), lb < v && v < ia.getOriSize(G.text).width ? (D.label.text = b, $a.labelTextWidth = 0) : ($a.labelTextWidth = lb, m = ia.getSmartText(G.text, lb - 4, u, B), lb = m.width + 4, $a.labelTextWidth = lb, O = V(O, m.height))); else {
                    gc = Qa.length;
                    Xb = Qa.length - 1;
                    (pb = (Qa[Xb].plotObj.value - Qa[0].plotObj.value) * P) ? (Ra = .1 * pb, Ab = V(.2 * pb, pb / gc)) : Ab = Ra = e;
                    for (p in xb) for (va = 0, ca = xb[p].length; va < ca;) {
                    ...
                    va = 0;
                    for (db = Qa.length; va < db; va += 1) if ($a = Qa[va], ta = va % Xa, D = $a.plotObj, D.label) if (D.isCat) $a.labelTextWidth && (qa[ta] = $a); else {
                        Z = (Zb = qa[ta]) ? Zb.nextCat : xb[ta] ? xb[ta][0] : null;
                        pa = null;
                        if (va >= Xa) for (Na = va - Xa, pa = Qa[Na]; !pa.labelTextWidth;) if (Na >= Xa) Na -= Xa, pa = Qa[Na]; else {
                            pa = null;
                            break
                        }
                        ...
                        ib = D.value * P - A / 2;
                        if (l.isBar && va == db - 1 && pa) La > ib && (pa.plotObj.label.text = b, pa.labelTextWidth = 0, La = pa.leftEdge); else if (La > ib || Ja < ib + A) {
                            D.label.text = b;
                            $a.labelTextWidth = 0;
                            continue
                        }
                    ...
                    pa = Ea = null;
                    va = 0;
                    for (db = Qa.length; va < db; va += 1) if ($a = Qa[va], D = $a.plotObj, ta = va % Xa, D.isCat && $a.labelTextWidth) {
                        pa = Ea = null;
                        fa = D.value * P;
                        if (va >= Xa) for (Na = va - Xa, pa = Qa[Na]; !pa.labelTextWidth;) if (Na > Xa) Na -= Xa, pa = Qa[Na]; else {
                            pa = null;
                        ...
                        if (va + Xa < db) for (Ga = va + Xa, Ea = Qa[Ga]; !Ea.labelTextWidth;) if (Ga + Xa < db - 1) Ga += Xa, Ea = Qa[Ga]; else {
                            Ea = null;
                            break
                        }
                ...
                } else if (ha) for (va = 0, db = Qa.length; va < db; va +=
                    1) if ((D = Qa[va].plotObj) && D.label && D.label.text) {
                    G = D.label;
                    G.style && G.style !== q && (q = G.style, ia.setStyle(q));
                    p = 1;
                    if (va + p < db) for (Ec = Qa[p + va].plotObj; Ec && (Ec.value - D.value) * P < v;) if (D.isCat) {
                        if (Ec.label) {
                            Ec.label.text = b;
                            p += 1;
                            if (p + va >= db - 1) break;
                ...
                if (gc) for (c.scroll && c.scroll.viewPortMin && c.scroll.viewPortMax ? (dc = c.scroll.viewPortMin, Ya = c.scroll.viewPortMax, jb = kb = !1) : (dc = c.min, Ya = c.max), pb = (Qa[Xb].value -
            ...
            db = Qa.length;
            ja = 0;
            if (Fb) if (ha) for (Ac = ma, pc = wa ? xa + 8 : xa + 4, db = Qa.length, p = 0; p < db; p += 1) (D = Qa[p].plotObj) && D.label && void 0 !== s(D.label.text) && (G = D.label, G.style && G.style !== q && (q = G.style, ia.setStyle(q)), va = 1, m = ia.getSmartText(G.text, Bb - 4, v, B), G.text = m.text, m.tooltext && (G.originalText = m.tooltext), Gc = Tc + cd / 2, G.y = pc, G.x = Gc, G.rotation = ha, G.textAlign = Ac, ja += 1); else for (Mc = Bb, Ac = la,
            ...
            if (c.opposite) for (c.title.margin -= Bb - (r && r.height || 0) + xa, Ib -= Ha, h.chart.marginTop += Ib, h.chart.marginBottom -=
            ...
            f = d.legend;
            var u = d.chart, n = u.is3D ? Da.chart3D : Da.chart2D, l = u.useRoundEdges, k = a(h.legendiconscale, 1),
                m = (parseInt(f.itemStyle.fontSize, 10) || 10) + 1, D = this.colorManager, G;
            if (0 >= k || 5 < k) k = 1;
            f.padding = 4;
            0 >= m && (m = 1);
            G = 3 * k;
            ...
            f.shadow && (f.shadow = {enabled: f.shadow, opacity: V(e, u) / 100});
            f.reversed = Boolean(a(h.reverselegend, 0) - a(this.reverseLegend, 0));
            f.style = {padding: 4};
            Boolean(a(h.interactivelegend, 1)) ? f.symbolStyle = {
                _cursor: "hand",
                cursor: "pointer"
            } : (d.legend.interactiveLegend = !1, f.itemStyle.cursor = "default", f.itemHoverStyle = {cursor: "inherit"});
            ...
            var u = this.snapLiterals || (this.snapLiterals = {}), n = 0, l = c.series, k, m = c[g],
                D = this.smartLabel || m.smartLabel, G = c.chart.spacingRight, p = c.legend, r, q = p.textPadding,
                s = p.title.padding, v = p.symbolWidth, N = p.symbolPadding, A =
                v + 2 * N, C = 2 * f, ba = 0, ha = a(d.chart.legendpadding, 7);
            d = ha + p.borderWidth / 2 + a(d.chart.canvasborderthickness, 1);
            var z = 2 * p.padding, F = z, E = !1, ua = [];
            h -= z + ha;
            e && (l = l && l[0] && l[0].data);
            ...
            function (c, d, h, f, e) {
                ...
                var u = this.snapLiterals || (this.snapLiterals = {}), n = 0, l = c.series, k = c[g],
                    m = k.smartLabel || this.smartLabel, D = c.chart, p = D.spacingBottom, r = D.spacingLeft,
                    D = D.spacingRight, q = c.legend, s, v = q.textPadding, N = q.title.padding, A, ba = q.symbolWidth,
                    ha = q.symbolPadding, z = q.legendHeight, F = d.chart;
                A = 0;
                var E = 2 * f, ua = q.rowHeight, H = .05 * ua, ja = [];
                s = a(F.minimisewrappinginlegend, 0);
                var F = a(parseInt(F.legendnumcolumns, 10), 0), ra = 0, B = 0, Ba = 0, I = n = 0, Ha = 0, Da = 0,
                    K = q.padding,
                    xa = 2 * K, K = v + ha + K;
                d = a(d.chart.legendpadding, 7) + q.borderWidth / 2 + 1;
                var ia = xa, L = !1, Ka, Q = [], P = !1, ea = 0, nb = 0;
                0 > F && (F = 0);
                h -= xa;
            ...
            if (b && b.text) {
                var d = b.text, e = a[g].smartLabel, h = 2 * $(a.chart.marginTop, a.chart.marginBottom) + c,
            ...
            var e = c.chart, g = c = 0, f = 0, u = a(e.canvastopmargin, 0), e = a(e.canvasbottommargin, 0), n = u / (u + e),
                l = b.chart.marginTop, k = b.chart.marginBottom;
            e > k && (c += e - k);
            u > l && (c += u - l);
            ...
            var g = a(g.canvasrightmargin, 0), f = c / (c + g), u = 0, n = b.chart.marginLeft, l = b.chart.marginRight,
                k = 0, m = 0;
            c > n && (u += c - n);
            g > l && (u += g - l);
            ...
            column: function (b, d, h) {
                var f = b[g], e = d.borderWidth;
                return function (g, u, n) {
                    var k = d.plotgradientcolor,
                        m = d.is3d, D = d.isRoundEdges, p = d.plotBorderColor, G = c(g.color, d.color),
                        q = c(g.ratio, d.ratio), r = ca(d.plotBorderAlpha), s = a(g.dashed, d.dashed),
                        v = c(g.dashlen, d.dashLen), N = c(g.dashgap, d.dashGap), A = d.use3DLighting,
                        C = ca(c(g.alpha, d.alpha)).toString(), ba = {opacity: C / 100}, ha = d.isBar, F = d.fillAangle,
                        z = 0 > n ? ha ? 180 - F : 360 - F : F,
                        F = T(G + Ja + k, C, q, z, D, p, c(g.alpha, r).toString(), ha, m), E = s ? l(v, N, e) : "none";
                ...
                return function (e, g, u) {
                    var n = a(e.alpha, d.lineAlpha), k =
                            {opacity: n / 100}, m = a(e.anchorsides, d.anchorSides, 0),
                        D = a(e.anchorborderthickness, d.anchorBorderThickness, 1),
                        p = fa(c(e.anchorbordercolor, d.anchorBorderColor)), G = fa(c(e.anchorbgcolor, d.anchorBgColor)),
                        q = a(e.anchorstartangle, d.anchorStartAngle, 90), r = c(e.anchoralpha, d.anchorAlpha),
                        s = c(e.anchorbgalpha, r), v = a(e.anchorradius, d.anchorRadius),
                        N = Boolean(a(e.anchorshadow, d.anchorShadow, 0));
                    g = h.getPointStub(e, u, f.oriCatTmp[g], b, d, d.showValues, d.yAxis);
                    var A = c(e.anchorimageurl, d.imageUrl), C = c(e.anchorimagescale,
                        d.imageScale), ba = c(e.anchorimagealpha, d.imageAlpha);
                    g.y = u;
                    g.shadow = k;
                    g.anchorShadow = d.anchorShadow;
                    g.dashStyle = a(e.dashed, d.lineDashed) ? l(d.lineDashLen, d.lineDashGap, d.lineThickness) : "none";
                    g.color = {FCcolor: {color: fa(c(e.color, d.lineColor)), alpha: n}};
                    ...
                    g.marker = {
                        ...
                        lineColor: {FCcolor: {color: fa(c(e.anchorbordercolor, d.anchorBorderColor)), alpha: r}},
                        imageUrl: A,
                        imageScale: C,
                        imageAlpha: ba,
                ...
                var f = b[g];
                return function (e, g, u) {
                    var n = c(e.alpha, d.fillAlpha), l = {opacity: V(n, d.lineAlpha) / 100, inverted: !0},
                        k = a(e.anchorsides, d.anchorSides, 0), m = a(e.anchorborderthickness, d.anchorBorderThickness, 1),
                        D = fa(c(e.anchorbordercolor, d.anchorBorderColor)), p = fa(c(e.anchorbgcolor, d.anchorBgColor)),
                        G = a(e.anchorstartangle, d.anchorStartAngle,
                            90), q = c(e.anchoralpha, d.anchorAlpha), r = c(e.anchorbgalpha, q),
                        s = a(e.anchorradius, d.anchorRadius), v = Boolean(a(e.anchorshadow, d.anchorShadow, 0));
                    g = h.getPointStub(e, u, f.oriCatTmp[g], b, d, d.showValues, d.yAxis);
                    var N = c(e.anchorimageurl, d.imageUrl), A = c(e.anchorimagescale, d.imageScale),
                        C = c(e.anchorimagealpha, d.imageAlpha);
                    g.y = u;
                    g.shadow = l;
                    g.anchorShadow = d.anchorShadow;
                    g.color = {FCcolor: {color: fa(c(e.color, d.fillColor)), alpha: n}};
                    g.valuePosition = c(e.valueposition, d.valuePosition);
                    u = h.pointHoverOptions(e, d, {
                        plotType: "anchor",
                        anchorBgColor: p,
                    ...
                    g.marker = {
                        ...
                        lineColor: {FCcolor: {color: fa(c(e.anchorbordercolor, d.anchorBorderColor)), alpha: q}},
                        imageUrl: N,
                        imageScale: A,
                        imageAlpha: C,
                        lineWidth: a(e.anchorborderthickness, d.anchorBorderThickness),
    ...
    m.createChart = function (b, h, g, f, e, u, n) {
        var l = b.jsVars, k, D, p = qa[g || (g = b.chartType())], G, q = l.hasNativeMessage,
            r = b.options, s = b.args, v;
        v = function (a) {
            var c = {renderer: "javascript"}, e = l.fcObj, u = e.width, k = e.height, D = p && p.eiMethods,
                r = l.overlayButton, s;
            h.jsVars = b.jsVars;
            l.container = h;
            l.hcObj = a;
            ...
            if (a.hasRendered) {
                d.extend(h, Pa);
                if (D && "string" !== typeof D) for (s in D) h[s] = D[s];
            ...
            f && (f({success: a.hasRendered, ref: h, id: b.id}), a.hasRendered && (m.raiseEvent("loaded", {
                type: g,
                renderer: "javascript"
            }, b, [b.id]), q || (e.__state.firstRenderNotified = !0, setTimeout(function () {
                m.raiseEvent("rendered", {renderer: "javascript"}, e, [e.id])
            }, 0))));
            a.hasRendered && l.previousDrawCount < l.drawCount && (c.width = l.width, c.height = l.height, c.drawCount = l.drawCount, c.displayingMessage = q, c.renderer = e.options.renderer, m.raiseEvent("drawcomplete", c, e, [e.id]), q || n || setTimeout(function () {
                e.__state &&
                !e.__state.firstRenderNotified && m.raiseEvent("rendered", {renderer: "javascript"}, e, [e.id]);
        ...
        void 0 !== e ? "string" === typeof e && (e = new ua(h, e, b), q = l.hasNativeMessage = !0) : !p || !p.init || p && "stub" === p.name ? (b._chartMessageImageStyle = {
            ...
            }, e = new ua(h, r.dataInvalidMessage, b), q = l.hasNativeMessage = !0, b.__state.dataReady = !1, n || d.raiseEvent("dataInvalid", {error: k.error}, l.fcObj, void 0, function () {
            ...
            fontFamily: s.dataEmptyMessageFont || r.baseChartMessageFont, fontSize: s.dataEmptyMessageFontSize ||
            r.baseChartMessageFontSize, color: s.dataEmptyMessageColor || r.baseChartMessageColor
        ...
        e || (b._chartMessageImageStyle = {
            ...
            fontSize: r.baseChartMessageFontSize, color: r.baseChartMessageColor
    ...
    qa("base", {
        ...
        init: function (h, g, u) {
            var l = this.chartInstance || u, e = l.jsVars;
            u = e._reflowData || (e._reflowData = {});
            var n = e._reflowClean, k = l.options, D = k.args, p, G;
        ...
        postSpaceManager: function () {
            var b = this.hcJSON, c = b._FCconf, d = b.chart, h = d.marginLeft, e = d.spacingLeft, g = d.spacingRight,
                f = c.width - h - d.marginRight, u = b.title, b = b.subtitle, l = c.width, n = u.align, c = u.x,
                k = u.horizontalPadding, m = u.alignWithCanvas, D = (H(h) || 0) + a(f, l) / 2,
                h = this.snapLiterals || (this.snapLiterals = {}), f = u._captionWidth, p = b._subCaptionWidth,
        ...
        chart: function (h, w) {
            var J = this.name, k = this.dataObj, e = k.chart, m = this.colorManager, p, G, r, N, A, ba, ha,
                F = this.defaultSeriesType, z, E, ua, H, ra, ja, Ba, I, B, K, ia, Q, Ka, P, ea, nb, Pa, eb, fb, bb, W,
                wa, O, U, xb, T, Ra, Ab, ub, Mb, Tb, Rb, $a, $, Jb, Z, Zb, ca, pa, qa, na, Ea, La, za, Aa, Ya, Ua, vb,
                ib, rb, Ta, yb, wb, Kb, Ca, sc, uc, vc, nc, oc, yc, Fb, tc, wc, lb, Qb, Fc, Sa, hd, id, dc, jd, zc, kd,
                Xc, Wb, va, Vb, ec, Qa, Hb, pb, Cb, Db, Xb, gc, tb, fc, kc, sd, db, lc, Bb, Xa, Ib, Rc, Zc, ld, mc, Eb,
                Lb, Ub;
            p = Oc(k, h, w, this);
            B = p.chart;
            I =
            ...
            void 0 !== c(e.clickurl) && (B.link = e.clickurl, B.style.cursor = "pointer", p.plotOptions.series.point.events.click = function () {
                B.events.click.call({link: e.clickurl})
            });
            ...
            z.trendStyle = z.outCanvasStyle = {fontFamily: bb, color: O, fontSize: wa};
            U = n(z.trendStyle);
            z.inCanvasStyle = {fontFamily: Pa, fontSize: eb, color: fb};
            xb = n(z.inCanvasStyle);
            z.divlineStyle = {fontFamily: Pa, fontSize: eb, color: fb, lineHeight: xb};
            I.labels.style = {
                fontFamily: c(e.labelfont, bb), fontSize: a(e.labelfontsize, W) + Ga, color: c(e.labelfontcolor,
                    O)
            };
            I.labels.style.lineHeight = n(I.labels.style);
            I.steppedLabels.style = {fontFamily: bb, fontSize: wa, lineHeight: U, color: O, visibility: "hidden"};
            p.yAxis[0].labels.style = {fontFamily: bb, fontSize: wa, lineHeight: U, color: O};
            p.yAxis[1].labels.style = {fontFamily: bb, fontSize: wa, lineHeight: U, color: O};
            ...
            ub += Ga;
            p.legend.itemStyle =
                {fontFamily: Ab, fontSize: ub, color: Mb, fontWeight: Tb};
            ...
            p.legend.itemHoverStyle = {color: c(e.legenditemhoverfontcolor, Mb).replace(/^#?([a-f0-9]+)/ig, "#$1")};
            ...
            p.tooltip.style = {fontFamily: Pa, fontSize: eb, lineHeight: xb, color: fb};
            p.title.style = {
            ...
            p.yAxis[0].title.style = {
                ...
                backgroundColor: e.pyaxisnamebgcolor || e.yaxisnamebgcolor ? Y(c(e.pyaxisnamebgcolor, e.yaxisnamebgcolor), a(e.pyaxisnamebgalpha, e.yaxisnamebgalpha, e.pyaxisnamealpha, e.yaxisnamealpha, 100)) :
                    b,
            ...
            p.yAxis[1].title.style = {fontFamily: bb, color: O, fontSize: wa, lineHeight: void 0, fontWeight: "bold"};
            ...
            p.orphanStyles = {
                defaultStyle: {style: f({}, z.inCanvasStyle)},
                connectorlabels: {style: f({}, p.plotOptions.series.dataLabels)},
                vyaxisname: {style: f({}, p.yAxis[0].title.style)}
            };
            p.plotOptions.series.dataLabels.tlLabelStyle = {
                fontFamily: s(e.tlfont,
                    Pa), color: fa(s(e.tlfontcolor, fb)), fontSize: L(e.tlfontsize, T) + "px"
            };
            ...
            p.plotOptions.series.dataLabels.brLabelStyle =
                {fontFamily: s(e.brfont, Pa), color: fa(s(e.brfontcolor, fb)), fontSize: L(e.brfontsize, T) + "px"};
            ...
            z.isXYPlot && wb && (Kb = I.min, Ca = I.max, sc = p.yAxis[0].min, uc = p.yAxis[0].max, vc = a(e.quadrantxval, (Kb + Ca) / 2), nc = a(e.quadrantyval, (sc + uc) / 2), nc >= sc && nc <= uc && vc >= Kb && vc <= Ca && (wc = Y(c(e.quadrantlinecolor, B.plotBorderColor), c(e.quadrantlinealpha, Wa)), lb =
                ...
                fontStyle: a(e.quadrantlabeltlfontitalic, e.quadrantlabelfontitalic) ? "italic" :
                    "normal",
                ...
                fontStyle: a(e.quadrantlabelblfontitalic, e.quadrantlabelfontitalic) ? "italic" :
                    "normal",
                border: K || Eb ? Lb + "px solid" : b,
                borderColor: K,
                borderThickness: Lb,
                ...
                fontStyle: a(e.quadrantlabelbrfontitalic, e.quadrantlabelfontitalic) ? "italic" :
                    "normal",
                border: K || Eb ? Lb + "px solid" : b,
                borderColor: K,
                borderThickness: Lb,
            ...
            if (this.hasVDivLine && (tb = a(e.showvdivlines, 0), fc = a(e.numvdivlines, 0) + 1, tb && (fc = z.x.catCount - 1), 1 < fc)) {
                ...
                Rc && mc && I.plotBands.push({
                    isNumVDIV: !0, color: ld, from: Zc, to: Bb,
                    zIndex: 1
                })
            }
            Q = B.marginTop;
        ...
        parseExportOptions: function (d) {
            var h = this.chartInstance, g = this.dataObj.chart;
            f(d.exporting, {
                ...
                buttons: {
                    printButton: {enabled: !!a(g.printshowbutton, g.showprintmenuitem, 0)},
                    exportButton: {enabled: !(!a(g.exportenabled, 0) || !a(g.exportshowbutton, g.exportshowmenuitem, 1))}
                }
            });
            var h = d.exporting, u;
            g = g.exportformats;
        ...
        placeHorizontalXYSpaceManager: function (b, d, h, f) {
            var e = b[g], u, l, n, k, m = d.chart, p, D, G, r, q, s, v, N = b.chart, z = e.marginLeftExtraSpace,
                A = e.marginTopExtraSpace,
                ba = e.marginBottomExtraSpace, C = e.marginRightExtraSpace;
            k = h - (z + C + N.marginRight + N.marginLeft);
            var F = f - (ba + N.marginBottom + N.marginTop), ha = .3 * k;
            h = .3 * F;
        ...
        placeVerticalXYSpaceManager: function (b, d, h, f) {
            ...
            u = 0;
            var k = d.chart,
                m = !1, p, D, G, r, q = b.chart, s, v, N, z = e.marginLeftExtraSpace, A = e.marginTopExtraSpace,
                ba = e.marginBottomExtraSpace, C = e.marginRightExtraSpace;
            r = h - (z + C + q.marginRight + q.marginLeft);
            var ha = f - (ba + q.marginBottom + q.marginTop), F = .3 * r;
            f = .3 * ha;
            var B = r - F;
            h = ha - f;
        ...
        calculateCanvasOverflow: function (a,
            ...
            if (g && (m = (d = a.series) && d.length || 0, c)) for (; m--;) p = d[m], D && (g = p && p.data || [], 1 < g.length && (r = g[0], q = g[g.length - 1], n && (g = r && r.marker && r.marker.enabled && (r.marker.radius || 0) + (r.marker.lineWidth || 0) || 0, f = q && q.marker && q.marker.enabled && (q.marker.radius || 0) + (q.marker.lineWidth ||
        ...
        configurePlotLines: function (d, h, f, u, e, l, n, k, m, p, D) {
            var G = f.min, r = f.max, q = f.tickInterval, s = p ? "xAxis" : u.stacking100Percent ?
                "percentValue" : "yAxis", v = G, N = 1, z = f.gridLineColor, A = f.gridLineWidth,
                ba = f.gridLineDashStyle, C = 0 > G && 0 < r ? !0 : !1, ha = 0 === G, B = 0 === r,
                E = 0 === a(u.showzeroplanevalue, d.showzeroplanevalue), ua = !0, H, ja = 1,
                I = 0 < a(d.numdivlines, 0), ra = h[g].axisGridManager, K = this.colorManager, Ba = this.is3D,
                ia = a(d.showaxislimitgridlines, this.showAxisLimitGridLines),
                Ba = a(ia, Ba || h.chart.plotBorderWidth ? 0 : 1), Ha = this.inversed;
            h = h.xAxis;
            D = a(D, m ? 1 : 0);
            delete f._altGrid;
            delete f._lastValue;
        ...
        xAxisMinMaxSetter: function (b, c, d, h, e) {
            var f = b[g], u = f.x, l = c.chart, n = u.min = a(u.min, 0), k = u.max = a(u.max, u.catCount - 1), m = 0,
                p = 0, D = b.chart.defaultSeriesType,
                G = /^(column|column3d|bar|bar3d|floatedcolumn|sparkwinloss|boxandwhisker2d|dragcolumn)$/.test(D),
                r = /^(line|area|spline|areaspline)$/.test(D), D = /^(scatter|bubble|candlestick|dragnode)$/.test(D),
                q = b.xAxis, s = q.scroll, v = s && s.enabled, N = a(l.canvaspadding), z = W(N),
                A = za($(a(N, h, 0), d / 2 - 10)), N = za($(a(N,
                e, 0), d / 2 - 10)), ba, C, ha, F;
        ...
        postSeriesAddition: function (b) {
            var d = b[g], h = d.isBar, u = d.is3d, e = b.chart.rotateValues && !h ? 270 : 0, l = d[0],
                n = l && l.stacking100Percent, k, m, D, G, q, r, s, N, v, z, A, ba, C, F, ha, B, E, ua, H, I, ra, ja, K;
            if (this.isStacked) for (D in k = d.plotSpacePercent, m = b.chart.defaultSeriesType, k = 1 - 2 * k, B = b.series, E = this.numberFormatter, ra = f({}, b.plotOptions.series.dataLabels.style), ja = parseFloat(ra.fontSize), K = !l.stacking100Percent, ra.color = b.plotOptions.series.dataLabels.color,
                G = l.stack, G) {
                l = G[D].length;
                q = k / l;
                s = -(k - q) / 2;
                ...
                for (r = 0; r < l; r += 1, s += q) {
                    ...
                    if (A && A.length) for (z = 0, v = A.length; z < v; z += 1) if (ba = A[z]) for (C = (ba.n || 0) + (ba.p || 0), d.showStackTotal && (N = z, N += s, ba = 0 > C ? ba.n : ba.p, b.xAxis.plotLines.push({
                        value: N,
                        width: 0,
                        isVline: K,
                        isTrend: !K,
                    ...
                    })), ba = 0, N = ha.length; ba < N; ba += 1) if (H = ha[ba][z]) if (I = C && (H.y || 0) / C * 100, ua = E.percentValue(I), H.toolText = p(H.toolText, [14, 24, 25, 112], {
                            percentValue: ua,
                            sum: E.dataLabels(C),
                            unformattedSum: C
        ...
        styleApplicationDefinition_font: function (a, b, c) {
            var d, e, h = !1, f, u, l = this.styleMapForFont;
            switch (b) {
                case "caption":
                    d = a.title;
                    break;
            ...
            if ("object" === typeof d) if (d instanceof Array) for (b = 0, f = d.length; b < f; b += 1) {
                u = d[b];
                for (e in c) if (a = e.toLowerCase(), "function" === typeof l[a]) l[a](c[e], u, h);
                n(u.style)
            } else {
                for (e in c) if (a = e.toLowerCase(), "function" === typeof l[a]) l[a](c[e], d, h);
                n(d.style)
            }
        },
        parseStyles: function (a) {
            var b, c, d, e = {}, h, g = this.dataObj;
            if (g.styles && g.styles.definition instanceof Array && g.styles.application instanceof Array) {
                ...
                for (b = 0; b < g.styles.application.length; b += 1) for (c = g.styles.application[b].styles && g.styles.application[b].styles.split(Ja) || [], h = 0; h < c.length; h += 1) if (d = c[h].toLowerCase(), e[d] && g.styles.application[b].toobject) this["styleApplicationDefinition_" + e[d].type.toLowerCase()](a, g.styles.application[b].toobject.toLowerCase(), e[d])
            }
        },
        updateDefaultAnnotations: function () {
            var b = this.renderer, d = this.dataObj, h =
                this.chartInstance, g = d && d.annotations || {}, e = {}, f;
    ...
    qa("singleseries", {
        series: function (a, b, c) {
            ...
            var h = b[g], f = b.xAxis, e = d.chart, u = b.chart.is3D, l, n, k, m, p, D, G, r, q, s, N, v, z = 0, A, ba,
                F, ha, B, E, ua, H = this.numberFormatter, I = a(e.syncaxislimits, 0), ra;
            ...
            l = b.yAxis[0];
            n = h[0];
            if (h.isDual) k = H.getCleanValue(e.pyaxismaxvalue), m = H.getCleanValue(e.pyaxisminvalue), l.title.text = C(e.pyaxisname), I && !n.stacking100Percent ? (v = h[1], N = a(v.max), v = a(v.min), void 0 !== N && void 0 !== v && (n.min = $(n.min, v), n.max = V(n.max, N)), N = H.getCleanValue(e.syaxismaxvalue), v = H.getCleanValue(e.syaxisminvalue), null !== v && (m = null !== m ? $(m, v) : v), null !== N && (k = null !== k ? V(k, N) : N)) : I = 0; else {
            ...
            d = {enabled: c(h.showhovereffect, h.hovereffect, b.enabled)};
            ...
            e = !1;
            var k = {enabled: h}, m = g && b + g.plotType.toLowerCase();
            if (void 0 === h) if (this.forceHoverEnable) e = h = k.enabled = !0; else {
            ...
            if (h) {
                ...
                "anchor" == m && (n = g.imageUrl ? {
                    ...
                    animation: k.anchorAnimation,
                    shadow: k.shadow,
                    fillColor: {FCcolor: {color: k.anchorColor, alpha: k.anchorBgAlpha * k.anchorAlpha / 100 + b}},
                    lineColor: {FCcolor: {color: k.anchorBorderColor, alpha: k.anchorBorderAlpha}},
                ...
                "bubble" == m && (n = {
                    ...
                    scale: k.scale,
                    fillColor: k.color,
                    lineColor: {FCcolor: {color: k.borderColor, alpha: k.alpha}},
                    lineWidth: k.borderThickness
                })
            }
            return {enabled: h, options: k, rolloverOptions: n}
        }, getPointStub: function (d, h, f, u) {
            var e = this.dataObj.chart;
            u = u[g];
            h = null === h ? h : u.numberFormatter.dataLabels(h);
            var l = s(C(c(d.tooltext, u.tooltext))), k = s(C(d.displayvalue)), e = u.showTooltip ? void 0 !==
            l ? p(l, [1, 2, 3, 5, 6, 7], {
                formattedValue: h,
                label: f,
            ...
            d = c(d.link);
            return {displayValue: u, categoryLabel: f, toolText: e, link: d}
            ...
            b.dataset = function (b, d) {
                var h = a.renderer && a.renderer.plots, g, f, u, l;
                u = a.is3D;
            ...
            b.xaxis = function (b) {
                var d = a.renderer && a.renderer.xAxis &&
                    a.renderer.xAxis[0] && a.renderer.xAxis[0].labels, h, g;
            ...
            b.yaxis = function (b) {
                var d = a.renderer && a.renderer.yAxis, h, g;
                if (!d || !d.length) return 0;
    ...
    qa("multiseries", {
        series: function (b, c, d) {
            ...
            var h, f = 0, e = d[g], u = e.axisGridManager, l = c.chart, k = d.xAxis, m, e = e.x, p, D, G, r;
            if (c.categories && c.categories[0] && c.categories[0].category) for (c.categories[0].font && (d.xAxis.labels.style.fontFamily = c.categories[0].font), void 0 !== (h = a(c.categories[0].fontsize)) && (1 > h && (h = 1), d.xAxis.labels.style.fontSize = h + Ga, n(d.xAxis.labels.style)), c.categories[0].fontcolor && (d.xAxis.labels.style.color =
            ...
            var D = this.dataObj.chart, r = this.isDual, q = this.isXY, N = this.isMLAxis, z = this.isStacked,
                A = this.isErrorChart, ba;
            u = u[g];
            var F, ha, B = null === h ?
                h : this.numberFormatter.dataLabels(h, k), E, ua = s(C(c(d.tooltext, e.plottooltext, u.tooltext))),
                H = u.tooltipSepChar, ra, I = {}, ja, K, Ba, ia, Ha, Da, xa, L, Q;
    ...
    qa("scrollbase", {
        postSeriesAddition: function () {
            var b = this.hcJSON, d = b.xAxis.scroll, h = b[g], f = h.width, e = h.x.catCount, u = this.dataObj.chart,
                k = this.colorManager, l, n, m, p, D, G;
            h.isScroll = !0;
            b.chart.hasScroll = !0;
            if (this.isStacked) l = 1; else {
                n = l = 0;
                p = b.series;
    ...
    qa("logbase", {
        isLog: !0, isValueAbs: !0, configureAxis: function (d, h) {
            var u = d[g], k = u.axisGridManager, e = this.numberFormatter, l = d.series, n = d.xAxis, m = d.yAxis[0],
                p = u[0], D = h.chart,
                G = !a(D.showyaxislimits, D.showlimits, D.showyaxisvalues, 1),
                r = !a(D.showdivlinevalues, D.showyaxisvalues, 1), q = a(D.base, D.logbase, 10), s = a(D.yaxismaxvalue),
                N = a(D.yaxisminvalue), v = this.colorManager, z = 1 === a(D.showminordivlinevalues),
                ...
                A = [m, void 0, void 0, a(D.minordivlinethickness, 1), m.gridLineDashStyle,
                    Y(c(D.minordivlinecolor, A), a(D.minordivlinealpha, ba / 2)), 2], ba = z || ba && A[3],
                F = a(D.showaxislimitgridlines, this.showAxisLimitGridLines),
                ha = a(F, this.is3D || d.chart.plotBorderWidth ? 0 : 1), B, E;
            0 >= q && (q = 10);
            0 >= s && (s = void 0);
            0 >= N && (N = void 0);
            ...
            for (D = l.length; D--;) if (N = l[D]) for (N.threshold = m.min, E = (N = N.data) && N.length || 0; E--;) B = N[E], B.y =
                ja(B.y, q);
            delete p.max;
            delete p.min;
            p.isLog = !0;
            ...
            for (D = s.divArr.length; D--;) {
                B = s.divArr[D];
                if (B.ismajor) v[1] =
                    ja(B.value, q), v[2] = e.yAxis(B.value), k.addAxisGridLine.apply(k, v); else if (ba || B.isextreme) A[1] = ja(B.value, q), A[2] = z || B.isextreme ? e.yAxis(B.value) : b, k.addAxisGridLine.apply(k, A);
            ...
            d = l;
            for (k = n; k >= m; --k) if (n = U(e, d), b <= n && a >= n && (u[f++] = {value: n, ismajor: !0}), k != m) {
                l = 1 < e ? -1 : 1;
                n = U(e, d) - U(e, d + l);
                c = n / (h + 1);
            ...
            for (G in u) for (q in u[G]) "value" ==
            q && (p || (p = u[G][q] == b && (u[G].isextreme = u[G].isMin = !0)), D || (D = u[G][q] == a && (u[G].isextreme = u[G].isMax = !0)));
            p || (u[f++] = {value: b, ismajor: !0, isMin: !0, isextreme: !0});
            D || (u[f] = {value: a, ismajor: !0, isMax: !0, isextreme: !0});
            return {Max: a, Min: b, divArr: u}
    ...
    qa("column2dbase", {
        point: function (d, h, u, k, e) {
            var n = u.length, m = e[g], p = m.axisGridManager,
                D = e.xAxis, m = m.x, G = this.colorManager, q = /3d$/.test(e.chart.defaultSeriesType), r = this.isBar,
                s = /^spark/i.test(d);
            d = c(k.showplotborder, s || q ? Na : sb) === sb ? q ? 1 : a(k.plotborderthickness, 1) : 0;
            var N = e.chart.useRoundEdges, z = a(k.plotborderalpha, k.plotfillalpha, 100),
                ...
                ba = 0, B = Boolean(a(k.use3dlighting, 1)), F = e[g].numberFormatter, ha, E = a(k.plotborderdashed, 0),
                ua =
                    a(k.plotborderdashlen, 5), H = a(k.plotborderdashgap, 4), I, ra, K, ja, Ba, ia, Ha, Da, xa, L, Q,
                Ka, P, ea;
    ...
    qa("linebase", {
        defaultSeriesType: "line", hasVDivLine: !0, defaultPlotShadow: 1, point: function (d, h, u, k, e) {
            var n, m, p, D, G, q, r, s, N, z, ba, A, B, F, ha, E, ua, H, I, ra, K, ja, Ba, ia, Ha, Da;
            d = e.chart;
            var xa = u.length, L = e.xAxis;
            n = e[g];
            var Q = this.colorManager, P, Ka = n.axisGridManager, ea = 0, nb = n.x, Pa = e[g].numberFormatter, eb, bb,
                fb;
            ...
            h.color = {FCcolor: {color: F, alpha: ha}};
            h.lineWidth = ba;
            h.anchorShadow = Ha;
            ...
            for (m = 0; m < xa; m += 1) D = u[m], D.vline ? Ka.addVline(L,
                ...
                y: n,
                color: {FCcolor: {color: N, alpha: z}},
                shadow: q,
                dashStyle: G,
                valuePosition: c(D.valueposition, d.valuePosition),
                marker: {
                    enabled: !!E,
                    shadow: Da && {opacity: ja / 100},
                    fillColor: {FCcolor: {color: K, alpha: Ba * ja / 100 + b}},
                    lineColor: {FCcolor: {color: I, alpha: ja}},
                    lineWidth: H,
                    radius: ra,
                    startAngle: ia,
                    symbol: La(ua),
    ...
    qa("area2dbase", {
        defaultSeriesType: "area", hasVDivLine: !0, parseAnchorVisibility: function (b, d, h) {
            ...
            d = e.chart;
            var n = u.length, m = e.xAxis, D = e[g], p = D.axisGridManager, D = D.x, G = e[g].numberFormatter,
                q = this.colorManager, r = 0, N, z, ba, A, B, F, ha, E, ua, H, I, ra, ja, K, Ba, ia, Ha, Da, xa, L, Q,
                P, Ka, ea, nb, Pa, eb, bb, fb;
            ...
            P = h.fillColor =
                {FCcolor: {color: B + Q.replace(/,+?$/, ""), alpha: F, ratio: kb, angle: ha}};
            h.lineWidth = Ha;
            h.dashStyle = z ? l(ba, ja, Ha) : "none";
            h.lineColor = {FCcolor: {color: E, alpha: ua, ratio: Wa, angle: N}};
            h.step = c(this.stepLine, h.step);
            h.drawVerticalJoins = Boolean(a(h.drawVerticalJoins, k.drawverticaljoins, 1));
            h.useForwardSteps = Boolean(a(h.useForwardSteps, k.useforwardsteps, 1));
            ...
            for (z = 0; z < n; z += 1) ja = u[z],
                ja.vline ? p.addVline(m, ja, r, e) : (N = G.getCleanValue(ja.value), A = a(ja.showlabel, k.showlabels, 1), ba = C(v(ja.label, ja.name)), p.addXaxisCat(m, r, r, A ? ba : b, ja, {}, k), r += 1, A = a(ja.anchorsides, k.anchorsides, 0), ra = a(ja.anchorstartangle, k.anchorstartangle, 90), H = a(ja.anchorradius, k.anchorradius, 3), I = fa(c(ja.anchorbordercolor, k.anchorbordercolor, E)), Da = a(ja.anchorborderthickness, k.anchorborderthickness, 1), K = fa(c(ja.anchorbgcolor, k.anchorbgcolor, q.getColor("anchorBgColor"))), Ba = c(ja.anchoralpha, k.anchoralpha, this.anchorAlpha,
                    ...
                    marker: {
                        enabled: Ha,
                        shadow: ea && {opacity: Ba / 100},
                        fillColor: {FCcolor: {color: K, alpha: ia * Ba / 100 + b}},
                        lineColor: {FCcolor: {color: I, alpha: Ba}},
                        lineWidth: Da,
                        radius: H,
                        symbol: La(A),
                        startAngle: ra,
    ...
    qa("mscolumn2dbase", {
        point: function (d, f, u, k, e, l, n, m, D) {
            ...
            var p = !1, G = u.data || [], q = e[g], r = c(f.type, this.defaultSeriesType),
                N = c(f.isStacked, e.plotOptions[r] && e.plotOptions[r].stacking),
                v = c(this.isValueAbs, q.isValueAbs, !1), z = a(f.yAxis, 0), ba = e[g].numberFormatter,
                A = this.colorManager, B = A.getPlotColor(), C, F = e._FCconf.isBar, ha =
                    f.hoverEffects;
            ...
            u = f._dataParser = Ab.column(e, {
                ...
                plotgradientcolor: a(k.useplotgradientcolor, 1) ? O(k.plotgradientcolor, A.getColor("plotGradientColor")) :
                    b,
            ...
            for (k = 0; k < l; k += 1) (q = G[k]) ? (C = ba.getCleanValue(q.value, v), null === C ? f.data.push({y: null}) : (p = !0, q = u(q, k, C), f.data.push(q), q.previousY = this.pointValueWatcher(e, C, z, N, k, m, r))) : f.data.push({y: null});
            !d || p || this.realtimeEnabled || (f.showInLegend = !1);
            return f
        }, defaultSeriesType: "column"
    }, ib);
    qa("mslinebase", {
        hasVDivLine: !0, point: function (d, h, f, u, e, k) {
            d = a(u.ignoreemptydatasets, 0);
            var l = !1, n = this.colorManager, m, D;
            m = e.chart;
            var p =
                f.data || [];
            D = e[g];
            var G = c(h.type, this.defaultSeriesType),
                ...
                r = c(this.isValueAbs, D.isValueAbs, !1), N = a(h.yAxis, 0), v = this.numberFormatter,
                z = fa(c(f.color, u.linecolor, n.getPlotColor())), ba = a(f.alpha, u.linealpha, Wa),
                A = a(u.showshadow, this.defaultPlotShadow, 1),
                B = a(f.drawanchors, f.showanchors, u.drawanchors, u.showanchors),
                C = a(f.anchorsides, u.anchorsides, 0), F = a(f.anchorstartangle, u.anchorstartangle, 90),
                ha = a(f.anchorradius, u.anchorradius, 3), E = fa(c(f.anchorbordercolor,
                u.anchorbordercolor, z)), ua = a(f.anchorborderthickness, u.anchorborderthickness, 1),
                n = fa(c(f.anchorbgcolor, u.anchorbgcolor, n.getColor("anchorBgColor"))),
                ja = c(f.anchoralpha, u.anchoralpha, Wa), H = c(f.anchorbgalpha, u.anchorbgalpha, ja),
                I = ja && c(f.anchorshadow, u.anchorshadow, 0), ra = h.hoverEffects;
            h.name = s(f.seriesname);
            if (0 === a(f.includeinlegend) || void 0 === h.name || 0 === ba && 1 !== B) h.showInLegend = !1;
            h.marker = {
                enabled: Boolean(a(B, 1)), fillColor: {FCcolor: {color: n, alpha: H * ja / 100 + b}}, lineColor: {
                    FCcolor: {
                        color: E, alpha: ja +
                        b
                    }
                }, lineWidth: ua, radius: ha, symbol: La(C), startAngle: F
            };
            h.color = {FCcolor: {color: z, alpha: ba}};
            h.shadow = A ? {opacity: A ? ba / 100 : 0} : !1;
            h.anchorShadow = I;
            h.step = c(this.stepLine, h.step);
            ...
            for (u = 0; u < k; u += 1) (D = p[u]) ? (f = v.getCleanValue(D.value, r), null === f ? h.data.push({y: null}) : (l = !0, D = m(D, u, f), h.data.push(D), D.previousY = this.pointValueWatcher(e, f, N, q, u, 0, G))) : h.data.push({y: null});
    ...
    qa("msareabase", {
        ...
        point: function (d, h, f, u, e, k) {
            d = a(u.ignoreemptydatasets, 0);
            var n = !1, m = e.chart, D = f.data || [], p = e[g], G = c(h.type, this.defaultSeriesType),
                q = c(h.isStacked, e.plotOptions[G] && e.plotOptions[G].stacking),
                r = c(this.isValueAbs, p.isValueAbs, !1), s = a(h.yAxis, 0), N = e[g].numberFormatter,
                v = this.colorManager, z = v.getPlotColor(),
                ba = c(f.color, u.plotfillcolor, z).split(Ja)[0].replace(/^#?/g, "#").split(Ja)[0],
                A = c(f.alpha, u.plotfillalpha, u.areaalpha, this.areaAlpha, 70), B = a(u.plotfillangle, 270),
                ...
                F = a(u.plotborderangle, 270), ha = a(f.anchorsides, u.anchorsides, 0),
                E = a(f.anchorstartangle, u.anchorstartangle, 90), ja = a(f.anchorradius, u.anchorradius, 3),
                ...
                K = a(f.anchorbgalpha, u.anchorbgalpha, ra), Ba = ra && c(f.anchorshadow, u.anchorshadow, 0),
                Ha = h.hoverEffects;
            ...
            h.fillColor = {FCcolor: {color: ba, alpha: A, ratio: kb, angle: B}};
            h.color = ba;
            h.shadow = {opacity: a(u.showshadow, 1) ? C / 100 : 0};
            h.anchorShadow = Ba;
            h.lineColor = {FCcolor: {color: z, alpha: C, ratio: Wa, angle: F}};
            ...
            h.marker = {
                ...
                lineColor: {FCcolor: {color: ua, alpha: ra + b}},
                lineWidth: H,
                radius: ja,
                symbol: La(ha),
                startAngle: E
            ...
            for (m = 0; m < k; m += 1) (p = D[m]) ? (u = p ? N.getCleanValue(p.value, r) : null, null === u ? h.data.push({y: null}) : (n = !0, p = f(p, m, u), h.data.push(p), p.previousY = this.pointValueWatcher(e, u, s, q, m, 0, G))) :
                h.data.push({y: null});
    ...
    qa("scatterbase", {
        ...
        point: function (d, h, f, u, e, k, n) {
            d = a(u.ignoreemptydatasets, 0);
            var m = this.colorManager, D = m.getPlotColor(), p, G, q, r, N, v, z, ba, A, B, C, F, ha, E, ja, ua, H, I,
                ra;
            k = !1;
            var K, Ba;
            ...
            r = f.data ||
                [];
            var Ha, ia, Da, xa, L, Q = a(f.showvalues, e[g].showValues), P = this.numberFormatter, Ka,
                ea = h._showRegression = a(f.showregressionline, u.showregressionline, 0);
            h.zIndex = 1;
            h.name = s(f.seriesname);
            if (0 === a(f.includeinlegend) || void 0 === h.name) h.showInLegend = !1;
            ...
            h.marker = {
                ...
                lineColor: {FCcolor: {color: q, alpha: ba + b}},
                lineWidth: D,
                radius: v,
                symbol: La(n)
            };
            r = f.data || [];
            L = r.length;
            ea && (h.events = {hide: this.hideRLine, show: this.showRLine}, Ha = {
                sumX: 0,
                sumY: 0,
                sumXY: 0,
                sumXsqure: 0,
            ...
            for (G = 0; G < L; G += 1) (A = r[G]) ? (p = P.getCleanValue(A.y), ra = P.getCleanValue(A.x), null === p ? h.data.push({
                ...
                marker: {
                    enabled: N,
                    shadow: B && {opacity: H / 100},
                    fillColor: {FCcolor: {color: ua, alpha: I * H / 100 + b}},
                    lineColor: {FCcolor: {color: E, alpha: H}},
                    lineWidth: ja,
                    radius: ha,
                    symbol: La(F),
                ...
                Ka.rolloverOptions
            }), this.pointValueWatcher(e, p, ra, ea && Ha))) : h.data.push({y: null});
        ...
        postSeriesAddition: function (b, c) {
            for (var d = b.chart, h = c.chart, e = b.series, f = 0, g = e.length; f < g; f += 1) e[f]._showRegression && (e[f].relatedSeries =
                [f + 1]);
            d.clipBubbles = a(h.clipbubbles, 1)
        },
        categoryAdder: function (d, h) {
            var f, u = 0, e, k = h[g].x, m, D = h.xAxis, p, G, q = d.chart, r = parseInt(q.labelstep, 10),
                s = a(q.showlabels, 1), N = c(q.xaxislabelmode, "categories").toLowerCase(), z = this.colorManager,
                ba = h[g].numberFormatter, A, B, F, ha, E, ja;
    ...
    qa("mscombibase", {
        canvasPaddingModifiers: ["anchor", "anchorlabel"], series: function (b, d, h) {
            var f, e, u, k, l = b.chart, n, m = [], D = [], p = [], G, q, r = d[g], s = this.isDual, N = 0, z;
            ...
            if (b.dataset && 0 < b.dataset.length) {
                ...
                if (0 === D.length && 1 !== k) r.hasNoColumn = !0; else if (!this.isStacked) for (h = 0, f = D.length; h < f; h += 1) D[h].numColumns = f;
...
FusionCharts.register("module", ["private", "modules.renderer.js-renderer", function () {
    function d(a, b, c, d) {
        var f = b.paper, g = b.layers, k = c ? "y-axis" : "x-axis", l = this.layerAboveDataset = g.layerAboveDataset,
            n = this.layerBelowDataset = g.layerBelowDataset, g = l.bands || (l.bands = []), m = g.length,
            p = n.bands || (n.bands = []), q = p.length, r = l.lines || (l.lines = []), s = r.length,
            v = n.lines || (n.lines = []), z = v.length, l = l.labels || (l.labels = []), A = l.length,
            n = n.labels || (n.labels = []), B = n.length;
        this.renderer = b;
        this.axisData = a || {};
        this.globalOptions =
            b.options;
    ...
    var q = this, E = q.window, b = q.hcLib, K = b.Raphael, I = b.chartAPI,
        c = /msie/i.test(E.navigator.userAgent) && !E.opera, s = E.document, a = E.Image, v = "VML" === K.type,
        O = b.BLANKSTRING, C = b.getPosition, g = "rgba(192,192,192," + (c ? .002 : 1E-6) + ")",
        c = b.TOUCH_THRESHOLD_PIXELS, f = b.CLICK_THRESHOLD_PIXELS, l = b.stubFN, p = {pageX: 0, pageY: 0},
        F = parseFloat, Q = parseInt, k = b.extend2, B = b.addEvent, A = b.getMouseCoordinate, W = b.removeEvent,
        r = b.pluck, oa = b.pluckNumber, ga = b.toRaphaelColor, $ = b.setImageDisplayMode, V = b.FC_CONFIG_STRING,
        ta = b.plotEventHandler,
        za = b.isArray, Aa = b.each = function (a, b, c, d) {
            var f;
            c || (c = a);
            d || (d = {});
            if (za(a)) for (f = 0; f < a.length; f += 1) {
                if (!1 === b.call(c, a[f], f, a, d)) return f
            } else if (null !== a && void 0 !== a) for (f in a) if (!1 === b.call(c, a[f], f, a, d)) return f
        }, Z = b.createElement, U = b.createContextMenu, na = b.hasTouch, H = na ? c : f, T = b.getSentenceCase,
        fa = b.getCrispValues, n = b.getValidValue, L = b.getFirstValue, ca = b.regex.dropHash, aa = b.HASHSTRING,
        sa = function (a) {
            return a !== Ea && null !== a
        }, Y = function (a, b) {
            ...
            return a
        }, Ea, la = 8 === s.documentMode ? "visible" : "", ya = E.Math, Ia = ya.sin, ma = ya.cos, Ma = ya.atan2,
        pa = ya.round, qa = ya.min, La = ya.max, Ya = ya.abs, ib = ya.ceil, Ja = ya.floor, Ta = 180 / ya.PI, Na = ya.PI,
        sb = Na / 2, Wa = 2 * Na, Ga = Na + sb, Sb = b.getFirstColor, Qb = b.graphics.getLightColor,
        Fb = b.POSITION_TOP, jb = b.POSITION_BOTTOM, yb = b.POSITION_RIGHT, kb = b.POSITION_LEFT;
    ...
    K.addSymbol({
        printIcon: function (a, b, c) {
            var d = .75 * c, f = .5 * c, g = .33 * c, k = pa(a - c) + .5, l = pa(b - c) + .5, n = pa(a + c) + .5;
            c = pa(b + c) + .5;
            var m = pa(a - d) + .5, p = pa(b - d) + .5, d = pa(a + d) + .5, q = pa(b + f) + .5, r = pa(a + f) + .5,
                s = pa(b + g) + .5;
            a = pa(a - f) + .5;
            g = pa(b + g + g) + .5;
            return ["M", m, l, "L", d, l, d, p, m, p, "Z", "M", k, p, "L", k, q, m, q, m, b, d, b, d, q, n, q, n, p, "Z", "M", m, b, "L", m, c, d, c, d, b, "Z", "M", r, s, "L", a, s, "M", r, g, "L", a, g]
                                 ...
                                 b, c) {
            var d = .66 * c, f = .5 * d, g = pa(a - c) + .5, k = pa(b - c) + .5, l = pa(a + c) + .5;
            c = pa(b + c) - .5;
            var n = pa(a - f) + .5, m = b < c - 3 ? c - 3 : pa(b) + .5, f = pa(a + f) - .5, p = pa(a + d) - .5,
                d = pa(a - d) + .5;
    ...
    b.rendererRoot = I("renderer.root", {
        standaloneInit: !1, isRenderer: !0, inited: !1, callbacks: [], init: function (a, b, c) {
            var d = this, f = d.container = a && a.containerElement || b.chart.renderTo, g = b.tooltip, k = d.layer, l,
                n;
            d.options = b;
            d.logic = a;
            ...
            var c = a.target || a.originalTarget || a.srcElement || a.relatedTarget || a.fromElement, d = a.data,
                f = d.fusionCharts;
        ...
        onContainerRollOver: function (a) {
            ...
            var b = a.originalEvent,
                b = b.target || b.originalTarget || b.srcElement || b.relatedTarget || b.fromElement, c = a.data,
                d = c.paper;
            ...
            var c = this.paper, d = this.options.chart, f = this.elements, g = f.messageText, k = f.messageVeil,
                l = c.width, n = c.height;
            k || (k = f.messageVeil = c.rect(0, 0, l, n).attr({fill: "rgba(0,0,0,0.2)", stroke: "none"}));
            ...
            var a = this, b = a.logic, c = "zoomline" === b.rendererId, d = a.paper, f = a.elements,
                g = a.toolbar || (a.toolbar = []), k = a.menus || (a.menus = []), l = a.layers, n = a.options, m = n[V],
                b = m && m.outCanvasStyle || b.outCanvasStyle || {}, m = n.chart.toolbar || {}, p = m.hDirection,
                q = c ? 1 : m.vDirection, r = m.button ||
                {}, s = r.scale, v = r.width * r.scale, z = r.height * r.scale, A = p * (r.spacing * r.scale + v),
                B = r.radius, C = (n = n.exporting) && n.buttons || {},
                F = C.exportButton && !1 !== C.exportButton.enabled, C = C.printButton && !1 !== C.printButton.enabled,
            ...
            g.add = function (a, b, c) {
                ...
                var h = 0 === g.count ? A - p * r.spacing * r.scale : A, h = c.x || (g.x += h), f = c.tooltip || "";
                g.push(a =
            ...
            }(g.x + v, g.y + z), {tooltip: "Export chart"}));
            C && (f.printButton = g.add("printIcon", function () {
                a.print()
            }, {tooltip: "Print chart"}))
        }, setMargins: function () {
            var a = this.paper, b = this.options.chart || {}, c = pa;
            ...
            var b = this, c = b.paper, d = b.layers, f = b.elements, g = d.background, k = f.background,
                l = f.chartborder, n = b.options.chart || {}, m = F(n.borderWidth) || 0, p = .5 * m, r = 2 * m,
                s = n.borderWidth || 0, v = b.chartHeight, z = b.chartWidth, A = f.backgroundImage, B = n.bgSWF,
                C = n.bgSWFAlpha / 100, E = n.bgImageDisplayMode, H = n.bgImageVAlign,
                I = n.bgImageHAlign, K = n.bgImageScale, L = s + "," + s + "," + (z - 2 * s) + "," + (v - 2 * s), Q, ea,
                O, W, P, U, T;
            c.canvas.style.backgroundColor = n.containerBackgroundColor;
            !g && (g = d.background = c.group("background"));
            d = {x: m, y: m, width: c.width - r, height: c.height - r, stroke: "none", fill: ga(n.backgroundColor)};
            ...
            B && (Q = new a, P = O = 1, A = [], Q.onload = function () {
                ea = $(E, H, I, K, s, z, v, Q);
                ea["clip-rect"] = L;
                if (ea.tileInfo) for (O = ea.tileInfo.xCount, P = U = ea.tileInfo.yCount, T = ea.y, delete ea.tileInfo; O && ea.width && ea.height;) --U, W ? (A[void 0] = W.clone().attr({
                    x: ea.x,
                    y: ea.y
                }), g.appendChild(A[void 0])) : A[void 0] = W = c.image(B, g).attr(ea).css({opacity: C}), ea.y += ea.height, 0 === U && (U = P, --O, ea.x += ea.width, ea.y = T); else {
                    if (b.disposed || c.disposed) return;
                    A[0] = c.image(B, g);
                    A[0].attr(ea).css({opacity: C}).attr({visibility: la, "clip-rect": L})
                }
            ...
            var a = this, b = a.paper, c = a.plots = a.elements.plots, d = a.logic, f = a.layers, g = a.options,
                l = a.elements, n = g.chart, g = a.datasets =
                    g.series, m = L(n.rendererId, n.defaultSeriesType), p = f.background,
                q = f.dataset = f.dataset || b.group("dataset").insertAfter(p), s, v, p = function (a, b) {
                    return function (h) {
                        var f = c[a], g, l = {hcJSON: {series: []}}, n = l.hcJSON.series[a] || (l.hcJSON.series[a] = {}),
                    ...
                    return function (g, k) {
                        d.call(a, c[b], f, {numUpdate: g, hasAxisChanged: k})
                    }
                };
        ...
        }, drawPlot: l, drawCanvas: l, drawAxes: l, drawScroller: function () {
        }, drawLegend: function () {
            var a = this, b = a.options, c = a.paper, d = b.chart || {}, f = b.legend, g = f.scroll, b =
                ...
                r = "vertical" === f.layout, s = d.marginBottom, v = d.spacingBottom, z = d.spacingLeft,
                A = d.spacingRight, B = c.width, C = c.height, F = a.canvasTop, E = f.width, H = f.height,
                I = f.borderRadius, L = f.backgroundColor, Q = f.borderColor, W = f.borderWidth || 0, U = .5 * W,
                P = .5 * W + 2, ga = oa(f.padding, 4), V = .5 * ga, Z, ub, Ra, Y, wa, Ab, t, w;
            w = g && g.enabled;
            ...
            a.addCSSDefinition(".fusioncharts-legend .fusioncharts-caption", k({"text-anchor": f.title.align}, f.title.style));
            f.legendAllowDrag && (a.addCSSDefinition(".fusioncharts-legend", {cursor: "move"}), ub = r, Ra = s, n.drag(function (a, b) {
                Y = Ab + a;
                wa = t + b;
                Y + E + P > B && (Y = B - E - P);
                wa + H + P > C && (wa = C - H - P);
            ...
            m.shadow(f && f.shadow);
            w ? (Z = H - ga, m = "," + E + "," + Z, q = l.elementGroup = c.group("legenditems", n).attr({"clip-rect": "0," + V + m}), g = l.scroller || (l.scroller = c.scroller(E - 10 + V - W, U, 10, H - W, !1, {
                ...
                b]);
                k(a.fusionCharts.jsVars._reflowData, {hcJSON: {legend: {scroll: {position: b}}}}, !0)
            })) : q = l.elementGroup = n;
            ...
            var b = this, c = b.paper, d = b.options, f = d.series, l = d.chart, n = l.defaultSeriesType, d = d.legend,
                m = d.legendHeight, p = d.symbolPadding, s = d.textPadding || 2, v = oa(d.padding, 4),
                l = l.textDirection, z = d.itemHoverStyle, B = d.itemHiddenStyle, C = d.itemStyle, F = C.color,
                B = B && B.color || "#CCCCCC", E = z && z.color || F, z = d.symbol3DLighting, H = d.symbolWidth,
                I = !1 !== d.interactiveLegend, K = a.elements, L = K.elementGroup;
            a = a.item = [];
            var K = K.item =
                    [], Q = [], W = {line: !0, spline: !0, scatter: !0, bubble: !0, dragnode: !0, zoomline: !0}, O, ea, U,
                T, P, V, Z, Y, ub, Ra, $, wa, Ab, t, w, J, M, e, da, R, S;
            wa = 0;
            for (Ab = f.length; wa < Ab; wa += 1) if ((O = f[wa]) && !1 !== O.showInLegend) if (Y = O.type || n, "point" === O.legendType) for (O = O.data || [], P = 0, V = O.length; P < V; P += 1) U = O[P] || {}, !1 !== U.showInLegend && (U._legendType = Y, Q.push(U)); else switch (O._legendType = Y, Y) {
                case "pie":
                case "pie3d":
                case "funnel":
                case "pyramid":
            ...
            V = function (a) {
                ...
                a = A(b.logic.chartInstance.ref, a);
                var e =
                    !1 !== c.visible, c = c.plot.legend.elements.legendItemText;
                d.chartX = a.chartX;
                d.chartY = a.chartY;
                d.pageX = a.pageX;
                d.pageY = a.pageY;
            ...
            for (Ab = Q.length; wa < Ab; wa += 1) !1 !== Q[wa].showInLegend && (S = {
                ...
                cursor: C.cursor ||
                "pointer", stroke: U ? S.symbolStroke : B, fill: U ? S.symbolColor : B, "stroke-width": 1, ishot: I
            ...
            var a = this.options.chart, b = this.options.title, c = this.options.subtitle, d = this.paper,
                f = this.smartLabel, g = this.elements, k = this.layers, l = k.caption, n = g.caption, m = g.subcaption,
                p = b.text, q = c && c.text, r = b.x, s;
            ...
            var b = this, c = b.paper, d = b.elements, f = b.options, g = f.credits, k = f.chart || {},
                l = k.borderWidth ||
                    0, n = b.chartHeight, m = b.chartWidth, p = d.logoImage, r = k.logoURL, s = k.logoAlpha / 100,
                z = k.logoPosition, B = k.logoLink, C = k.logoScale, F = k.logoLeftMargin, H = k.logoTopMargin, f = {
                    tr: {vAlign: Fb, hAlign: yb},
                    bl: {vAlign: jb, hAlign: kb},
                    br: {vAlign: jb, hAlign: yb},
            ...
            r && (I = new a, (L = f[z]) || (L = {vAlign: Fb, hAlign: kb}), I.onload = function () {
            ...
            var c = a.legend, d = c && c.elements, f = d && d.legendItemText, g = d && d.legendItemSymbol,
                d = d && d.legendItemLine, k = c && c.hiddenColor, l = c && c.itemLineColor, n = c && c.itemTextColor,
                m = c && c.symbolColor, p = c && c.symbolStroke, c = r(b, !a.visible);
            a.setVisible(b);
            c ? (g && g.attr({
                fill: m || l,
                stroke: p
            }), f && f.attr({fill: n}), d && d.attr({stroke: l})) : (g && g.attr({
                fill: k,
                stroke: k
            }), f && f.attr({fill: k}), d && d.attr({stroke: k}));
            ...
            var l = k(k({}, g.exporting), c), n = (l.exportformat || "png").toLowerCase(), m = l.exporthandler,
                p = (l.exportaction || O).toLowerCase(), r = l.exporttargetwindow || O, v = l.exportfilename,
                z = l.exportparameters, A = l.exportcallback, B = l.exportwithimages;
            ...
            q.raiseEvent("beforeExport", l, f, void 0, function () {
                function c() {
                    ...
                    if ("download" === p) {
                        ...
                        I = Z("form", {method: "POST", action: m, target: r, style: "display:none;"}, s.body);
                        for (a in C) Z("input", {type: "hidden", name: a, value: C[a]}, I);
                        I.submit();
                ...
                var h = d.layers.buttons,
                    g = f.id, k = d.paper, D = q && q.hcLib, C, F, H, I, K, L, D = D && D.isCanvasElemSupported(), Q, O,
                    P = 0, W = {}, U, T, ga, V, Y = {};
                ...
                -1 !== L.indexOf("<image ") ? D ? (O = (Q = L.match(/<image [^\>]*\>/gi)) && Q.length, U = function (a) {
                    ...
                    var g = new a;
                    g.onload = function () {
                        var a = "image/" + d, k = s.createElement("canvas"), l = k.getContext("2d"), n = "";
                        k.width = g.width;
                        k.height = g.height;
                        l.drawImage(g, 0, 0);
                        n = k.toDataURL(a);
                    ...
                    W["image_" + P] = {
                        name: b, type: c, encodedData: a, width: d,
                        height: f
                    };
                    ga()
                }, ga = function () {
            ...
            q.raiseEvent("BeforePrint", c, b.logic.chartInstance, void 0, function () {
                var a = b.container, d = b.elements, f = d.printButton, h = d.exportButton, g = [], k = a.parentNode,
                    d = s.body || s.getElementsByTagName("body")[0], l = d.childNodes;
                b.isPrinting = !0;
                Aa(l, function (a, b) {
                    1 == a.nodeType && (g[b] = a.style.display, a.style.display = "none")
                });
                !1 !== c.hideButtons && (f && "hidden" != f.attrs.visibility && f.attr({visibility: "hidden"}),
                h && "hidden" != h.attrs.visibility && h.attr({visibility: "hidden"}));
                d.appendChild(a);
                E.print();
                setTimeout(function () {
    ...
    d.prototype = {
        configure: function () {
            var a = this.axisData, b = this.renderer, c = this.isVertical, d = this.isReverse, f = b.options,
                g = f.chart, k = g.marginBottom, g = g.marginRight, l = b.canvasTop,
                n = b.canvasLeft, m = this.min = a.min, m = this.span = (this.max = a.max) - m,
                n = this.startX = oa(a.startX, n), l = this.startY = oa(a.startY, l),
                p = this.endX = oa(a.endX, b.canvasRight), a = this.endY = oa(a.endY, b.canvasBottom),
                m = this.pixelRatio = c ? (a - l) / m : (p - n) / m, r = this.relatedObj = {};
            r.marginObj = {top: l, right: g, bottom: k, left: n};
            r.canvasObj = {x: n, y: l, w: p - n, h: a - l, toX: p, toY: a};
            ...
            var a = this.axisData, b = a && a.plotLines || [], c = a && a.plotBands || [], d = a && a.showLine,
                f = a && a.tickLength, g = a && a.tickWidth;
            ...
            var c = this.primaryOffset = a, d = this.secondaryOffset = b || this.secondaryOffset, f = this.isVertical,
                g, k, l, n = [this.topLabelGroup, this.belowLabelGroup, this.topLineGroup,
                    this.belowLineGroup, this.topBandGroup, this.belowBandGroup], m, p;
            m = 0;
            for (p = n.length; m < p; m += 1) if (l = n[m]) g = f ? d : c, k = f ? c : d, l.attr({transform: "t" + g + "," + k});
            f || this.drawPlotLine && this.drawPlotLine()
        }, update: function () {
        }, drawTicks: function () {
            var a = this.axisData, b = this.renderer.paper, c = this.min, d = this.max, f = this.isVertical,
                g = this.layerBelowDataset, g = this.tickGroup = this.tickGroup || b.group("axis-ticks", g),
                k = this.relatedObj.canvasObj, l = a.offset, n = a.opposite, m = a.showAxis, p = a.tickInterval,
                r = a.tickLength, q = a.tickWidth,
                a = a.tickColor, s = c;
            if (f && m) for (c = this.getAxisPosition(c), f = this.getAxisPosition(d), k = n ? k.toX + l : k.x - l, b.path(["M", k, c, "L", k, f], g).attr({
                stroke: a,
                "stroke-width": q
            ...
            var a =
                    this.renderer, b = a.paper, c = this.isVertical, d = +!c, f = this.lines = this.lines || [],
                k = this.labels = this.labels || [], l = this.relatedObj.canvasObj, n = this.globalOptions || {},
                m = this.elements || {}, p = this.axisData.plotLines || [], r = this.primaryOffset,
                q = c ? this.startY : this.startX, s = c ? this.endY : this.endX,
                v = parseFloat(a.canvasBorderWidth) || 0, z = La(p.length, La(f.length, k.length)),
                A = a.layers.datalabels, B = this.belowLineGroup, C = this.topLineGroup, F = this.belowLabelGroup,
                E = this.topLabelGroup, I = !1 !== (a.tooltip || {}).enabled, K = function (b) {
                    return function (c) {
                        ta.call(this,
                            a, c, b)
                    }
                }, L = n.chart.xDepth || 0, n = n.chart.textDirection, Q = [], W = 0, U, P, T, V, Z, $, Ra, fa, wa, aa, t,
                w, J, M, e, da, R, S, ka, ca, pa, ma, qa, X, Fa, la, na, sa, Ea, ya, za, Aa, Dc, Na, ob, Va, Oa, Ja, ab,
                Ga, Ia, mb, hb;
            for (hb = 0; hb < z; hb += 1) {
                T = V = Z = null;
                T = f[hb];
                V = k[hb];
                if (Ra = p[hb]) if (fa = Ra.width, wa = Ra.isVline, aa = Ra.isTrend, t = Ra.isGrid, w = Ra.tooltext, J = Ra.value, M = Ra.color, e = Ra.dashStyle, da = aa ? Ra.to : null, R = Ra._isStackSum, U = 3 < Ra.zIndex ? C : B, S = Ra.label) {
                    ka = S.style;
                    ca = S.text;
                    pa = ka && ka.color;
                    ...
                    S.backgroundColor && (S.labelBgClr = ga({
                        color: S.backgroundColor, alpha: 100 *
                        S.backgroundOpacity
                    }));
                    S.borderColor && (S.labelBorderClr = ga({color: S.borderColor, alpha: "100"}));
                    Na = Fa ? .2 * Fa : 2;
                ...
                if (Ra && "visible" === Ia && .1 < fa) ab = {
                    ...
                    path: Ga,
                    fill: g
                }, a.layers.tracker)), Z = Z || T, I && w && Z.tooltip(w); else if (T || V) T && T.remove(), T = null, f && (f[hb] = null), m && m.lines && (m.lines[hb] = null);
                ...
                !T && !V || Ra && null === Ra.value || (Ra && Ra.isMinLabel ? this.poi.min = {
                    ...
                    index: hb,
                    line: T
                } : Ra && Ra.isZeroPlane && (this.poi.zero = {label: V, index: hb, line: T}));
                T = V = null
            }
            oa(a.options.plotOptions.series.animation.duration, 0)
        }, drawPlotBands: function () {
            var a = this.renderer, b = a.paper, c = this.isVertical,
                d = this.axisData.plotBands || [], f = this.bands = this.bands || [],
                g = this.bandLabels = this.bandLabels || [], k = this.relatedObj.canvasObj, l = this.primaryOffset,
                n = c ? this.startY : this.startX, m = c ? this.endY : this.endX, p = a.options.chart.hasScroll,
                r = this.belowBandGroup, q = this.topBandGroup, s = this.belowLabelGroup, v = this.topLabelGroup,
                z = this.elements || {}, A = a.options.chart.textDirection, a = !1 !== (a.tooltip || {}).enabled, B, C,
                F, E, H, I, K, L, Q, P, O, W, U, T, V, Z, Y, $, t, w, J, M, e, da, R, S, ka, fa, aa, ca, pa, X, qa, ma,
                ta, la = La(d.length, f.length);
            for (ta =
                     0; ta < la; ta += 1) {
                ma = "visible";
                X = f[ta];
                qa = g[ta];
                if (B = d[ta]) if (C = B.tooltext, F = B.to, E = B.from, H = B.value, I = B.width, K = B.color, ca = 3 < B.zIndex ? q : r, L = B.label) {
                    if (Q = L.style) {
                    ...
                    if (V = L.borderColor) M = L.labelBorderClr = ga({color: V, alpha: "100"});
                    V = L.textAlign;
                ...
                if (!X && B &&
                    ...
                    fill: ga(K),
                    "stroke-width": 0
                }, X ? X.attr(B) : (X = f[ta] = b.rect(B, ca), z.bands = z.bands || [], z.bands[ta] = X), a && C && X.tooltip(C); else if (X && (!B || "hidden" === ma)) {
            ...
            var a = this.axisData, b = a.title || {}, c = b && b.style, d = b && b.className, f = b.align,
                g = b.centerYAxisName || !1, k = this.renderer.paper, l = this.isVertical,
                n = this.relatedObj.canvasObj, m = oa(a.offset, 0) + oa(b.margin, 0), p = b.text || "",
                r = this.name || void 0, a = a.opposite, q = this.layerBelowDataset,
                q = q.nameGroup = q.nameGroup || k.group("axis-name", q), s = oa(b.rotation, a ? 90 : 270),
                v = l ? a ? n.toX + m : n.x - m : (n.x + n.toX) / 2, z = {
            ...
            var a = this.axisData, b = this.renderer.paper,
                c = this.min, d = this.max, f = this.isVertical, g = a.opposite, k = this.layerBelowDataset,
                k = this.lineGroup = this.lineGroup || b.group("axis-lines", k), l = a.lineColor, n = a.lineThickness,
                m = a.lineEndExtension || 0, p = a.lineStartExtension || 0, a = this.relatedObj.canvasObj;
            ...
            b = b.path({path: ["M", d, c, "L", f, m], stroke: l, "stroke-width": n}, k);
    ...
    I("renderer.cartesian", {
        drawCanvas: function () {
            var a = this.options.chart || {}, b = a.plotBackgroundColor, c = this.paper, d = this.elements,
                f = d.canvas, g = d.canvas3DBase, k = d.canvas3dbaseline, g = d.canvasBorder, l = d.canvasBg,
                n = this.canvasTop, m = this.canvasLeft, p = this.canvasWidth, r = this.canvasHeight,
                q = oa(a.plotBorderRadius, 0), l = a.plotBorderWidth, s = .5 * l, z = a.plotBorderColor, A = a.isBar,
                B = a.is3D, C = a.use3DLighting, F = a.showCanvasBg, E = a.canvasBgDepth, H = a.showCanvasBase,
                I = a.canvasBaseColor3D,
                L = a.canvasBaseDepth, Q = a.plotShadow, O = v && 0 === l && Q && Q.enabled, W = a.xDepth || 0,
                a = a.yDepth || 0, P = this.layers, U = P.background, T = P.dataset;
            ...
            var a = this.logic, b = this.options, c = this.paper, f = this.layers, g = f.dataset,
                ...
                c = this.xAxis = [], f = this.yAxis = [];
            k.insertBefore(g);
            l.insertAfter(g);
            if (b.xAxis && b.xAxis.length) for (g = 0, k = b.xAxis.length; g < k; g += 1) c[g] = this.xAxis[g] = new d(b.xAxis[g], this, a.isBar); else c[0] = this.xAxis[0] = new d(b.xAxis, this, a.isBar);
            if (b.yAxis) for (g = 0, k = b.yAxis.length; g < k; g += 1) f[g] = this.yAxis[g] = new d(b.yAxis[g], this, !a.isBar, !a.isBar);
            g = 0;
            ...
            var a = this, b = a.options, c = a.paper, d = a.layers, f = a.xAxis["0"] || {}, g = f.axisData || {},
                l = g.scroll || {}, n = a.canvasTop, m = a.canvasLeft, p = a.canvasWidth, r = a.canvasHeight,
                s = a.canvasBorderWidth, v = s || (g.showLine ?
                g.lineThickness : 0), z = s || g.lineStartExtension, g = s || g.lineEndExtension,
                s = b.chart.useRoundEdges, A, B, C, F, E, H, I, L, Q, O, W, U, P, T, ga, Z = d.dataset,
                Y = d.datalabels, $ = d.tracker;
            ...
            l.enabled && (fa = d.scroll = d.scroll || c.group("scroll").insertAfter(F), F = l.scrollRatio, b = oa(b[V].xAxisScrollPos, l.startPercent), E = l.viewPortMax, H = l.viewPortMin, B = l.vxLength, I = ib(B), L = l.showButtons, Q = l.height, O = l.padding, W = l.color, U = l.flatScrollBars, B = l.windowedCanvasWidth = f.getAxisPosition(B), A = l.fullCanvasWidth =
                f.getAxisPosition(E - H) - B, C = pa(b * A), P = a.fusionCharts.jsVars._reflowData, T = {hcJSON: {_FCconf: {xAxisScrollPos: 0}}}, ga = T.hcJSON._FCconf, d.scroller = c.scroller(m - z, n + r + v + O - !!v, p + z + g, Q, !0, {
                showButtons: L,
                displayStyleFlat: U,
                scrollRatio: F,
                scrollPosition: b
                ...
                c = {
                    position: b,
                    direction: b - l.lastPos || 0, vxLength: I
                };
                ga.xAxisScrollPos = l.lastPos = b;
                k(P, T, !0);
                if (0 !== c.direction) for (wa = 0; wa < a.datasets.length; wa++) a[a.datasets[wa].drawPlot + "Scroll"] && a[a.datasets[wa].drawPlot + "Scroll"].call(a, a.plots[wa], a.datasets[wa], c)
            }), function () {
                var b;
                K.eve.on("raphael.scroll.start." + d.scroller.id, function (c) {
                    b = c;
                    q.raiseEvent("scrollstart", {scrollPosition: c}, a.logic.chartInstance)
                });
                K.eve.on("raphael.scroll.end." + d.scroller.id, function (c) {
                    q.raiseEvent("scrollend", {prevScrollPosition: b, scrollPosition: c},
                        a.logic.chartInstance)
                })
            }());
            return l.enabled
        }, finalizeScrollPlots: function () {
            var a = this, c = a.container, d = a.elements, f = a.layers, g = f.scroller, k = f.dataset,
                l = f.datalabels, f = f.tracker, n, m = {}, r, s = a.xAxis["0"] || {},
                v = (s.axisData || {}).scroll || {}, z = oa(a.options[V].xAxisScrollPos, v.startPercent),
                A = v.fullCanvasWidth;
            v.enabled && (k.attr({"clip-rect": d["clip-canvas"]}), l.attr({"clip-rect": d["clip-canvas"]}), f.attr({"clip-rect": d["clip-canvas"]}), d = function (c) {
                var d = a.elements.canvas, f = n.left, k = n.top, l = c.state, u =
                ...
                switch (l) {
                    case "start":
                        ...
                        q.raiseEvent("scrollstart", {scrollPosition: m.prevScrollPosition}, a.logic.chartInstance);
                        break;
                    case "end":
            ...
            var d = this, f = a.data, k = f.length, l = a.items, n = a.graphics || (a.graphics = []), m = d.paper,
                p = d.smartLabel, q = d.logic, s = d.layers, v = d.options, z = d.elements, A = v.chart,
                B = !1 !== (v.tooltip || {}).enabled,
                C, E = d.definition.chart, I = v.plotOptions.series, L = I.dataLabels.style, O = d.xAxis[b.xAxis || 0],
                W = d.yAxis[b.yAxis || 0], U = d.chartWidth, ea = d.chartHeight, T = W.axisData.reversed, Z = q.isLog,
                P = q.is3D, Y = q.isStacked, $ = q.isWaterfall, fa = q.isCandleStick, aa = r(O.axisData.scroll, {}),
                ca = c || {}, ma = aa.enabled, wa = oa(ca.position, v[V].xAxisScrollPos, aa.startPercent),
                la = ca.vxLength || ib(aa.vxLength), t = ca.scrollStart || La(0, pa((k - la) * wa) - 1) || 0,
                w = ca.scrollEnd || qa(k, t + la + 2) || k,
                J = A.canvasBorderOpacity = K.color(A.plotBorderColor).opacity,
                M = d.canvasBorderWidth, e = A.isCanvasBorder = 0 !== J && 0 < M, da,
                R = c !== Ea ? 0 : isNaN(+I.animation) && I.animation.duration || 1E3 * I.animation,
                S = b.numColumns || 1, ka = b.columnPosition || 0, na = A.use3DLighting,
                Yb = !1 === b.visible ? "hidden" : "visible", ya = A.overlapColumns, za = O.getAxisPosition(0),
                X = O.getAxisPosition(1) - za, Fa = E && E.plotspacepercent, Aa = oa(E && E.plotpaddingpercent),
                Ja = I.groupPadding, Ia = I.maxColWidth, Na = (1 - .01 * Fa) * X || qa(X * (1 - 2 * Ja), Ia * S),
                Ga = Na / 2, Ma = Na / S, Wa = qa(Ma - 1, 1 < S ? ya || Aa !== Ea ? 0 < Aa ? Ma * Aa / 100 : 0 : 4 : 0),
                Dc = ka * Ma - Ga + Wa / 2,
                Ta = W.max, ob = W.min, Va = 0 < Ta && 0 <= ob, Oa = 0 >= Ta && 0 > ob, sb = 0 < Ta && 0 > ob,
                ab = Oa || T && Va ? Ta : Z || Va ? ob : 0, kb = W.yBasePos = W.getAxisPosition(ab), yb,
                mb = oa(A.useRoundEdges, 0), hb = s.dataset = s.dataset || m.group("dataset-orphan"),
                Za = s.datalabels = s.datalabels || m.group("datalabels").insertAfter(hb), cb = s.tracker,
                jb = d.canvasTop, Fb = d.canvasLeft, Qb = d.canvasWidth, Sb = d.canvasBottom, md = d.canvasRight, xc,
                nd, od, Hc, bc, cc, Pc, Nb, $b, zb, qb, qc, Gb, Bc, Ob, hc, Pb, gb, Cc, Ic, Ua, vb, ac, rb, rc, Qc, wb,
                Kb, Ca, sc, uc, vc, nc, oc, yc, dd, tc, wc, lb, Yc = function (a) {
                    ta.call(this,
                        d, a)
                }, Fc = function (a, b) {
                    return function (c) {
            ...
            R && (!c && Za.attr({transform: "...t" + U + "," + ea}), d.animationCompleteQueue.push({
                fn: function () {
                    Za.attr({
                        transform: "...t" +
                        -U + "," + -ea
            ...
            fa || P || ma || Ca.attrs["clip-rect"] || Ca.attr({"clip-rect": z["clip-canvas"]});
            $ && Ca.toBack();
            if (P) for (bc = A.xDepth || 0, cc = A.yDepth || 0, sc = Ca.negative = Ca.negative || m.group("negative-values", Ca), nc = Ca.column = Ca.column || m.group("positive-values", Ca), vc = Ca.zeroPlane, !vc && 0 > ob && 0 <= Ta && (vc = Ca.zeroPlane = m.group("zero-plane", Ca).insertBefore(nc),
                ...
                stroke: od || "none",
                "stroke-width": Hc ? 1 : 0
            })), (uc = sc.data("categoryplots")) || (sc.data("categoryplots", Array(k)), uc = sc.data("categoryplots")), (oc = nc.data("categoryplots")) || (nc.data("categoryplots", Array(k)), oc = nc.data("categoryplots")), zb = 0; zb < k; zb += 1) uc[zb] = uc[zb] || m.group(sc), oc[zb] = oc[zb] || m.group(nc); else yc = Ca;
            p.setStyle({
                fontFamily: L.fontFamily, fontSize: L.fontSize,
                lineHeight: L.lineHeight, fontWeight: L.fontWeight, fontStyle: L.fontStyle
            });
            for (zb = t; zb < w; zb += 1) {
                qb = f[zb];
                Ob = qb.y;
                ...
                wb = Kb = null;
                if (null === Ob) {
                    if ($b = l[zb]) wb = $b.graphic, P || wb.attr({height: 0})
                } else {
                    Pc = !1;
                    Bc = oa(qb.x, zb);
                    qc = qb.link;
                    ...
                    if (P) {
                        ...
                        wb.attr({
                            ...
                            "stroke-width": Gb,
                            visibility: Yb
                        }).shadow(I.shadow && qb.shadow, dd).data("BBox", {height: Ua, width: vb, x: Pb, y: gb});
                        R && wb.animate({cubepath: [Pb - bc, gb + cc, vb, Ua, bc, cc]}, R, "normal", d.getAnimationCompleteFn());
                        ...
                        vb = tc.width;
                        Ua = tc.height;
                        if (!fa && e && (!sa(hc) || $ && hc === Ob && Ob === qb._FCY)) if (Oa && !T) da = gb - (jb - Gb / 2), Ua += da, kb = gb -= da; else if (Z || Va || T && Oa) Ua = Sb - gb + Gb / 2, kb = gb + Ua;
                        ...
                        if (!($b = l[zb])) {
                            ...
                            R && wb.animate({y: gb, height: Ua || 1}, R, "normal", d.getAnimationCompleteFn());
            ...
            g = c.vxLength;
            var k = La(0, pa((d - g) * c.position) - 1) || 0, d = qa(d, k + g + 2) || d;
            k > d - g - 2 && (k = La(0, d - g - 2));
            c.scrollEnd = d;
            for (g = k; g < d; g++) if (!f[g]) {
                c.scrollStart =
                    g;
            ...
            var k = this.options, l = this.logic;
            d = k.chart;
            var n = this.paper, m = this.smartLabel, p = this.layers, k = k.plotOptions.series.dataLabels.style,
                q = 1 === d.rotateValues ? 270 : 0, s = this.canvasHeight, v = this.canvasTop, z = a.data[c];
            a = a.items[c];
            var A = d.valuePadding + 2, B = a.graphic;
            c = a.dataLabel;
            var C = r(a.valueBelowPlot, 0 > z.y), F = l.isStacked, l = l.is3D, E = d.xDepth || 0, I = d.yDepth || 0,
                H = z.displayValue;
            ...
            }), q && c.attr("transform", "T0,0,R" + q)) : c && c.attr({text: O});
            return c
            ...
            var c = this, d = a.data, f = d.length, k = a.items, l = a.graphics = [], n = c.paper, m = c.logic,
                p = c.layers, r = c.options, q = c.elements, s = r.chart, v = !1 !== (r.tooltip || {}).enabled, A,
                z = c.definition.chart, r = r.plotOptions.series, B = r.dataLabels.style, C = {
                    fontFamily: B.fontFamily,
                    fontSize: B.fontSize,
                    lineHeight: B.lineHeight,
                    fontWeight: B.fontWeight,
                    fontStyle: B.fontStyle
                }, B = c.xAxis[b.xAxis || 0], E = c.yAxis[b.yAxis || 0], I = m.is3D, m = m.isStacked,
                L = s.canvasBorderOpacity = K.color(s.plotBorderColor).opacity, O = c.canvasBorderWidth,
                L = s.isCanvasBorder = 0 !== L && 0 < O,
                O = isNaN(+r.animation) && r.animation.duration || 1E3 * r.animation, W = b.numColumns || 1,
                T = b.columnPosition || 0, U = s.use3DLighting, V = !1 === b.visible ? "hidden" : "visible",
                P = s.overlapColumns, Z = B.getAxisPosition(0), Z = B.getAxisPosition(1) - Z,
                Y = z && z.plotspacepercent, z = oa(z && z.plotpaddingpercent), $ = r.groupPadding, fa = r.maxColWidth,
                Y = (1 - .01 * Y) * Z || qa(Z * (1 - 2 * $), fa * W), Z = Y / 2, Y = Y / W,
                P = qa(Y - 1, 1 < W ? P || z !== Ea ? 0 < z ? Y * z / 100 :
                    0 : 4 : 0), W = Y - P, T = T * Y - Z + P / 2, aa = E.max, ca = E.min,
                P = E.getAxisPosition(0 > aa && 0 > ca ? aa : 0 < aa && 0 < ca ? ca : 0), z = oa(s.useRoundEdges, 0),
                wa = c.canvasTop, Z = c.canvasLeft, ma = c.canvasHeight, Y = c.canvasRight, t = c.chartWidth,
                w = c.chartHeight, J, M, e, da, R, S, ka, la, na, sa, $ = E.axisData.effectiveZeroPlaneThickness;
            ka = p.dataset = p.dataset || n.group("dataset-orphan");
            var Aa = p.datalabels = p.datalabels || n.group("datalabels").insertAfter(ka), p = p.tracker, X, Fa, ya, za,
                Ja, La, fa = function (a) {
                    ta.call(this, c, a)
                }, Na = function (a, b) {
                    return function (d) {
            ...
            (ka.data("categoryplots", Array(f)), sa = ka.data("categoryplots")), q = 0; q < f; q += 1) ya[q] = ya[q] || n.group(C), sa[q] = sa[q] || n.group(ka); else la.attrs["clip-rect"] || la.attr({"clip-rect": q["clip-canvas"]}), za = la;
            q = 0;
            for (C = f - 1; q < f; q += 1, --C) {
                wa = d[q];
                ca = wa.y;
                X = ma = null;
                if (null === ca) {
                    if (S = k[q]) X = S.graphic, I || X.attr({width: 0})
                } else {
                    la = oa(wa.x, q);
                    ka = wa.link;
                    A = wa.toolText;
                    ...
                    if (I) {
                        ...
                        wa.hoverEffects && (R = {
                            ...
                            fill: [ga(da.color), !U], stroke: da.borderWidth && ga(da.borderColor) ||
                            "NONE", "stroke-width": da.borderWidth
                        });
                        X.attr({
                            ...
                            cursor: ka ? "pointer" : "",
                            visibility: V
                        }).shadow(r.shadow && wa.shadow, Ja).data("BBox", {height: W, width: e, x: na, y: la});
                        O && X.animate({cubepath: [na - J, la + M, e, W, J, M]}, O, "normal", c.getAnimationCompleteFn());
                        ...
                        O && X.animate({x: na, width: e || 1}, O, "normal", c.getAnimationCompleteFn());
            ...
            var k = this.options, l = this.logic, n = k.chart, m = this.paper, p = this.layers,
                r = k.plotOptions.series.dataLabels.style, k = this.canvasLeft, q = this.canvasWidth, s = a.data[c],
                v = a.items[c];
            a = n.valuePadding + 2;
            var A = v.graphic;
            c = v.dataLabel;
            var z = 0 > s.y, B = l.isStacked, l = l.is3D, C = n.xDepth ||
                0, F = n.yDepth || 0, E = s.displayValue;
            b = !1 === b.visible ? "hidden" : "visible";
            ...
            if (sa(E) && E !== O && null !== s.y) {
                ...
                s = d + (z ? 0 : m);
                f = z ? d - k : k + q - (d + m);
                if (B) s = La(k + .5 * p, s + .5 * (z ? m : -m)), s = qa(k + q - .5 * p, s), s -= l ? C : 0, r += l ? F : 0; else if (I ? m >= p ? (s += z ? a : -a, l && (r += F, s -= C)) : p < n ? (s += z ? -a : a, g = z ? "end" : "start", l && z && (s -= C)) : (z ? (s = d + m + La(p - d - m + k, 0) - a, g = "end", s -= l ? C : 0) : (s = d - La(p - (k + q - d), 0) + a, g = "start"), l && (s -= C, r += F)) : f >= p ? (s += z ? -a : a, l && z && (s -= C, r += C)) : (s += z ? a + p : -(a + p), l && (s -= C, r += F)), s > k + q || s < k) s = k + 4, g = "start";
                c.attr({x: s, y: r, "text-anchor": g, visibility: b})
            } else c &&
            c.attr({text: O});
            return c
            ...
            var d = this, f = d.paper, k = d.elements, l = d.options, n = l.chart, m = d.logic,
                p = l.plotOptions.series, r = b.items, q = b.graphics = b.graphics || [], s, v = d.xAxis[c.xAxis || 0],
                z = d.yAxis[c.yAxis || 0], A = m.multisetRealtime || m.dragExtended, B = m.isWaterfall, C, E, I, H, L,
                Q = 0, O = !1 !== (l.tooltip || {}).enabled, W,
                T = isNaN(+p.animation) && p.animation.duration || 1E3 * p.animation, U, P = p.dataLabels.style, V = {
                    fontFamily: P.fontFamily, fontSize: P.fontSize,
                    lineHeight: P.lineHeight, fontWeight: P.fontWeight, fontStyle: P.fontStyle
                }, Z = n.xDepth || 0, Y = n.yDepth || 0, $ = n.series2D3Dshift, ca = c.step, aa = c.drawVerticalJoins,
                ma = c.useForwardSteps, la = b.data, t = !1 === c.visible ? "hidden" : "visible", w, J = la.length,
                M = v.getAxisPosition(0), e = v.getAxisPosition(1) - M, da = e * J, R = v.axisData.scroll || {},
                S = n.hasScroll || !1, ka, na = p.connectNullData, pa = d.chartWidth, sa = d.chartHeight,
                ya = function () {
                    hc.attr({"clip-rect": null});
                    Ob.show();
                    Bc.show();
                    Pb.show();
                    Fb.attr({transform: "...t" + -pa + "," + -sa})
                }, X,
                Fa, za, Aa, Ea, Ja, Na, Ia = null, Ga, Ma, Ta = p.connectorWidth = F(c.lineWidth), ob = c.color, Va, Oa,
                Wa = p.connectorDashStyle = c.dashStyle, ab, Ya, kb, mb, hb, Za, cb, ib, jb, sb = d.layers,
                yb = sb.dataset = sb.dataset || f.group("dataset-orphan"),
                Fb = sb.datalabels = sb.datalabels || f.group("datalabels").insertAfter(yb), xc = sb.tracker,
                Qb = k["clip-canvas-init"].slice(0), Sb = k["clip-canvas"].slice(0), Hc = z.axisData.reversed,
                bc = z.max, cc = z.min,
                Pc = z.getAxisPosition(0 < bc && 0 < cc ? Hc ? bc : cc : 0 > bc && 0 > cc ? Hc ? cc : bc : Hc ? bc : 0) + ($ ? Y : 0),
                Nb = [], $b = n.anchorTrackingRadius,
                zb = /drag/ig.test(d.logic.rendererId), qb, qc, Gb, Bc, Ob, hc, Pb, gb, Cc, Ic, Ua, vb, ac = [],
                rb = function (a) {
                    ta.call(this, d, a)
                }, rc = function (a) {
                    return function (b) {
                    ...
                    return function () {
                        var s = k.imageUrl, w = k.imageScale, v = k.imageAlpha, z = p.imageHoverAlpha,
                            A = p.imageHoverScale, B = this.height * w * .01, C = this.width * w * .01,
                            F = this.width * A * .01;
                        cb = {
                            x: a - this.width * w * .005, y: e -
                            this.height * w * .005, width: C, height: B, alpha: v
                        };
                        ib = {
                        ...
                        z = F > C ? ib : cb;
                        zb && (z = {cx: a, cy: e, r: .5 * La(B, C)});
                        (l.graphic = mb = f.image(s, Pb).attr(cb).css({opacity: .01 * v}).data("alwaysInvisible", !w).data("setRolloverProperties", p).data("setRolloverAttr", ib).data("setRolloutAttr", cb).data("anchorRadius", w).data("anchorHoverRadius", A)) && q.push(mb);
                        if (Fa || O || p) hb = l.tracker = (zb ? f.circle(xc) : f.rect(xc)).attr(z).attr({
                            cursor: Fa ? "pointer" :
                                "", stroke: g, "stroke-width": k.lineWidth, fill: g, ishot: !0, visibility: t
            ...
            Fb.attr({transform: "...t" + pa + "," + sa});
            T && d.animationCompleteQueue.push({fn: ya, scope: d});
            ...
            for (w = 0; w < J; w += 1) {
                ...
                if (null === Ea) ac.length = 0, 0 === na && (Ia = null); else {
                    Aa = oa(X.x, w);
                    Fa = X.link;
                    ...
                    if ((ab = X.marker) && ab.enabled) if (Ya = ab.symbol.split("_"), kb = "spoke" === Ya[0] ? 1 : 0, za = ab.radius, gb = ab.shadow, qc = {
                            index: w,
                            link: Fa,
                            value: X.y,
                            ...
                            datasetName: b.name,
                            visible: b.visible
                        }, cb = ib = {}, Za = X.rolloverProperties, ab.imageUrl) vb = new a, vb.onload = wb(Ga, Ma, ab, s, qc, W, Za, w), vb.onerror = Kb(Ga, Ma, ab, s, qc, W, Za, w), vb.src = ab.imageUrl; else {
                        Za && (cb = {
                            polypath: [Ya[1] || 2, Ga, Ma, za, ab.startAngle, kb], fill: ga(ab.fillColor),
                            "stroke-width": ab.lineWidth, stroke: ga(ab.lineColor)
                        }, ib = {
            ...
            T ? (U = K.animation({"clip-rect": Sb}, T, S ? "easeIn" : "normal", d.getAnimationCompleteFn()), hc.attr({"clip-rect": Qb}).animate(B ?
            ...
            var g = d.graphic;
            d = d.dataLabel;
            var k = f.options.chart, l = 1 === k.rotateValues ? 270 : 0, n = g.data("setRolloverProperties"),
                m = g.data("isRealtime"), p = m && g.attr("polypath"), r = g.data("setRolloverAttr"),
                q = "image" === g.type, s = g.data("setRolloutAttr"),
                v = d && (d.data("isBelow") ? 1 : -1) * (q ? .5 * (r.height - s.height) : g.data("anchorHoverRadius") - g.data("anchorRadius")),
                z = "DataPlotRollOver" == c ? r : s, A = {
                    transform: "T0," + ("DataPlotRollOver" ===
                    c ? v : 0) + "R" + l
                }, B = {fill: z.fill, "stroke-width": z["stroke-width"], stroke: z.stroke},
                z = q ? z : {polypath: z.polypath}, k = k.syncLabelWithAnchor, C = g.data("anchorRadius"),
                F = g.data("anchorHoverRadius"),
                r = !(/,0\)$/.test(r.fill) && /,0\)$/.test(s.fill)) && g.data("anchorHoverRadius") - g.data("anchorRadius") && n.animation && 50;
            d && d.data("isMiddle") && (A = {transform: "T," + ("DataPlotRollOver" === c ? v : 0) + ",0R" + l});
            n && (("DataPlotRollOver" == c && 0 !== F || "DataPlotRollOut" == c && 0 !== C) && g.attr({visibility: "visible"}), q ? g.css({
                opacity: .01 *
                z.alpha
            }) : g.attr(B), m && !q && (z.polypath[1] = p[1], z.polypath[2] = p[2]), g.stop(), g.animate(z, r, "easeOut", function () {
                ("DataPlotRollOver" == c && !F || "DataPlotRollOut" == c && !C) && g.attr({visibility: "hidden"})
            }), d && d.stop(), r && k && d && d.animate(A, r, "easeOut"));
            ta.call(a, f, b, c)
        }, drawPlotArea: function (b, c) {
            var d = this, f = d.paper, l = d.options, n = l.chart, m = d.logic, p = l.plotOptions.series,
                r = d.elements, q = b.items, s = b.graphics = b.graphics || [], v, z = d.xAxis[c.xAxis || 0],
                A = d.yAxis[c.yAxis || 0], B = A.axisData.reversed, C = n.xDepth || 0, F =
                n.yDepth || 0, m = m.isStacked, E = !1 !== (l.tooltip || {}).enabled, I, H, l = p.dataLabels.style,
                K = {
                    fontFamily: l.fontFamily,
                    fontSize: l.fontSize,
                    lineHeight: l.lineHeight,
                    ...
                    fontStyle: l.fontStyle,
                    color: l.color
                }, l = isNaN(+p.animation) && p.animation.duration || 1E3 * p.animation, L = n.series2D3Dshift,
                Q = "0" === d.definition.chart.drawfullareaborder, O = b.data,
                W = !1 === c.visible ? "hidden" : "visible", T = O.length, P = z.getAxisPosition(0),
                U = (z.getAxisPosition(1) - P) * T, V = z.axisData.scroll || {}, P = n.hasScroll || !1,
                Z = p.connectNullData,
                Y, $, aa, ca, fa, t = A.max, w = A.min,
                J = A.getAxisPosition(0 < t && 0 > w ? 0 : !B && 0 < t && 0 <= w ? w : t) + (L ? F : 0),
                M = d.chartWidth, e = d.chartHeight, B = function () {
                    Wa.attr({"clip-rect": null});
                    ab.show();
                    Oa.show();
                    Ma.attr({transform: "...t" + -M + "," + -e})
                }, da = null, R, S, t = c.lineWidth, w = c.dashStyle, ka = ga(c.fillColor), ma = ga(c.lineColor), la = 0,
                na = /drag/ig.test(d.logic.rendererId), qa, X, pa, sa, ya, za, Aa = [], Ea = [], Ga = null, Ja = [],
                Ia = d.layers;
            ca = Ia.dataset = Ia.dataset || f.group("dataset-orphan");
            var Ma = Ia.datalabels = Ia.datalabels || f.group("datalabels").insertAfter(ca),
                Na = Ia.tracker, Ia = r["clip-canvas-init"].slice(0), r = r["clip-canvas"].slice(0),
                n = n.anchorTrackingRadius, Va, Oa, Ta, ab, Wa, Ya, mb, hb, Za, cb, ib = function (a) {
                    ta.call(this, d, a)
                }, jb = function (a) {
                    return function (b) {
                        d.hoverPlotAnchor(this, b, "DataPlotRollOver", a, d)
                    ...
                    return function () {
                        var t = l.imageUrl, v = l.imageScale, w = l.imageAlpha, z = r.imageHoverAlpha,
                            A = r.imageHoverScale, B = this.width * v * .01, C = this.width * A *
                            .01;
                        ya = {
                        ...
                        z = C > B ? za : ya;
                        na && (z = {cx: a, cy: e, r: .5 * La(C, B)});
                        (n.graphic = X = f.image(t, ab).attr(ya).css({opacity: .01 * w}).data("alwaysInvisible", !v).data("setRolloverProperties", r).data("setRolloverAttr", za).data("setRolloutAttr", ya).data("anchorRadius", v).data("anchorHoverRadius", A)) && s.push(X);
                        if ($ || E || r) Va = k({
                            cursor: $ ? "pointer" : "",
                            stroke: g, "stroke-width": l.lineWidth, fill: g, ishot: !0, visibility: W
            ...
            A.yBasePos = J;
            Ma.attr({transform: "...t" + M + "," + e});
            l && d.animationCompleteQueue.push({fn: B, scope: d});
            K = ca;
            ...
            for (K = 0; K < T; K += 1) {
                ...
                X = cb = pa = null;
                v = q[K] = {};
                if (null === ca) 0 === Z && (da = null, 0 < la && (1 === la ? Aa.splice(-8, 8) : (Aa = Aa.concat(Ea), Aa.push("Z")), Ea = [])), v.chart = d, v.index = K, v.value = ca; else {
                    $ = Y.link;
                    I = Y.toolText;
                    H = Y.previousY;
                    fa = (fa = A.getAxisPosition(H) || null) || J;
                    S = A.getAxisPosition(ca + (H || 0)) + (L ? F : 0);
                    if ((Za = Y.marker) && Za.enabled) if (H = {
                            index: K,
                            link: $,
                            value: Y.y,
                            ...
                            datasetName: b.name,
                            visible: b.visible
                        }, ya = za = {}, sa = Y.rolloverProperties, Za.imageUrl) aa = new a, aa.onload = Ga(R, S, Za, v, H, I, sa, K), aa.onerror = sb(R, S, Za, v, H, I, sa, K), aa.src = Za.imageUrl; else {
            ...
            l ? mb = Wa.attr({"clip-rect": Ia}).animate({"clip-rect": r}, l, P ? "easeIn" : "normal", d.getAnimationCompleteFn()) : (B && B(), B = void 0);
            Ya && (l ? Ya.attr({"clip-rect": Ia}).animateWith(Wa, mb, {"clip-rect": r},
            ...
            Q && (p = b.connector = f.path(Ja, Ta).attr({
                ...
                "stroke-linejoin": 2 < t ? "round" : "miter",
                visibility: W
            }), l ? Ta.attr({"clip-rect": Ia}).animateWith(Wa, mb, {"clip-rect": r}, l, P ? "easeIn" : "normal", function () {
                Ta.attr({"clip-rect": null})
            }) : Ta.attr({"clip-rect": null}), p && s.push(p));
            b.visible = !1 !== c.visible;
            return b
        }, drawPlotScatter: function (a, b) {
            var c = this, d =
                    c.options, f = d.chart, k = d.plotOptions.series, l = c.paper, n = c.elements, m = a.items, p,
                r = a.graphics = a.graphics || [], q = c.xAxis[b.xAxis || 0], s = c.yAxis[b.yAxis || 0], v = a.data,
                z = !1 === b.visible ? "hidden" : "visible", d = !1 !== (d.tooltip || {}).enabled, A,
                B = k.dataLabels.style, C = {
                    fontFamily: B.fontFamily,
                    fontSize: B.fontSize,
                    lineHeight: B.lineHeight,
                    fontWeight: B.fontWeight,
                    fontStyle: B.fontStyle,
                    color: B.color
                }, B = isNaN(+k.animation) && k.animation.duration || 1E3 * k.animation, F = c.chartWidth,
                E = c.chartHeight, I, H, K, L, Q, O, P, W, T, U = b.lineWidth,
                V = 0 < U, Y = b.color, Z = b.dashStyle, aa = k.connectNullData, $ = [], t, w, J, M, e, da,
                R = c.layers, S = R.dataset || (R.dataset = l.group("dataset-orphan")),
                ca = R.datalabels || (R.datalabels = l.group("datalabels").insertAfter(S)), R = R.tracker,
                f = f.anchorTrackingRadius, fa, la, ma, oa = function (a) {
                    ta.call(this, c, a)
                }, X = function (a) {
                    return function (b) {
            ...
            for (H = v.length; I < H; I += 1) {
                ...
                } else V && 0 === aa && (P = null), m[I] = {chart: c, index: I, x: Q, y: O};
                A && r.push(A);
                M && r.push(M);
                e && r.push(e);
                c.drawTracker &&
            ...
            $.length && (k = a.graphic = l.path($, C).attr({
                ...
                visibility: z
            }).shadow(k.shadow && K.shadow), C.attr({"clip-rect": n[B ? "clip-canvas-init" : "clip-canvas"]}), B && C.animate({"clip-rect": n["clip-canvas"]}, B, "normal"), r.push(k));
            B && fa.attr({opacity: 0}).animate({opacity: 1}, B, "normal", c.getAnimationCompleteFn());
            a.visible = !1 !== b.visible;
            return a
        }, drawPlotLineLabel: function (a, b, c, d,
                                        f, g) {
            var k = this.options, l = k.chart, m = this.paper, p = this.layers,
                r = k.plotOptions.series.dataLabels.style, k = 1 === l.rotateValues ? 270 : 0, q = this.canvasHeight,
                s = this.canvasTop, v = a.data, z = v[c], A = a.items[c], B = n(z.valuePosition, "auto").toLowerCase();
            a = this.logic.defaultSeriesType;
            var C = A.graphic, F = z.marker,
            ...
            sa(p) && p !== O ? (F ? k && F.attr("transform", ["r", 360 - k]) : F = A.dataLabel = m.text(g).attr({
                ...
                y: f,
                visibility: b
            }).data("isBelow", z._valueBelowPoint), k && F.attr("transform", "T0,0,R" + k)) : F && F.attr({text: O});
            return F
        }, drawLabels: function () {
            for (var a =
                ...
                fill: m.color
            }, sa(r.html) && r.html !== O && (g[d] = a.text({text: r.html}, f).css(p).attr({
                x: parseInt(m.left,
                    10) + l,
    ...
    I("renderer.piebase", {
        isHovered: !1, getPlotData: function (a, b) {
            ...
            var b = this.graphic || this, c = b.plotItem ||
                b.data("plotItem"), d = c.seriesData, f = c.chart, g = f.logic.chartInstance, l = c.index,
                n = b.data("eventArgs") || {}, m = f.options.series[0].enableMultiSlicing,
                p = d.data[c.index].doNotSlice, r = c.slicedTranslation, s, v;
            ...
            if (!(d.isRotating || d.singletonCase || p || (b = !m && f.sliceInOtherPies(l), (a = c.sliced) && b))) return b = c.graphic, d = c.connector, m = c.dataLabel, r = "object" === typeof r ? "t" + r : r, p = c.connectorPath, s = (a ? -1 : 1) * c.transX, v = (a ? -1 : 1) * c.transY, q.raiseEvent("slicingStart", {
                slicedState: a, dataIndex: "index" in
                n && n.index, data: f.getPlotData(l, a)
            }, g), b.animate({transform: a ? "t0,0" : r}, 200, "easeIn", function () {
                q.raiseEvent("slicingEnd", {
                    slicedState: c.sliced,
                    dataIndex: "index" in n && n.index,
                    data: f.getPlotData(l, c.sliced)
                }, g)
            }), m && m.x && m.animate({x: m.x + (a ? 0 : s)}, 200, "easeIn"), p && (p[1] += s, p[2] += v, p[4] += s, p[6] += s, d.animate({path: p}, 200, "easeIn")), a = c.sliced = !a, b = {hcJSON: {series: []}}, b.hcJSON.series[0] = {data: r = []}, r[l] = {sliced: a}, k(g.jsVars._reflowData, b, !0), a
        }, plotDragStart: function (a, b, c) {
            var d = this.data("plotItem"),
                f = d.chart, d = d.seriesData, g = f.options.series, k = -f.datasets[0].startAngle * Ta;
            d.isRotating = !1;
            ...
            var b = this.data("plotItem"), c = b.chart, d = b.seriesData, f = -c.datasets[0].startAngle * Ta,
                g = {hcJSON: {series: [{startAngle: f}]}};
            ...
            d.isRotating && (setTimeout(function () {
                ...
                startingAngle: z(f, !0), changeInAngle: f -
            ...
            var g = a.chart, k = a.seriesData, l = g.options.series;
            l[0].enableRotation && !k.singletonCase && (c = m.call(f, c, d, k.pieCenter, k.chartPosition), k.isRotating || (k.dragStartAngle !== c && (k.isRotating = !0), q.raiseEvent("RotationStart", {startingAngle: z(k.startingAngleOnDragStart, !0)}, g.logic.chartInstance)), l[0].startAngle += c - k.dragStartAngle, k.dragStartAngle = c, k.moveDuration =
            ...
            var b = this.plotItem || this.data("plotItem"),
                c = b.chart, d = c.options.series[0], f, g;
            ...
            var c = a.data("plotItem"), d = c.rolloverProperties, f = b ? d.color : c.color,
                g = b ? d.borderWidth : c.borderWidth, k = b ? d.borderColor : c.borderColor;
            d && c.graphic.attr({fill: ga(f), "stroke-width": g, stroke: k})
        }, getEventArgs: function (a) {
            a =
                a || {};
            return {
            ...
            }, c = ["start", "start", "end", "end"], d = [-1, 1, 1, -1], f = [1, 1, -1, -1];
            return function (g, k, l, n) {
                var m =
                        this.options.plotOptions, p = m.pie, r = this.canvasLeft + .5 * this.canvasWidth,
                    q = this.canvasTop + .5 * this.canvasHeight, s = this.smartLabel, v = m.series.dataLabels,
                    z = v.style, A = oa(ib(parseFloat(z.lineHeight)), 12),
                    A = L(v.placeLabelsInside, 1 === k.length ? !0 : !1), m = v.skipOverlapLabels,
                    B = v.manageLabelOverflow, C = v.connectorPadding, F = v.distance,
                    E = n && n.metrics || [r, q, p.size, p.innerSize || 0], I = E[1], H = E[0];
                n = .5 * E[2];
                var K = [[], [], [], []], Q = this.canvasLeft, O = this.canvasTop, p = this.canvasWidth,
                    F = l.labelsRadius || (l.labelsRadius = n + F),
                    q = r = parseInt(z.fontSize, 10), P = q / 2, C = [C, C, -C, -C];
                l = l.labelsMaxInQuadrant || (l.labelsMaxInQuadrant = Ja(F / q));
                var v = v.isSmartLineSlanted, E = E[3] / 2, W, T, U, V, Y, Z, aa, $, t, w, J, M, e, da, R, S, ca, fa,
                    ga, na;
                g || s.setStyle(z);
                if (1 == k.length && !E && A) V = k[0], (R = V.dataLabel) && R.show(), V.slicedTranslation = [Q, O], R && (R.attr({
                    ...
                    align: "middle",
                    transform: ["t", H, I]
                }), R.x = H); else if (A) na = E + (n - E) / 2, Aa(k, function (a) {
                    ...
                    for (k = g = 4; k--;) {
                        if (m && (A = K[k].length - l, 0 < A)) for (K[k].sort(a), z = K[k].splice(0, A), A = 0, U = z.length; A < U; A += 1) V = z[A].point, V.dataLabel.attr({visibility: "hidden"}), V.connector && V.connector.attr({visibility: "hidden"});
                        K[k].sort(b)
                    }
                    ...
                    for (K[3].reverse(); g--;) {
                        ...
                        U = da - (U - 1) * q;
                        z = 0;
                        for (k = E.length - 1; 0 <= k; --k, U += q) if (V = E[k].point, e = E[k].angle, Y = V.sliced, R = V.dataLabel, A = Ya(da * Ia(e)), A < z ? A = z : A > U && (A = U), z = A + q, w = (A + E[k].oriY) / 2, Z = H + f[g] * F * ma(ya.asin(w / da)), w *= d[g], w += I, J = I + n * Ia(e), aa = H + n * ma(e), (2 > g && Z < aa || 1 < g && Z > aa) && (Z = aa), $ = Z + C[g], M = w - P - 2, t = $ + C[g],
...
FusionCharts.register("module", ["private", "modules.renderer.js-interface", function () {
    var d = this, m = d.hcLib, z = d.renderer.getRenderer("javascript"), q = m.hasModule, E = m.loadModule,
        b = m.getMetaSentence, K = m.moduleCmdQueue, I = m.executeWaitingCommands, c = m.injectModuleDependency,
        s = m.moduleDependencies, a = m.getDependentModuleName, v, O;
    v = function (c) {
        var g, f, l, p = {}, q;
        c = b(c);
    ...
    d.extend(z, {
        render: function (b, g) {
            var f = this.chartType(), l = this.options.chartTypeSourcePath + f, p = this.jsVars, s = this.__state,
                v = m.chartAPI, k = this.options, B = this.args, A = this.options.showChartLoadingMessage, E, r;
            ...
            var b = this.ref, c = this.jsVars, l = c && c.fcObj,
            ...
            var b = this.ref, c, l = this.jsVars;
            ...
            var f = this.jsVars, l = this.chartType(), p = d.hcLib.chartAPI[l], l = a(l).concat(f.userModules),
                q = l[l.length - 1];
...
FusionCharts.register("module", ["private", "modules.api.dynamicchartattributes", function () {
    ...
    d.extend(d.core, {
        setChartAttribute: function (m, z) {
            var q, E, b, K;
            if ("string" === typeof m) q = m, m = {}, m[q] = z; else if (null === m || "object" !== typeof m) return;
            K = 0;
            ...
            var z = this.getChartData(d.dataFormats.JSON), z = z && (z.chart || z.graph || z.map), q, E;
            if (0 === arguments.length || void 0 === m || void 0 === z) return z;
            if ("string" === typeof m) q = z[m.toString().toLowerCase()]; else if (m instanceof Array) for (q = {}, E = 0; E < m.length; E += 1) q[m[E]] = z[m[E].toString().toLowerCase()]; else d.raiseError(this, "25081429", "param", "~getChartAttribute()", 'Unexpected value of "attribute"');
            return q
        }
    }, !0)
}]);
FusionCharts.register("module", ["private", "api.linkmanager", function () {
    var d = this, m = d.FusionChartsDOMInsertModes, z = {}, q = function (b, m) {
        this.items = {};
        this.root = b;
        this.parent = m;
    ...
    d.addEventListener("linkedChartInvoked", function (b, m) {
        var z = b.sender, c = z.clone({dataSource: m.data, dataFormat: m.linkType, link: new q(z.link.root, z)}, !0),
            s = m.alias, a;
        ...
        d.raiseEvent("beforeLinkedItemOpen", {level: z.link.level}, z.link.root, void 0, function () {
            ...
            d.raiseEvent("linkedItemOpened",
                {level: z.link.level, item: a}, z.link.root)
        })
    });
    d.addEventListener("overlayButtonClick", function (b, m) {
        if ("LinkManager" === m.id) {
            var q = b.sender, c = q.link.level - 1, s = q.link.parent, a = q.link.root;
            d.raiseEvent("beforeLinkedItemClose", {level: c, item: q}, a, q, function () {
                setTimeout(function () {
...
FusionCharts.register("module", ["private", "modules.renderer.js-thememanager", function () {
    var d = this, m, z, q, E = /\s+!important$/, b = /\\!important$/, K = function (a, b) {
        ...
        if (b instanceof Array) for (q = 0; q < b.length; q += 1) {
            try {
                k = a[q], s = b[q]
            } catch (z) {
                continue
            }
            if ("object" !== typeof s) c && void 0 === s || (a[q] = s); else {
            ...
            if (null !== s && "object" === typeof s) if (v = Object.prototype.toString.call(s), "[object Object]" === v) {
                if (null === k || "object" !== typeof k) k = a[q] = {};
                v = K(s, m);
                -1 !== v ? k = a[q] = d[v] : I(k, s, c, d, m)
            } else "[object Array]" === v ? (null !== k && k instanceof Array || (k = a[q] = []), v = K(s, m), -1 !== v ? k = a[q] = d[v] : I(k, s, c, d, m)) : a[q] = s; else a[q] = s
        }
        return a
    }, c = function (a, b, c) {
        if ("object" !== typeof a && "object" !== typeof b) return null;
        ...
        var d, m, q, s, k, z, A = 0, C = 0;
        for (d in b) if (m = b[d], m instanceof Array) for (z = m.length, k = 0; k < z; k += 1) {
            if (s = m[k], "object" === typeof s) if ("category" === d) if ("true" === s.vline) {
        ...
        var c = a.sender, m = c.getChartData(d.dataFormats.JSON, !0), s;
    ...
    m.prototype = {
        constructor: m, add: function (a) {
            ...
            var s = b.jsVars, k = a.split(","), v = [], A = k.length, E, r;
            if (A) {
                for (r = 0; r < A; r += 1) {
                    E = this.themeStore;
                    var I;
    ...
    z.prototype = {
        constructor: z, pushTheme: function (a) {
            a && (this.themeArray.push(a), this.parse(a), this.length += 1)
        },
        popTheme: function () {
        }, parse: function (a) {
            var b = this.themeComponents, d = this.chartInstance, m = this.base, q, v, k;
            for (v in a) if ("string" === typeof a[v] || "number" === typeof a[v]) if (m[v]) {
                if (q = s(a[v]), k = s(m[v]), q.important || !k.important) m[v] = a[v]
            } else m[v] = a[v]; else b[v] || (b[v] = []), q = b[v], a[v] instanceof Array ? q.push(c([], a[v])) : "object" === typeof a[v] ? q.push(new z([a[v]], d, !0)) : "function" === typeof a[v] && q.push(a[v])
        }, merge: function (a) {
            var b = this.base, c = a.base, d = this.themeComponents, m = a.themeComponents, q, k, v;
            for (v in c) if (q =
            ...
            var m = this.themeComponents, q = this.chartInstance, k = new z([], q, !0), s, v, C;
            v = m[a];
            if (!v) return null;
            a = 0;
    ...
    d.addEventListener("beforeDataUpdate", function (a, b) {
        var c = a.sender, m = d.core.transcodeData(b.data, b.format, d.dataFormats.JSON), s = m.chart && m.chart.theme;
